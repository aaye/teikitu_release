...
TgINLINE TgVOID
tgSE_Init_Request(
    STg2_SE_CO_Request_F32_04_PCU TgATTRIBUTE_MAYBE_UNUSED ARG0) {}

TgINLINE TgRESULT
tgSE_Collide(
    STg2_SE_CO_Request_F32_04_PCU TgATTRIBUTE_MAYBE_UNUSED ARG0, ETgSE_CHANNEL_C TgATTRIBUTE_MAYBE_UNUSED ARG1 ) { return KTgS_OK; }
