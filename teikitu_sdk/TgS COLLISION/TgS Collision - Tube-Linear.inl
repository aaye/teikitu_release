...
/*  »Project«   Teikitu Gaming System (TgS) (∂)
    »File«      TgS Collision - Tube-Linear.inl
...
/* =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-==-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- */
#if !defined(TGS_COLLISION_TUBE_LINEAR_INL)
...
/* ---- FCNI_VO(tgCO_TB_Clip_PM) ------------------------------------------------------------------------------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgINLINE TgRESULT FCNI_VO(tgCO_TB_Clip_PM)( VEC_T(1,PC) pvT0, VEC_T(1,PC) pvT1, VEC_OBJ_T(TgTUBE,CPC) psTB0, VEC_T(1,C) vS0, VEC_T(1,C) vD0 )
{
    VEC_T(1)                            vT0, vT1, vN0, vN1;
    TgRESULT                            iResult;

    iResult = FCNI_VO(tgCO_TB11_Param)( &vT0, &vT1, &vN0, &vN1, FCN_V(tgMH_SET1)( TYPE_K(0) ), psTB0, vS0, vD0 );
...
/* ---- FCNI_VO(tgCO_TB_Clip) ---------------------------------------------------------------------------------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgINLINE TgRESULT FCNI_VO(tgCO_TB_Clip)( VEC_OBJ_T(STg2_CO_Clip_List,PC) psCL, VEC_OBJ_T(TgTUBE,CPC) psTB0, VEC_T(1,C) vS0, VEC_T(1,C) vD0 )
{
    VEC_T(1)                            vT0, vT1, vN0, vN1;
    TgRESULT                            iResult;
...
/*# !defined (TEMPLATE_TYPE_EXPANSION__RELOAD) */
    ...
    #define TGS_COLLISION_TUBE_LINEAR_INL
...
/*# !defined(TGS_COLLISION_TUBE_LINEAR_INL) */
#endif
