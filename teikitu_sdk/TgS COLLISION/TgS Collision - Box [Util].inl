...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgINLINE VEC_OBJ_T(TgRECTANGLE,P) FCN_VO(tgCO_BXF_Init_Face)( VEC_OBJ_T(TgRECTANGLE,PC) psRT0, VEC_OBJ_T(TgBOX,CPC) psBX0, TgSINT_E32_C i0 )
{
    VEC_T(1)                            vK0, vK1, vK2;
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgINLINE TgRESULT FCN_VO(tgCO_BXF_Clip)( VEC_OBJ_T(STg2_CO_Clip_List,PC) psCL, VEC_OBJ_T(TgBOX,CPC) psBX0, TgSINT_E32_C i0 )
{
