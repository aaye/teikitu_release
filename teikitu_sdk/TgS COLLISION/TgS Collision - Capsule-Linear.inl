...
/*  »Project«   Teikitu Gaming System (TgS) (∂)
    »File«      TgS Collision - Capsule-Linear.inl
...
/* =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-==-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- */
#if !defined(TGS_COLLISION_CAPSULE_LINEAR_INL)
...
/* ---- FCNI_VO(tgCO_CP_Clip) ---------------------------------------------------------------------------------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgINLINE TgRESULT FCNI_VO(tgCO_CP_Clip)( VEC_OBJ_T(STg2_CO_Clip_List,PC) psCL, VEC_OBJ_T(TgTUBE,CPC) psCP0, VEC_T(1,C) vS0, VEC_T(1,C) vD0 )
{
    ...
    if (TgFAILED(iResult = FCNI_VO(tgCO_CP_Contact)( &vT0, &vT1, &vN0, &vN1, psCP0, vS0, vD0 )))
    {
        psCL->m_nuiPoint = 0;
        return (iResult);
    };
...
/* ---- FCNI_VO(tgCO_CP_Clip_PM) ------------------------------------------------------------------------------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgINLINE TgRESULT FCNI_VO(tgCO_CP_Clip_PM)( VEC_T(1,PC) pvT0, VEC_T(1,PC) pvT1, VEC_OBJ_T(TgTUBE,CPC) psCP0, VEC_T(1,C) vS0, VEC_T(1,C) vD0 )
{
    VEC_T(1)                            vT0, vT1, vN0, vN1;
    TgRESULT                            iResult;
...
/*# !defined (TEMPLATE_TYPE_EXPANSION__RELOAD) */
    ...
    #define TGS_COLLISION_CAPSULE_LINEAR_INL
...
/*# !defined(TGS_COLLISION_CAPSULE_LINEAR_INL) */
#endif
