...
FCN_VO(tgCO_REQ_Init_Test)(
    VEC_OBJ_T(STg2_CO_Request,PC) OUT0, ETgPM_SHORT_C ARG1, ETgCO_PURPOSE_C ARG2 );
...
FCN_VO(tgCO_REQ_Init_Test_Sweep)(
    VEC_OBJ_T(STg2_CO_Request,PC) OUT1, ETgPM_SHORT_C ARG1, VEC_T(1,C) ARG2, ETgCO_PURPOSE_C ARG3 );
...
FCN_VO(tgCO_REQ_Init_Sweep)(
    VEC_OBJ_T(STg2_CO_Request,PC) OUT0, ETgPM_SHORT_C ARG1, VEC_T(1,C) ARG2, ETgCO_PURPOSE_C ARG3 );
...
FCN_VO(tgCO_REQ_Set_Include_Filter)(
    VEC_OBJ_T(STg2_CO_Request,PC) OUT0, TgUINT_E32_C ARG1 );
...
FCN_VO(tgCO_REQ_Ignore_Native_String)(
    VEC_OBJ_T(STg2_CO_Request,PC) OUT0, TgSINT_E32_C ARG1, TgBOOL_C ARG2 );
...
FCN_VO(tgCO_REQ_Is_Ignored_Native_String)(
    VEC_OBJ_T(STg2_CO_Request,CPC) ARG0, TgSINT_E32_C ARG1 );
