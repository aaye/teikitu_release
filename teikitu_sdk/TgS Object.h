...
/** @brief Standard Module function: First part of initialization process. Set the state of the module.
    @return Result Code. */
TgINLINE TgRESULT
tgOB_Module_Init( TgVOID ) { return KTgS_OK; }
...
/** @brief Standard Module function: Last part of initialization process. Used for setup and other necessary tasks prior to the use of the module.
    @return Result Code. */
TgINLINE TgRESULT
tgOB_Module_Boot( TgVOID ) { return KTgS_OK; }
...
TgINLINE TgRESULT
tgOB_Load_Config( TgVOID ) { return KTgS_OK; }

/** @brief Standard Module function: Save the current configuration of the module. */
TgINLINE TgRESULT
tgOB_Save_Config( TgVOID ) { return KTgS_OK; }
...
TgINLINE TgBOOL
tgOB_Query_Init( TgVOID ) { return true; }
...
TgINLINE TgBOOL
tgOB_Query_Boot( TgVOID ) { return true; }
...
TgINLINE TgRSIZE
tgOB_Query_Fixed_Memory( TgVOID ) { return 0u; }
...
TgINLINE TgVOID
tgOB_Attach(
    TgOBJECT_INST_ID_C TgATTRIBUTE_MAYBE_UNUSED ARG0, TgOBJECT_INST_ID_C TgATTRIBUTE_MAYBE_UNUSED ARG1, TgBOOL_C TgATTRIBUTE_MAYBE_UNUSED ARG2 ) {}
