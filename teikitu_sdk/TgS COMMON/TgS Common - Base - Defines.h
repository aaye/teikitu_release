...
#if defined(TgCOMPILE_FILE__CXX) && !((defined(_MSVC_LANG) && _MSVC_LANG >= 202002L) || (defined(__cplusplus) && (__cplusplus >= 202002L)))
    #error Codebase developed and tested against C++20
#endif
...
#define TgMACRO_USZ_MACRO(A)                TgMACRO_USZ( A )
...
#define TgCOMPILE_PRINT_SIZE(A)             char (*__fail)(void)[sizeof( A )] = 1 // static char( *__kaboom )[sizeof( A )] = 1
...
#define TgCOLOUR_R(COL_U32)                 ((COL_U32      ) & 0xFF)
        ...
        #define TgATTRIBUTE_NO_EXCEPT noexcept
    #else
        #define TgATTRIBUTE_NO_EXCEPT throw()
    #endif
#else
    #define TgATTRIBUTE_NO_EXCEPT
#endif
...
/* -.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.- */
    ...
    #else
	    #ifdef __COUNTER__
	        #define TgCOMPILER_ASSERT(e,c)          typedef TgATTRIBUTE_MAYBE_UNUSED char TgMACRO_CONCAT3(COMPILER_ASSERT_,0,__COUNTER__)[(e) != 0]
	    #else
	        #define TgCOMPILER_ASSERT(e,c)          typedef TgATTRIBUTE_MAYBE_UNUSED char TgMACRO_CONCAT3(COMPILER_ASSERT_,c,__LINE__)[(e) != 0]
	    #endif
    #endif
...
/*# TgCOMPILE_ASSERT && TgCOMPILE_ASSERT__CRITICAL */
    ...
    #define TgERROR_INDEX( A, B )               {                                                                                                                                   \
                                                    TgMSVC_ATTRIBUTE(__analysis_assume((A) < ( sizeof(B) / sizeof((B)[0]) )));                                                      \
                                                    if ( ((TgRSIZE)(A)) >= ( sizeof(B) / sizeof((B)[0]) ) ) TgATTRIBUTE_UNLIKELY                                                    \
                                                    {                                                                                                                               \
...
/*# TgCOMPILE_ASSERT && TgCOMPILE_ASSERT__ERROR */
    ...
    #define TgERROR_INDEX( A, B )               TgMSVC_ATTRIBUTE(__analysis_assume((A) < ( sizeof(B) / sizeof((B)[0]) )))
/*# TgCOMPILE_ASSERT && TgCOMPILE_ASSERT__ERROR */
#endif
...
/*# TgCOMPILE_ASSERT && TgCOMPILE_ASSERT__PARAM_CHECK */
    ...
    #define TgPARAM_CHECK_INDEX( A, B )         TgMSVC_ATTRIBUTE(__analysis_assume((A) < ( sizeof(B) / sizeof((B)[0]) )))
    #define TgPARAM_VAR( ... )                  TgMSVC_ATTRIBUTE(__VA_ARGS__)
/*# TgCOMPILE_ASSERT && TgCOMPILE_ASSERT__PARAM_CHECK */
#endif
    ...
    #define TgDIAG_MSG( A, ... )                {                                                                                                                                   \
                                                    ...
                                                    TgANALYSIS_ASSUME(A);                                                                                                           \
                                                    if ((!bSkip) && !(A)) TgATTRIBUTE_UNLIKELY                                                                                      \
                                                    {                                                                                                                               \
...
/*# TgCOMPILE_ASSERT && TgCOMPILE_ASSERT__DIAG */
    ...
    #define TgVERIFY_MSG( A, ... )              {                                                                                                                                   \
                                                    static TgBOOL bSkip = false;                                                                                                    \
                                                    TgANALYSIS_ASSUME(A);                                                                                                           \
                                                    if (!(A) && (!bSkip)) TgATTRIBUTE_UNLIKELY                                                                                      \
                                                    {                                                                                                                               \
...
#define MAKE_TgRESULT(fac,code)             ((TgSINT_E32) (((TgRESULT)(fac)<<16) | ((TgRESULT)(code))))
...
#define TgSUCCEEDED(Status)                 ((TgSINT_E32)(Status) >= 0)
#define TgFAILED(Status)                    ((TgSINT_E32)(Status) <  0)
...
#define TgTYPE_ENUM_FLAG(A,B,...)           typedef enum TgCLANG_ATTRIBUTE(enum_extensibility(closed),flag_enum)                                                                    \
    ...
    #define TgSTD_ATOMIC(name)                  std::atomic_##name
    #define TgSTD_MEMORY_ORDER(name)            std::memory_order_##name
    #define TgCXX_CONSTRUCTOR(...)              __VA_ARGS__

    #if !defined(ATOMIC_VAR_INIT) || (__cplusplus >= 202002L)
        #define TgSTD_ATOMIC_VAR_INIT(x)            x
    #else
        #define TgSTD_ATOMIC_VAR_INIT(x)            ATOMIC_VAR_INIT(x)
    #endif

#else

    #define TgSTD_ATOMIC(name)                  atomic_##name
    #define TgSTD_MEMORY_ORDER(name)            memory_order_##name
    #define TgCXX_CONSTRUCTOR(...)

    #if !defined(ATOMIC_VAR_INIT) || (__STDC_VERSION__ >= 201710L)
        #define TgSTD_ATOMIC_VAR_INIT(x)            x
    #else
        #define TgSTD_ATOMIC_VAR_INIT(x)            ATOMIC_VAR_INIT(x)
    #endif
