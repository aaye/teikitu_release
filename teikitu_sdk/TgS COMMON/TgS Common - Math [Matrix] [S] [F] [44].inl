...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgINLINE TgVOID FCN_M(tgMH_Init_Quat_S)( MAT_S_T(PCU) pmOut, VEC_S_T(1,C) qR0 )
{
    FCN_M(tgMH_Set_Quat_S)( pmOut, qR0 );
    pmOut->_41 = TYPE_K(0);
    pmOut->_42 = TYPE_K(0);
    pmOut->_43 = TYPE_K(0);
    pmOut->m_avCol[3] = VEC_K(KTgUNIT_W_S);
...
{
    FCN_V(tgMH_Init_Reference_Frame_From_Vector_And_Position_S,3)( (VEC_S_T(3,P))pmOut, vAxis, vS0 );
    pmOut->m_avCol[3] = VEC_K(KTgUNIT_W_S);
}
