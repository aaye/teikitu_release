...
TgTYPE_STRUCT(STg2_MM_MGR,)
{
    ...
    TgRESULT                                    (*m_pfnReserve)( TgMEM_INFO_HEADER_P NONULL OUT0, TgVOID_PP NONULL OUT1, TgRSIZE_C ARG2 );
                                                ...
                                                /** @return Return the number of bytes to commit that will fit the number of requested bytes on fully committed pages. */
    TgRSIZE                                     (*m_pfnCommit_Size)( TgRSIZE_C ARG0 );
...
TgEXTN TgRESULT
tgMM_Commit_Size(
    TgRSIZE_P NONULL OUT0, ETgMM_ALLOCATOR_C ARG1, TgRSIZE_C ARG2 );
