...
TgEXTN TgRESULT                             FCN(Compare_Internal)( TgSINT_E08_P, CHAR(CPC) ARG1, TgRSIZE_C, TgRSIZE_C, CHAR(CPC), TgRSIZE_C, TgRSIZE_C, TgRSIZE_C, TgBOOL_C,
                                                                   TgBOOL_C );
...
/* ---- FCN(To_U08) -------------------------------------------------------------------------------------------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgINLINE TgUINT_E08 FCN(To_U08)( CHAR(CPC) ARG0, TgRSIZE_C ARG1 )
{
    return ((TgUINT_E08)tgCM_MIN_U32( KTgMAX_U08, FCN(To_U32)( ARG0, ARG1 ) ));
}


/* ---- FCN(To_U16) -------------------------------------------------------------------------------------------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgINLINE TgUINT_E16 FCN(To_U16)( CHAR(CPC) ARG0, TgRSIZE_C ARG1 )
{
    return ((TgUINT_E16)tgCM_MIN_U32( KTgMAX_U16, FCN(To_U32)( ARG0, ARG1 ) ));
}


/* ---- FCN(To_S08) -------------------------------------------------------------------------------------------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgINLINE TgSINT_E08 FCN(To_S08)( CHAR(CPC) ARG0, TgRSIZE_C ARG1 )
{
    return ((TgSINT_E08)tgCM_CLP_S32( FCN(To_S32)( ARG0, ARG1 ), KTgMIN_S08, KTgMAX_S08 ));
}


/* ---- FCN(To_S16) -------------------------------------------------------------------------------------------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgINLINE TgSINT_E16 FCN(To_S16)( CHAR(CPC) ARG0, TgRSIZE_C ARG1 )
{
    return ((TgSINT_E16)tgCM_CLP_S32( FCN(To_S32)( ARG0, ARG1 ), KTgMIN_S16, KTgMAX_S16 ));
}


/* ---- FCN(Compare) ------------------------------------------------------------------------------------------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgINLINE TgRESULT FCN(Compare)( TgSINT_E08_P OUT0, CHAR(CPC) ARG1, TgRSIZE_C ARG2, TgRSIZE_C ARG3, CHAR(CPC) ARG4, TgRSIZE_C ARG5, TgRSIZE_C ARG6 )
{
...
/* ---- FCN(Compare_NoCase) ------------------------------------------------------------------------------------------------------------------------------------------------------ */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgINLINE TgRESULT FCN(Compare_NoCase)( TgSINT_E08_P OUT0, CHAR(CPC) ARG1, TgRSIZE_C ARG2, TgRSIZE_C ARG3, CHAR(CPC) ARG4, TgRSIZE_C ARG5, TgRSIZE_C ARG6 )
{
...
/* ---- FCN(CompareN) ------------------------------------------------------------------------------------------------------------------------------------------------------------ */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgINLINE TgRESULT FCN(CompareN)( TgSINT_E08_P OUT0, CHAR(CPC) ARG1, TgRSIZE_C ARG2, TgRSIZE_C ARG3, CHAR(CPC) ARG4, TgRSIZE_C ARG5, TgRSIZE_C ARG6, TgRSIZE_C ARG7 )
{
...
/* ---- FCN(CompareN_NoCase) ----------------------------------------------------------------------------------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgINLINE TgRESULT FCN(CompareN_NoCase)( TgSINT_E08_P OUT0, CHAR(CPC) ARG1, TgRSIZE_C ARG2, TgRSIZE_C ARG3, CHAR(CPC) ARG4, TgRSIZE_C ARG5, TgRSIZE_C ARG6, TgRSIZE_C ARG7 )
{
