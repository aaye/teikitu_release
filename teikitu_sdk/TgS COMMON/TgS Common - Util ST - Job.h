...
TgTYPE_STRUCT(STg2_Job,typedef TgRESULT( *TgFCN_JOB_CALLBACK )(STg2_Job const * const);)
{
    union
    {
        TgALIGN(16) STg2_UT_ST__QU_Node             m_sQueue;
        STg2_UT_ST__ST_Node                         m_sStack;
        TgUINT_E08                                  m_uiAlign[16];
    }                                           m_sNode;
...
TgCOMPILER_ASSERT( sizeof( STg2_Job ) == 512, 0 );
