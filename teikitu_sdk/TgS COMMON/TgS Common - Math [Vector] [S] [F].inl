...
TgINLINE VEC_S_T(1) FCN_V(tgMH_NORM_LEN_S)( VAR_T(P) pfLength, VEC_S_T(1,C) vS0 )
{
    ...
    VAR_T(C)        fMX = FCN_F(tgCM_MAX)( fM0, fM1 );
    VAR_T(C)        fM2 = fMX > VAR_K(KTgEPS) ? TYPE_K(1) / fMX : TYPE_K(0);
    VAR_T(C)        f0 = vS0.m_aData[0] * fM2;
    VAR_T(C)        f1 = vS0.m_aData[1] * fM2;
    VAR_T(C)        f2 = vS0.m_aData[2] * fM2;
    VAR_T(C)        f3 = vS0.m_aData[3] * fM2;
