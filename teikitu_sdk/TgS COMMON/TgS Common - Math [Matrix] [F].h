...
/** @addtogroup TGS_COMMON_MATH_VECTOR_LOAD
    @brief Initialize an eigen matrix forming a basis based on the vector at ARG1-2
    @param [out] OUT0 Matrix
...
/** @addtogroup TGS_COMMON_MATH_VECTOR_LOAD
    @brief Initialize an eigen matrix forming a basis based on the vector at ARG1-4
    @param [out] OUT0 Matrix
