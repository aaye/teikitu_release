...
#pragma once
    ...
    #endif
    #if defined(TgBUILD_HARDWARE) && !defined(TgBUILD_HARDWARE__C17_ARM) && !defined(TgBUILD_HARDWARE__C17_X64) && !defined (TGS_COMMON_MATH_API_VECTOR_SPECIALIZATION_INL)
...
#include "TgS COMMON/TgS Common - Math [Vector] [API].inl"
    ...
    #endif
    #if defined(TgBUILD_HARDWARE) && !defined(TgBUILD_HARDWARE__C17_ARM) && !defined(TgBUILD_HARDWARE__C17_X64) && !defined (TGS_COMMON_MATH_API_MATRIX_SPECIALIZATION_INL)
