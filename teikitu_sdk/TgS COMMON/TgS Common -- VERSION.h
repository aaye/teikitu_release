...
/* Brief: September 2022 - Short lived version to represent the full bring up the Render, Physics, and Execution Modules. Moved to 5.21 to represent the change in directory
          structure.
*/

/* 5.21 */ /* AEEC8393-9780-4ECA-918D-E3E11F7E2744 */
/*  Brief: September 2022 - This version will represent the bring up of the Physics and Execution Modules. (Working non-test executable.)
    Description: Changed directory structure to support a SDK development model. Tests moved out to be inline with application development, and the first application, an asset
    viewer tool was created. The goal is a bring up of the execution module so that frame update sequencing can be established, and synchronizations issues resolved. Frame rate
    target continues to be 120 FPS. Once execution is running, then fleshing out of set, render and physics will be the next set of goals. Extracted out the memory manager into
    its own DLL, and enabled it for preloading and malloc takeover. First pass Physics implementation now complete.
 */

/* 5.22 */ /* 7ECEAB43-40E4-4161-8F94-87AF31F5BA9A */
/*  Brief: September 2023 - This version will represent the bring up of a Vulkan Render Module.
    Description: 
 */
