...
FCN_VO(tgGM_RY_Reset)(
    VEC_OBJ_T(TgRAY,PCU) TgANALYSIS_NO_NULL OUT );
...
FCN_VO(tgGM_RY_Is_Valid)(
    VEC_OBJ_T(TgRAY,CPCU) TgANALYSIS_NO_NULL ARG );
...
TgINLINE TgVOID
FCN_VO(tgGM_RY_BA)(
    VEC_OBJ_T(TgBOXAA,PCU) TgANALYSIS_NO_NULL ARG0, VEC_OBJ_T(TgRAY,CPCU) TgANALYSIS_NO_NULL ARG1 );
...
FCN_VO(tgGM_RY_Sweep_BA)(
    VEC_OBJ_T(TgBOXAA,PCU) TgANALYSIS_NO_NULL ARG0, VEC_OBJ_T(TgRAY,CPCU) TgANALYSIS_NO_NULL ARG1, VEC_T(1,C) ARG2 );
...
FCN_VO(tgGM_RY_Project)(
    VEC_T(1,PCU) TgANALYSIS_NO_NULL ARG0, VEC_T(1,PCU) TgANALYSIS_NO_NULL ARG1, VEC_OBJ_T(TgRAY,CPCU) TgANALYSIS_NO_NULL ARG2, VEC_T(1,C) ARG3 );
...
FCN_VO(tgGM_RY_Is_Contained)(
    VEC_OBJ_T(TgRAY,CPCU) TgANALYSIS_NO_NULL ARG0, VEC_T(1,C) ARG1 );
...
TgINLINE TgVOID
FCN_VO(tgGM_RY_TX)(
    VEC_OBJ_T(TgRAY,PCU) TgANALYSIS_NO_NULL ARG0, VEC_T(3,CPCU) TgANALYSIS_NO_NULL ARG1 );
...
FCN_VO(tgGM_RY_Copy_TX)(
    VEC_OBJ_T(TgRAY,PCU) TgANALYSIS_NO_NULL ARG0, VEC_OBJ_T(TgRAY,CPCU) TgANALYSIS_NO_NULL ARG1, VEC_T(3,CPCU) TgANALYSIS_NO_NULL ARG2 );
...
TgINLINE TgVOID
FCN_VO(tgGM_RY_Init)(
    VEC_OBJ_T(TgRAY,PCU) TgANALYSIS_NO_NULL ARG0, VEC_T(1,C) ARG1, VEC_T(1,C) ARG2 );
...
TgINLINE TgVOID
FCN_VO(tgGM_RY_Copy)(
    VEC_OBJ_T(TgRAY,PCU) TgANALYSIS_NO_NULL ARG0, VEC_OBJ_T(TgRAY,CPCU) TgANALYSIS_NO_NULL ARG1 );
...
FCN_VO(tgGM_RY_Set_Origin)(
    VEC_OBJ_T(TgRAY,PCU) TgANALYSIS_NO_NULL ARG0, VEC_T(1,C) ARG1 );
