...
/* ---- FCN_VO(tgGM_RY_BA) ------------------------------------------------------------------------------------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgINLINE TgVOID FCN_VO(tgGM_RY_BA)( VEC_OBJ_T(TgBOXAA,PCU) psBA0, TgATTRIBUTE_MAYBE_UNUSED VEC_OBJ_T(TgRAY,CPCU) psRY0 )
{
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgINLINE TgVOID FCN_VO(tgGM_RY_Sweep_BA)( VEC_OBJ_T(TgBOXAA,PCU) psBA0, TgATTRIBUTE_MAYBE_UNUSED VEC_OBJ_T(TgRAY,CPCU) psRY0, TgATTRIBUTE_MAYBE_UNUSED VEC_T(1,C) vDT )
{
    FCN_VO(tgGM_BA_Set_Invalid)( psBA0 );
}
