...
/* -.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.- */
    ...
    #define TgCOMMIT_SIZE_VIRTUAL(A,B)          KTgS_OK
    ...
    #define TgMALLOC_EXACT(A)                   tgMM_Malloc_With_Trace( ETgMM_ALLOCATOR_OS, A, 16, TgU8_TEXT_WITH_QUOTE(__FILE__), __LINE__ )
    #define TgFREE__EXACT(A)                    tgMM_Free_With_Trace( ETgMM_ALLOCATOR_OS, A, TgU8_TEXT_WITH_QUOTE(__FILE__), __LINE__ )
    #define TgMALLOC_POOL(A)                    tgMM_Malloc_With_Trace( ETgMM_ALLOCATOR_POOL, A, 16, TgU8_TEXT_WITH_QUOTE(__FILE__), __LINE__ )
    #define TgFREE_POOL(A)                      tgMM_Free_With_Trace( ETgMM_ALLOCATOR_POOL, A, TgU8_TEXT_WITH_QUOTE(__FILE__), __LINE__ )
    #define TgREALLOC_POOL(A,B)                 tgMM_Realloc_With_Trace( ETgMM_ALLOCATOR_POOL, A, B, 16, TgU8_TEXT_WITH_QUOTE(__FILE__), __LINE__ )
    #define TgMALLOC_TEMP(A)                    tgMM_Malloc( ETgMM_ALLOCATOR_POOL, A, 16 )
    ...
    #define TgCOMMIT_SIZE_VIRTUAL(A,B)          tgMM_Commit_Size( A, ETgMM_ALLOCATOR_OS, B )
    #define TgCOMMIT_VIRTUAL(A,B)               tgMM_Commit_With_Trace( ETgMM_ALLOCATOR_OS, A, B, TgU8_TEXT_WITH_QUOTE(__FILE__), __LINE__ )
    #define TgFREE_VIRTUAL(A)                   tgMM_Free_With_Trace( ETgMM_ALLOCATOR_OS, A, TgU8_TEXT_WITH_QUOTE(__FILE__), __LINE__ )
#else
    #define TgMALLOC_EXACT(A)                   tgMM_Malloc( ETgMM_ALLOCATOR_OS, A, 16 )
    #define TgFREE__EXACT(A)                    tgMM_Free( ETgMM_ALLOCATOR_OS, A )
    #define TgMALLOC_POOL(A)                    tgMM_Malloc( ETgMM_ALLOCATOR_POOL, A, 16 )
    #define TgFREE_POOL(A)                      tgMM_Free( ETgMM_ALLOCATOR_POOL, A )
    #define TgREALLOC_POOL(A,B)                 tgMM_Realloc( ETgMM_ALLOCATOR_POOL, A, B, 16 )
    #define TgMALLOC_TEMP(A)                    tgMM_Malloc( ETgMM_ALLOCATOR_POOL, A, 16 )
    #define TgFREE_TEMP(A)                      tgMM_Free( ETgMM_ALLOCATOR_POOL, A )
...
#define TgKI_CUSTOM_DECLARE_AND_INLINE_2(A)                                                                                                                                         \
    ...
    {                                                                                                                                                                               \
        ...
        CXX_CONSTRUCTOR(Tg##A##_SINGLETON(): m_uiKI(KTgMAX_U64) {})                                                                                                                 \
    };                                                                                                                                                                              \
                                                                                                                                                                                    \
