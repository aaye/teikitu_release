...
TgEXTN TgRESULT
tgJM_Queue_Job(
    TgJOB_QUEUE_ID_C ARG0, STg2_Job_CPC ARG1 );
...
tgJM_Spawn_Job_Thread(
    TgJOB_QUEUE_ID_CPC ARG0, TgUINT_E32 ARG1, ETgTHREAD_PRIORITY_C ARG2, TgCHAR_U8_CPC ARG3 );
