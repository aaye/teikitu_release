...
TgINLINE TgVOID PIXBeginEvent_ThatWorksInC_ID3D12GraphicsCommandList( ID3D12GraphicsCommandList8_P ARG0, TgATTRIBUTE_MAYBE_UNUSED UINT64 ARG1, TgCHAR_NC_CPC ARG2 );
...
TgINLINE TgVOID PIXBeginEvent_ThatWorksInC_ID3D12CommandQueue( ID3D12CommandQueue_P ARG0, TgATTRIBUTE_MAYBE_UNUSED UINT64 ARG1, TgCHAR_NC_CPC ARG2 );
