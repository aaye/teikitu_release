...
#include <directx/minwindefine.h> /**< Defines IUnknown */
#include <directx/dxcore.h> /**< Needs to be a local copy due to author's prejudice against C. Fixed issues with dxcore_interface.h */
