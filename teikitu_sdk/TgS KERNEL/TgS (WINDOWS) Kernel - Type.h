...
/*  »Project«   Teikitu Gaming System (TgS) (∂)
    »File«      TgS (WINDOWS) Kernel - Type.h
...
{
    TgUINT_E32                                  m_uiRender_Target_W; /**< Assumed to be 1:1 for window, and thus equal to the client rect */
    TgUINT_E32                                  m_uiRender_Target_H; /**< Assumed to be 1:1 for window, and thus equal to the client rect */

    TgSINT_E32                                  m_iWindow_X0; /**< Left coordinate of the window, ignored if KTgMIN_S32. */
    TgSINT_E32                                  m_iWindow_Y0; /**< Top coordinate of the window, ignored if KTgMIN_S32. */
