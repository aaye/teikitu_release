...
tgKN_GPU_EXT__CMD__Render_Debug_Text(
    UTg2_KN_GPU_CMD_C ARG0, TgRSIZE ARG1, STg2_KN_GPU_HLSL_CB_Debug_Text_CPC TgANALYSIS_NO_NULL ARG2 );
...
tgKN_GPU_EXT__CMD__Render_Debug_UI(
    UTg2_KN_GPU_CMD_C ARG0, STg2_KN_GPU_HLSL_CB_Debug_UI_CPC TgANALYSIS_NO_NULL ARG1 );
...
tgKN_GPU_EXT__CMD__Render_Debug_Geom(
    UTg2_KN_GPU_CMD_C ARG0, ETgKN_GPU_DEBUG_PM ARG1, STg2_KN_GPU_HLSL_CB_Debug_Model_CPC TgANALYSIS_NO_NULL ARG2 );
...
tgKN_GPU_EXT__CMD__Render_Debug_Line(
    UTg2_KN_GPU_CMD_C ARG0, STg2_KN_GPU_Vertex_Geom_01_CPCU ARG1, TgRSIZE_C ARG2, STg2_KN_GPU_HLSL_CB_Debug_Line_CPC TgANALYSIS_NO_NULL ARG3 );
...
tgKN_GPU_EXT__Execute__Init_Data_Buffer_1(
    TgVOID_PP TgANALYSIS_NO_NULL OUT0, UTg2_KN_GPU_CMD_C ARG1, TgVOID_CP TgANALYSIS_NO_NULL ARG2, TgRSIZE_C ARG3 );
...
/** @brief Initialize and upload two data buffers using the provided command list. The output parameters are a pointer to a pointer to the resulting API resource.
    @details Usually used to upload a vertex and index buffer.
    @param [in,out] OUT0 Pointer to a pointer to an API resource.
...
tgKN_GPU_EXT__Execute__Init_Data_Buffer_2(
    TgVOID_PP TgANALYSIS_NO_NULL OUT0, TgVOID_PP TgANALYSIS_NO_NULL OUT1, UTg2_KN_GPU_CMD_C ARG2, TgVOID_CP TgANALYSIS_NO_NULL ARG3, TgRSIZE_C ARG4,
    TgVOID_CP TgANALYSIS_NO_NULL ARG5, TgRSIZE_C ARG6 );
