...
TgRESULT tgIN_PM_Stop_Keyboard( TgVOID )
{
    ...
    g_asController_Active[ETgCONTROLLER_KEYBOARD].m_enController = ETgCONTROLLER_MAX;
    g_asController_Active[ETgCONTROLLER_KEYBOARD].m_psConsumer = nullptr;
...
{
    TgUINT_F32_C    uiID = (TgUINT_F32)(enController - ETgCONTROLLER_KEYBOARD);
    TgUINT_F32_C    uiNext_Buffer = s_asKeyboard[uiID].m_uiBuffer ^ 1;
    TgUINT_F32                          uiIndex;
    TgUINT_F32                          uiEvent;
    TgUINT_F32                          uiState = ETgSTATE_KEYBOARD_VALID;
    ...
    {
        TgUINT_F32_C    uiDIK = s_auiKEY_DIK[uiIndex].m_uiDIK;
        ...
        g_asController_Active[enController].m_asEvent[uiEvent].m_uiUTF32 = (TgUINT_F32)s_auiKEY_DIK[uiIndex].m_uiChar;
