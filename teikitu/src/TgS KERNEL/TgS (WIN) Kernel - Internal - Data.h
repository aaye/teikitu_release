...
/*  »Project«   Teikitu Gaming System (TgS) (∂)
    »File«      TgS (WIN) Kernel - Internal - Data.h
...
/* =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-==-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=--=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-= */
#if !defined(TGS__WIN_KERNEL_INTERNAL_DATA_H)
#define TGS__WIN_KERNEL_INTERNAL_DATA_H
#pragma once
...
TgEXTN TgUINT_F32                           g_uiKN_Default_Window_Style;
TgEXTN WNDPROC                              g_pfnKN_Default_WndProc;

TgEXTN TgSINT_F32                           g_iKN_Window_PadX;
TgEXTN TgSINT_F32                           g_iKN_Window_PadY;
...
TgEXTN TgVOID                               (*g_pfnQuery_Monitor_Min_Resolution)(TgUINT_F32_P, TgUINT_F32_P, HMONITOR);
TgEXTN TgVOID                               (*g_pfnQuery_Monitor_Max_Resolution)(TgUINT_F32_P, TgUINT_F32_P, HMONITOR);
TgEXTN TgVOID                               (*g_pfnQuery_Swap_Context_Mode_Width_and_Height)(TgUINT_F32_P, TgUINT_F32_P, HWND, HMONITOR);
TgEXTN TgVOID                               (*g_pfnQuery_Swap_Context_Closest_Mode_Rounded_Down)(TgUINT_F32_P, TgUINT_F32_P, HWND, HMONITOR);
...
TgEXTN TgVOID                               (__stdcall *g_pfnRaiseException)(DWORD, DWORD, DWORD, TgUINT_F64_CP);
...
TgEXTN BOOL                                 (__stdcall *g_pfnEnumDisplayMonitors)(HDC, LPCRECT, MONITORENUMPROC, TgSINT_F64);
...
TgEXTN TgSINT_F64                           (__stdcall *g_pfnGetWindowLongPtr)(HWND, TgSINT_F32);
TgEXTN TgSINT_F64                           (__stdcall *g_pfnSetWindowLongPtr)(HWND, TgSINT_F32, TgSINT_PTR);

/*  API Set: ext-ms-win-ntuser-window-l1-1-0 */
TgEXTN HWND                                 (__stdcall *g_pfnCreateWindowEx)(DWORD, TgOSCHAR_CP, TgOSCHAR_CP, DWORD, TgSINT_F32, TgSINT_F32, TgSINT_F32, TgSINT_F32, HWND, HMENU, 
                                                                             HINSTANCE, TgVOID_P);
TgEXTN BOOL                                 (__stdcall *g_pfnDestroyWindow)(HWND);
TgEXTN BOOL                                 (__stdcall *g_pfnShowWindow )(HWND, TgSINT_F32);
...
TgEXTN TgSINT_F64                           (__stdcall *g_pfnDefWindowProc)(HWND, TgUINT_F32, TgUINT_F64, TgSINT_F64);
TgEXTN BOOL                                 (__stdcall *g_pfnSetWindowPos)(HWND, HWND, TgSINT_F32, TgSINT_F32, TgSINT_F32, TgSINT_F32, TgUINT_F32);
...
TgEXTN BOOL                                 (__stdcall *g_pfnPeekMessage)(LPMSG, HWND, TgUINT_F32, TgUINT_F32, TgUINT_F32);
TgEXTN BOOL                                 (__stdcall *g_pfnGetMessage)(LPMSG, HWND, TgUINT_F32, TgUINT_F32);
TgEXTN BOOL                                 (__stdcall *g_pfnTranslateMessage)(const MSG *);
TgEXTN TgVOID                               (__stdcall *g_pfnPostQuitMessage)(TgSINT_F32);
TgEXTN TgSINT_F64                           (__stdcall *g_pfnDispatchMessage)(const MSG *);
TgEXTN TgSINT_F64                           (__stdcall *g_pfnSendMessage)(HWND, TgUINT_F32, TgUINT_F64, TgSINT_F64);
TgEXTN BOOL                                 (__stdcall *g_pfnPostMessage)(HWND, TgUINT_F32, TgUINT_F64, TgSINT_F64);

/* shell32 */
TgEXTN HRESULT                              (__stdcall *g_pfnSHGetKnownFolderPath)(const GUID *, DWORD, HANDLE, PWSTR *);

/* (WIN) COMMON, API Set: ext-ms-win-ntuser-sysparams-ext-l1-1-0 */
TgEXTN TgSINT_F32                           (__stdcall *g_pfnGetSystemMetrics)(TgSINT_F32);


/* =============================================================================================================================================================================== */
#endif
/* (WIN) KERNEL, DLL: user32 */
