...
tgKN_OS_Set_Window_Title_Internal(
    TgSINT_PTR_C iWindow_Index, TgBOOL_C bDefault, TgBOOL_C bDimension, TgOSCHAR_CPC oszText, TgRSIZE_C nuiText );

static TgNOTHROW TgUINT_F32
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgSINT_E32 tgKN_OS_Create_Window( STg2_KN_OS_Window_Configuration_CPC psKN_OS_Window_Configuration )
{
    ...
    iWindow = (TgSINT_E32)(sHWND.ps - g_asKN_Wnd);
    ...
    if (sHWND.ps->m_sConfig.m_bCenterOnMonitor)
    {
        ...
        sHWND.ps->m_sConfig.m_iWindow_X0 = (iMonitor_W >> 1) - (((TgSINT_F32)sHWND.ps->m_sConfig.m_uiRender_Target_W + g_iKN_Window_PadX) >> 1);
        sHWND.ps->m_sConfig.m_iWindow_Y0 = (iMonitor_H >> 1) - (((TgSINT_F32)sHWND.ps->m_sConfig.m_uiRender_Target_H + g_iKN_Window_PadY) >> 1);
    };
    ...
    return ((TgSINT_E32)(sHWND.ps - g_asKN_Wnd));
}
...
TgVOID tgKN_OS_Window_FullScreen( TgSINT_PTR_C iWindow_Index )
{
    ...
    g_asKN_Wnd[iWindow_Index].m_iWindow_Saved_W = (TgSINT_F32)g_asKN_Wnd[iWindow_Index].m_sConfig.m_uiRender_Target_W;
    g_asKN_Wnd[iWindow_Index].m_iWindow_Saved_H = (TgSINT_F32)g_asKN_Wnd[iWindow_Index].m_sConfig.m_uiRender_Target_H;
    ...
    tgKN_OS_Set_Window_Title_Internal( iWindow_Index, true, true, nullptr, 0 );
}
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgSINT_F64 __stdcall tgKN_OS_Base_Window_Update( HWND hWnd, TgUINT_F32 uMessage, TgUINT_F64 wParam, TgSINT_F64 lParam )
{
    ...
    switch (uMessage)
    {
        ...
        SWITCH_FALLTHROUGH case WM_KEYDOWN:
        SWITCH_FALLTHROUGH case WM_KEYUP:
        SWITCH_FALLTHROUGH case WM_SYSKEYUP:
        ...
        SWITCH_FALLTHROUGH case WM_LBUTTONDOWN:
        SWITCH_FALLTHROUGH case WM_LBUTTONUP:
        SWITCH_FALLTHROUGH case WM_LBUTTONDBLCLK:
        SWITCH_FALLTHROUGH case WM_MBUTTONDOWN:
        SWITCH_FALLTHROUGH case WM_MBUTTONUP:
        SWITCH_FALLTHROUGH case WM_MBUTTONDBLCLK:
        SWITCH_FALLTHROUGH case WM_RBUTTONDOWN:
        SWITCH_FALLTHROUGH case WM_RBUTTONUP:
        SWITCH_FALLTHROUGH case WM_RBUTTONDBLCLK:
        SWITCH_FALLTHROUGH case WM_XBUTTONDOWN:
        SWITCH_FALLTHROUGH case WM_XBUTTONUP:
        SWITCH_FALLTHROUGH case WM_XBUTTONDBLCLK:
        SWITCH_FALLTHROUGH case WM_MOUSEWHEEL:
        ...
        case WM_SIZING:
            ...
            {
                LPRECT                              pRect = (LPRECT)lParam;
                TgUINT_F32                          iW = (TgUINT_F32)(pRect->right - pRect->left - g_iKN_Window_PadX);
                TgUINT_F32                          iH = (TgUINT_F32)(pRect->bottom - pRect->top - g_iKN_Window_PadY);
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgVOID tgKN_OS_Set_Window_Title( TgSINT_PTR_C iWindow_Index, TgBOOL_C bDefault, TgBOOL_C bDimension, TgOSCHAR_CPC oszText, TgRSIZE_C nuiText )
{
    if (nullptr != oszText && 0 != nuiText)
    {
        g_asKN_Wnd[iWindow_Index].m_sConfig.m_bIncludeDefaultInTitle = bDefault;
        g_asKN_Wnd[iWindow_Index].m_sConfig.m_bIncludeDimensionsInTitle = bDimension;
        TgOS_TEXT_FCN( Copy )( g_asKN_Wnd[iWindow_Index].m_oszUpdate_Title, sizeof(g_asKN_Wnd[iWindow_Index].m_oszUpdate_Title), oszText, nuiText );
    }
}
...
TgVOID tgKN_ReCalc_Display( TgSINT_PTR_C iWindow_Index )
{
    ...
    g_asKN_Wnd[iWindow_Index].m_sConfig.m_uiRender_Target_W = (TgUINT_F32)(sRect.right - sRect.left);
    g_asKN_Wnd[iWindow_Index].m_sConfig.m_uiRender_Target_H = (TgUINT_F32)(sRect.bottom - sRect.top);
}
...
/* ---- tgKN_OS_Set_Window_Title_Internal ---------------------------------------------------------------------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
static TgVOID tgKN_OS_Set_Window_Title_Internal( TgSINT_PTR_C iWindow_Index, TgBOOL_C bDefault, TgBOOL_C bDimension, TgOSCHAR_CPC oszText, TgRSIZE_C nuiText )
{
...
/* ---- tgKN_OS_Create_Window_Thread --------------------------------------------------------------------------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
static TgNOTHROW TgUINT_F32 tgKN_OS_Create_Window_Thread( TgUINT_PTR_C uiParam )
{
    ...
    while (!g_bKN_Close_Windows)
    {
        ...
        {
            tgKN_OS_Set_Window_Title_Internal( iWindow_Index, g_asKN_Wnd[iWindow_Index].m_sConfig.m_bIncludeDefaultInTitle,
                                               g_asKN_Wnd[iWindow_Index].m_sConfig.m_bIncludeDimensionsInTitle, g_asKN_Wnd[iWindow_Index].m_oszUpdate_Title,
