...
TgCHAR_U8_CP tgKN_GPU_EXT_FMT_To_USZ( ETgKN_GPU_EXT_FORMAT_C enFormat )
{
    ...
    case ETgKN_GPU_EXT_FORMAT_B8G8R8X8_UNORM:
    SWITCH_FALLTHROUGH case ETgKN_GPU_EXT_FORMAT_R10G10B10_XR_BIAS_A2_UNORM:
    SWITCH_FALLTHROUGH case ETgKN_GPU_EXT_FORMAT_B8G8R8A8_TYPELESS:
    SWITCH_FALLTHROUGH case ETgKN_GPU_EXT_FORMAT_B8G8R8X8_TYPELESS:
    SWITCH_FALLTHROUGH case ETgKN_GPU_EXT_FORMAT_B8G8R8X8_UNORM_SRGB:
    SWITCH_FALLTHROUGH case ETgKN_GPU_EXT_FORMAT_BC6H_TYPELESS:
    SWITCH_FALLTHROUGH case ETgKN_GPU_EXT_FORMAT_BC6H_UF16:
    SWITCH_FALLTHROUGH case ETgKN_GPU_EXT_FORMAT_BC6H_SF16:
    SWITCH_FALLTHROUGH case ETgKN_GPU_EXT_FORMAT_BC7_TYPELESS:
    SWITCH_FALLTHROUGH case ETgKN_GPU_EXT_FORMAT_BC7_UNORM:
    SWITCH_FALLTHROUGH case ETgKN_GPU_EXT_FORMAT_BC7_UNORM_SRGB:
    SWITCH_FALLTHROUGH case ETgKN_GPU_EXT_FORMAT_AYUV:
    SWITCH_FALLTHROUGH case ETgKN_GPU_EXT_FORMAT_Y410:
    SWITCH_FALLTHROUGH case ETgKN_GPU_EXT_FORMAT_Y416:
    SWITCH_FALLTHROUGH case ETgKN_GPU_EXT_FORMAT_NV12:
    SWITCH_FALLTHROUGH case ETgKN_GPU_EXT_FORMAT_P010:
    SWITCH_FALLTHROUGH case ETgKN_GPU_EXT_FORMAT_P016:
    SWITCH_FALLTHROUGH case ETgKN_GPU_EXT_FORMAT_420_OPAQUE:
    SWITCH_FALLTHROUGH case ETgKN_GPU_EXT_FORMAT_YUY2:
    SWITCH_FALLTHROUGH case ETgKN_GPU_EXT_FORMAT_Y210:
    SWITCH_FALLTHROUGH case ETgKN_GPU_EXT_FORMAT_Y216:
    SWITCH_FALLTHROUGH case ETgKN_GPU_EXT_FORMAT_NV11:
    SWITCH_FALLTHROUGH case ETgKN_GPU_EXT_FORMAT_AI44:
    SWITCH_FALLTHROUGH case ETgKN_GPU_EXT_FORMAT_IA44:
    SWITCH_FALLTHROUGH case ETgKN_GPU_EXT_FORMAT_P8:
    SWITCH_FALLTHROUGH case ETgKN_GPU_EXT_FORMAT_A8P8:
    SWITCH_FALLTHROUGH case ETgKN_GPU_EXT_FORMAT_B4G4R4A4_UNORM:
    SWITCH_FALLTHROUGH case ETgKN_GPU_EXT_FORMAT_P208:
    SWITCH_FALLTHROUGH case ETgKN_GPU_EXT_FORMAT_V208:
    SWITCH_FALLTHROUGH case ETgKN_GPU_EXT_FORMAT_V408:
    SWITCH_FALLTHROUGH case ETgKN_GPU_EXT_FORMAT_SAMPLER_FEEDBACK_MIN_MIP_OPAQUE:
    SWITCH_FALLTHROUGH case ETgKN_GPU_EXT_FORMAT_SAMPLER_FEEDBACK_MIP_REGION_USED_OPAQUE:
    SWITCH_FALLTHROUGH case ETgKN_GPU_EXT_FORMAT_UNKNOWN:
