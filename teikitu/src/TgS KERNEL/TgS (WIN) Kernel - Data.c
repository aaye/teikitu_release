...
TgUINT_F32                                  g_uiKN_Default_Window_Style;
WNDPROC                                     g_pfnKN_Default_WndProc;

TgSINT_F32                                  g_iKN_Window_PadX;
TgSINT_F32                                  g_iKN_Window_PadY;
...
TgVOID                                      (*g_pfnQuery_Monitor_Min_Resolution)(TgUINT_F32_P, TgUINT_F32_P, HMONITOR) = nullptr;
TgVOID                                      (*g_pfnQuery_Monitor_Max_Resolution)(TgUINT_F32_P, TgUINT_F32_P, HMONITOR) = nullptr;
TgVOID                                      (*g_pfnQuery_Swap_Context_Mode_Width_and_Height)(TgUINT_F32_P, TgUINT_F32_P, HWND, HMONITOR) = nullptr;
TgVOID                                      (*g_pfnQuery_Swap_Context_Closest_Mode_Rounded_Down)(TgUINT_F32_P, TgUINT_F32_P, HWND, HMONITOR) = nullptr;
...
TgVOID                                      (__stdcall *g_pfnRaiseException)( DWORD, DWORD, DWORD, TgUINT_F64_CP  ) = nullptr;
...
BOOL                                        (__stdcall *g_pfnEnumDisplayMonitors)( HDC, LPCRECT, MONITORENUMPROC, TgSINT_F64  ) = nullptr;
...
TgSINT_F64                                  (__stdcall *g_pfnGetWindowLongPtr)( HWND, TgSINT_F32  ) = nullptr;
TgSINT_F64                                  (__stdcall *g_pfnSetWindowLongPtr)( HWND, TgSINT_F32 , TgSINT_PTR  ) = nullptr;

/*  API Set: ext-ms-win-ntuser-window-l1-1-0 */
HWND                                        (__stdcall *g_pfnCreateWindowEx)( DWORD, TgOSCHAR_CP, TgOSCHAR_CP, DWORD, TgSINT_F32 , TgSINT_F32 , TgSINT_F32 , TgSINT_F32 , HWND,
                                                                              HMENU, HINSTANCE, TgVOID_P ) = nullptr;
BOOL                                        (__stdcall *g_pfnDestroyWindow)( HWND ) = nullptr;
BOOL                                        (__stdcall *g_pfnShowWindow)( HWND, TgSINT_F32  ) = nullptr;
...
TgSINT_F64                                  (__stdcall *g_pfnDefWindowProc)( HWND, TgUINT_F32 , TgUINT_F64 , TgSINT_F64  ) = nullptr;
BOOL                                        (__stdcall *g_pfnSetWindowPos)( HWND, HWND, TgSINT_F32 , TgSINT_F32 , TgSINT_F32 , TgSINT_F32 , TgUINT_F32  ) = nullptr;
...
BOOL                                        (__stdcall *g_pfnPeekMessage)( LPMSG, HWND, TgUINT_F32 , TgUINT_F32 , TgUINT_F32  ) = nullptr;
BOOL                                        (__stdcall *g_pfnGetMessage)( LPMSG, HWND, TgUINT_F32 , TgUINT_F32  ) = nullptr;
BOOL                                        (__stdcall *g_pfnTranslateMessage)( const MSG * ) = nullptr;
TgVOID                                      (__stdcall *g_pfnPostQuitMessage)( TgSINT_F32  ) = nullptr;
TgSINT_F64                                  (__stdcall *g_pfnDispatchMessage)( const MSG * ) = nullptr;
TgSINT_F64                                  (__stdcall *g_pfnSendMessage)( HWND, TgUINT_F32 , TgUINT_F64 , TgSINT_F64  ) = nullptr;
BOOL                                        (__stdcall *g_pfnPostMessage)( HWND, TgUINT_F32 , TgUINT_F64 , TgSINT_F64  ) = nullptr;
