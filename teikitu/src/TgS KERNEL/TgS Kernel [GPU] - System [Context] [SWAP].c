...
TgVOID tgKN_GPU__SwapChain__Present_Print_Debug_Stats( UTg2_KN_GPU_CMD_C uCMD, TgKN_GPU_CXT_SWAP_ID_C tiCXT_SWAP )
{
    ...
    SWITCH_FALLTHROUGH case ETgKN_GPU_EXT_FORMAT_R8G8B8A8_UNORM_SRGB:
    SWITCH_FALLTHROUGH case ETgKN_GPU_EXT_FORMAT_B8G8R8A8_UNORM:
    SWITCH_FALLTHROUGH case ETgKN_GPU_EXT_FORMAT_B8G8R8A8_UNORM_SRGB:
