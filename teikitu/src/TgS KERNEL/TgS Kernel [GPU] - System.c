...
TgRESULT tgKN_GPU_Enumerate( TgVOID )
{
    ...
    {
        TgUINT_F32                          uiPrevious_Severity;
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgRESULT tgKN_GPU_Query_Adapter_List( STg2_KN_GPU_Adapter_CPP ppAdapter, TgUINT_F32_C nuiAdapter )
{
    TgRSIZE                             uiAdapter;
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgUINT_F32 tgKN_GPU_Query_Mode_List( STg2_KN_GPU_Mode_P psMode, TgUINT_F32_C niMode, TgUINT_F32_C uiAdapter, TgUINT_F32_C uiOutput, ETgKN_GPU_EXT_FORMAT_C enFormat )
{
