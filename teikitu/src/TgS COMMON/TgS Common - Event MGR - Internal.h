...
TgINLINE TgRESULT                           tgEM_TE_FRM_Lock( TgEM_TE_FRM_ID, TgUINT_F32_C, TgUINT_F32_C );
TgINLINE TgRESULT                           tgEM_TE_SEC_Lock( TgEM_TE_SEC_ID, TgUINT_F32_C, TgUINT_F32_C );
