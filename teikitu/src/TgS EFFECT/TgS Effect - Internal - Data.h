...
TgEXTN TgUINT_F32_C                         g_uiFX_Command_Size[ETgFX_COMMAND__MAX + 1];
...
TgEXTN TgUINT_F32                           g_uiParticle_Header_Index;
...
TgEXTN TgSINT_F32                           g_aiFX__Client__Shared_State[KTgFX_MAX_EFFECT_INSTANCE];
...
TgEXTN TgSINT_F32                           g_niFX__Client__Update__Active;
...
TgEXTN TgUINT_F32                           T_NAME(g_uiFX__,__Shared__Notify_State);

#if T_EFFECT_UPDATE || T_EFFECT_RENDER
TgEXTN TgUINT_F08                           T_NAME(g_asFX_Command__,__ToClient)[ETgFX_COMMAND__TO_CLIENT__BYTE_MAX];
...
TgEXTN TgSINT_F32                           T_NAME(g_niFX__,__Update__Active);
...
TgEXTN TgUINT_F08                           T_NAME(g_asFX_Command__,__Update_Command_Buffer)[ETgFX_COMMAND__CLIENT_TO_UPDATE__BYTE_MAX];
TgEXTN TgUINT_F08                           T_NAME(g_asFX_Command__,__ClientToUpdate)[ETgFX_COMMAND__CLIENT_TO_UPDATE__BYTE_MAX];
/*# T_EFFECT_UPDATE */
#endif
...
TgEXTN TgSINT_F32                           T_NAME(g_aniFX__,__Scene__Culled)[ETgFX_UPDATE__MAX];
/*# T_EFFECT_RENDER */
#else
TgEXTN TgFX_DATA_INST_ID                    T_NAME(g_atiFX__,__Scene__Effect_Head)[ETgFX_UPDATE__MAX];
TgEXTN TgSINT_F32                           T_NAME(g_niFX__,__Scene__Effect_Active);
/*# T_EFFECT_RENDER */
#endif
...
TgEXTN TgSINT_F32                           T_NAME(g_niFX__,__Render_Header__Active);
TgEXTN TgFX_DATA_INST_ID                    T_NAME(g_tiFX__,__Render_Generate__Head);
TgEXTN TgSINT_F32                           T_NAME(g_niFX__,__Render_Generate__Active);
...
TgEXTN TgUINT_F08                           T_NAME(g_asFX_Command__,__SceneToRender)[ETgFX_COMMAND__SCENE_TO_RENDER__BYTE_MAX];
/*# T_EFFECT_RENDER */
#endif
