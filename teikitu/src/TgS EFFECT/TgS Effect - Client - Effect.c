...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgVOID tgFX__Client__Kill_All( TgUINT_F32_P NONULL puiNotify_Flag )
{
    TgUINT_F32                          uiIndex;
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgUINT_F32 tgFX__Client__Get_Client_Index( TgFX_CLIENT_INST_ID_C tiClient )
{
    if (KTgID__INVALID_VALUE == tiClient.m_uiKI)
    {
        return KTgMAX_U32;
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgVOID tgFX__Client__Free_Internal( TgUINT_F32_C uiIndex )
{
...
static TgFX_CLIENT_INST_ID tgFX__Client__Inst_FX_Internal( ETgFX__EFFECT_C enEffect, TgVOID_CP pData0, TgVOID_CP pData1, TgFX_EFFECT_ID_C tiFX, STg2_FX_Instance_CPCU psInstance )
{
    ...
    uiEffect_Index = (TgUINT_F32)(psEffect - g_asFX_Effect);
