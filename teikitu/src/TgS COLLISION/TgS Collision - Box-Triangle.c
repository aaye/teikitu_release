...
//
//        TgSINT_F32_C    iIdx = sAxS.m_iAxis == 1 ? 0 : sAxS.m_iAxis - 21;
//
...
//
//        TgSINT_F32_C    iTriIdx = (sAxS.m_iAxis - 8) / 3;
//        TgSINT_F32_C    iBoxIdx0 = (sAxS.m_iAxis - 8) % 3;
//        VEC_T(1,C)        vK6;
//
...
//
//        TgSINT_F32_C    iIdx1 = (iBoxIdx0 + 1) % 3;
//        TgSINT_F32_C    iIdx2 = (iBoxIdx0 + 2) % 3;
...
//        TgSINT_F32_C    iFlag = ~(1 << (sAxS.m_iAxis - 2));
...
//        TgSINT_F32_C    niVertD0 = bSide ? sP0.m_iMinID : sP0.m_iMaxID;
//        TgSINT_F32_C    niVertD1 = bSide ? sP1.m_iMaxID : sP1.m_iMinID;
//        TgSINT_F32_C    iFeatureID = bSide ? sP0.m_iMinID : sP0.m_iMaxID;
...
//
//            TgSINT_F32                          iIdx, iCode, niPoint = 0;
...
//                    psAxS->m_iAxis = (TgSINT_F32 )uiIndex + (bNegAxis ? 5 : 2);
//                };
//            };
//        };
//    };
