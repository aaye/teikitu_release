...
//        TgBOOL                              bNewBasisSet;
//        TgSINT_F32                          iIdx0, iIdx1, niCount;
//
...
//        TgSINT_F32_C    niCount_Max = (bIsContained[i0] ? 0 : 1) + (bIsContained[i1] ? 0 : 1);
//
