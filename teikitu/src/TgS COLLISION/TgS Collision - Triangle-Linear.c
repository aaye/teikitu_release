...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgRESULT FCNI_VO(tgCO_ST_Clip_PM_F)( VEC_T(1,P) pvLN0, VEC_T(1,P) pvLN1, TgSINT_F32_PC  piCode, VEC_OBJ_T(TgSTRI,CPC) psST0, VEC_T(1,C) vS0, VEC_T(1,C) vD0 )
{
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgRESULT FCNI_VO(tgCO_ST_Clip_F)( VEC_OBJ_T(STg2_CO_Clip_List,PC) psCL, TgSINT_F32_PC  piCode, VEC_OBJ_T(TgSTRI,CPC) psST0, VEC_T(1,C) vS0, VEC_T(1,C) vD0 )
{
    VEC_T(1)                            vT0, vT1;
    TgSINT_F32                          iCode;
    TgRESULT                            iResult;
