...
/* Physics System */
TgKI_DECLARE( PH_MATERIAL_ID ) /* #IMPLEMENT */
TgKI_DECLARE( PH_FORM_ID ) /* #IMPLEMENT */
TgKI_DECLARE( PH_BODY_ID ) /* #IMPLEMENT */
TgKI_DECLARE( PH_CONSTRAINT_ID ) /* #IMPLEMENT */
TgKI_DECLARE( PH_MOTOR_ID ) /* #IMPLEMENT */
TgKI_DECLARE( PH_RAG_DOLL_ID ) /* #IMPLEMENT */
TgKI_DECLARE( PH_SCENE_ID ) /* #IMPLEMENT */
