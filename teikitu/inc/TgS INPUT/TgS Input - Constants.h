...
TgTYPE_ENUM(ETgCONTROLLER, TgSINT_F32,
    ETgCONTROLLER_GAMEPAD_0=0,      ETgCONTROLLER_GAMEPAD_1,        ETgCONTROLLER_GAMEPAD_2,        ETgCONTROLLER_GAMEPAD_3,        ETgCONTROLLER_KEYBOARD,
    ETgCONTROLLER_GUI_KEYBOARD,     ETgCONTROLLER_MOUSE,            ETgCONTROLLER_GUI_MOUSE,        ETgCONTROLLER_NET_0,            ETgCONTROLLER_NET_1,
    ETgCONTROLLER_NET_2,            ETgCONTROLLER_NET_3,            ETgCONTROLLER_MAX
);

TgTYPE_ENUM(ETgDEAD_ZONE, TgSINT_F32,
...
TgTYPE_ENUM(ETgPROP_GAMEPAD, TgSINT_F32,
    /* Digital Controls */
...
TgTYPE_ENUM(ETgPROP_KEYBOARD, TgSINT_F32,
    /* Function Keys */
...
TgTYPE_ENUM(ETgPROP_GUI_KEYBOARD, TgSINT_F32,
    ETgPROP_GUI_KEY_MAX
);

TgTYPE_ENUM(ETgPROP_MOUSE, TgSINT_F32,
    /* Digital Controls */
...
TgTYPE_ENUM(ETgPROP_GUI_MOUSE, TgSINT_F32,
    /* Digital Controls */
...
TgTYPE_ENUM(ETgSTATE_GUI_KEYBOARD, TgSINT_F32,
    ETgSTATE_GUI_KEYBOARD_VALID                 = 1 << 0,
);

TgTYPE_ENUM(ETgSTATE_MOUSE, TgSINT_F32,
    ETgSTATE_MOUSE_VALID                        = 1 << 0,
);

TgTYPE_ENUM(ETgSTATE_GUI_MOUSE, TgSINT_F32,
