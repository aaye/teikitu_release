...
tgKN_Notify_Start(
    TgKN_FCN_NOTIFY_CALLBACK ARG0, TgUINT_PTR_C ARG1, TgUINT_F64_C ARG2 );
...
TgEXTN TgRESULT
tgKN_Notify_MSG(
    TgUINT_F64_C ARG0, TgUINT_F64_C ARG1, TgUINT_F64_C ARG2 );
...
/** @brief Mount a given location with a specified level of access on the provided file system.
    ...
    @param[in] ARG1 Enumeration field indicating the level (type) of access to the files to be mounted at the given location.
...
tgKN_File_System_Mount(
    TgKN_FILE_SYSTEM_ID_C ARG0, ETgFILE_IO_ACCESS_C ARG1, TgCHAR_U8_CPCU ARG2 );
