...
/* The Input Module can be best described as a chain of responsibility or algorithmically as a producer-consumer.  Input devices act as producers, while the receiver stack acts
   collectively as the consumer. */
...
tgIN_Insert_Consumer(
    ETgCONTROLLER_C ARG0, TgUINT_F32_C ARG1, TgIN_FCN_CONSUMER ARG2, TgUINT_PTR_C ARG3 );
