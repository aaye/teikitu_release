...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgINLINE TgRESULT FCN_VO(tgCO_ST_Clip_F_RY)( VEC_OBJ_T(STg2_CO_Clip_List,PC) psCL, TgSINT_F32_PC piCode, VEC_OBJ_T(TgSTRI,CPC) psST0, VEC_OBJ_T(TgRAY,CPC) psRY0 )
{
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgINLINE TgRESULT FCN_VO(tgCO_ST_Clip_PM_F_RY)( VEC_T(1,PC) pvRY0, VEC_T(1,PC) pvRY1, TgSINT_F32_PC piCode, VEC_OBJ_T(TgSTRI,CPC) psST0, VEC_OBJ_T(TgRAY,CPC) psRY0 )
{
