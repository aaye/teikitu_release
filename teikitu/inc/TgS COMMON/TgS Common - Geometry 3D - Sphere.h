...
FCN_VO(tgGM_SP_Reset)(
    VEC_OBJ_T(TgSPHERE,PCU) NONULL OUT );
...
FCN_VO(tgGM_SP_Is_Valid)(
    VEC_OBJ_T(TgSPHERE,CPCU) NONULL ARG );
...
FCN_VO(tgGM_SP_Support_Point)(
    VEC_OBJ_T(TgSPHERE,CPCU) NONULL ARG0, VEC_T(1,C) ARG1 );
...
TgINLINE TgVOID
FCN_VO(tgGM_SP_BA)(
    VEC_OBJ_T(TgBOXAA,PCU) NONULL ARG0, VEC_OBJ_T(TgSPHERE,CPCU) NONULL ARG1 );
...
FCN_VO(tgGM_SP_Sweep_BA)(
    VEC_OBJ_T(TgBOXAA,PCU) NONULL ARG0, VEC_OBJ_T(TgSPHERE,CPCU) NONULL ARG1, VEC_T(1,C) ARG2 );
...
FCN_VO(tgGM_SP_Project)(
    VEC_T(1,PCU) NONULL ARG0, VEC_T(1,PCU) NONULL ARG1, VEC_OBJ_T(TgSPHERE,CPCU) NONULL ARG2, VEC_T(1,C) ARG3 );
...
TgINLINE TgVOID
FCN_VO(tgGM_SP_TX)(
    VEC_OBJ_T(TgSPHERE,PCU) NONULL ARG0, VEC_T(3,CPCU) NONULL ARG1 );
...
FCN_VO(tgGM_SP_Copy_TX)(
    VEC_OBJ_T(TgSPHERE,PCU) NONULL ARG0, VEC_OBJ_T(TgSPHERE,CPCU) NONULL ARG1, VEC_T(3,CPCU) NONULL ARG2 );
...
TgINLINE TgVOID
FCN_VO(tgGM_SP_Init)(
    VEC_OBJ_T(TgSPHERE,PCU) NONULL ARG0, VEC_T(1,C) ARG1, VEC_T(1,C) ARG2 );
...
TgINLINE TgVOID
FCN_VO(tgGM_SP_Copy)(
    VEC_OBJ_T(TgSPHERE,PCU) NONULL ARG0, VEC_OBJ_T(TgSPHERE,CPCU) NONULL ARG1 );
...
FCN_VO(tgGM_SP_Set_Origin)(
    VEC_OBJ_T(TgSPHERE,PCU) NONULL ARG0, VEC_T(1,C) ARG1 );
