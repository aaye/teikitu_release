...
FCN_VO(tgGM_BA_Is_Empty)(
    VEC_OBJ_T(TgBOXAA,CPCU) NONULL ARG );
...
FCN_VO(tgGM_BA_Union_PT)(
    VEC_OBJ_T(TgBOXAA,PCU) NONULL ARG0, VEC_T(1,C) ARG1 );
...
FCN_VO(tgGM_BA_Union_SP)(
    VEC_OBJ_T(TgBOXAA,PCU) NONULL ARG0, VEC_T(1,C) ARG1, VEC_T(1,C) ARG2 );
...
FCN_VO(tgGM_BA_Union_BA)(
    VEC_OBJ_T(TgBOXAA,PCU) NONULL ARG0, VEC_OBJ_T(TgBOXAA,CPCU) NONULL ARG1 );
...
FCN_VO(tgGM_BA_Reset)(
    VEC_OBJ_T(TgBOXAA,PCU) NONULL OUT );
...
FCN_VO(tgGM_BA_Support_Point)(
    VEC_OBJ_T(TgBOXAA,CPCU) NONULL ARG0, VEC_T(1,C) ARG1 );
...
FCN_VO(tgGM_BA_Sweep_BA)(
    VEC_OBJ_T(TgBOXAA,PCU) NONULL ARG0, VEC_OBJ_T(TgBOXAA,CPCU) NONULL ARG1, VEC_T(1,C) ARG2 );
...
FCN_VO(tgGM_BA_Project)(
    VEC_T(1,PCU) NONULL ARG0, VEC_T(1,PCU) NONULL ARG1, VEC_OBJ_T(TgBOXAA,CPCU) NONULL ARG2, VEC_T(1,C) ARG3 );
...
TgINLINE TgVOID
FCN_VO(tgGM_BA_TX)(
    VEC_OBJ_T(TgBOXAA,PCU) NONULL ARG0, VEC_T(3,CPCU) NONULL ARG1 );
...
FCN_VO(tgGM_BA_Copy_TX)(
    VEC_OBJ_T(TgBOXAA,PCU) NONULL ARG0, VEC_OBJ_T(TgBOXAA,CPCU) NONULL ARG1, VEC_T(3,CPCU) NONULL ARG2 );
...
FCN_VO(tgGM_BA_Init_SP)(
    VEC_OBJ_T(TgBOXAA,PCU) NONULL ARG0, VEC_T(1,C) ARG1, VEC_T(1,C) ARG2 ); /**< Single Point and Radius */
...
FCN_VO(tgGM_BA_Set_Invalid)(
    VEC_OBJ_T(TgBOXAA,PCU) NONULL ARG );
