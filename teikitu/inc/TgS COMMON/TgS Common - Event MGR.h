...
tgEM_TE_FRM_NEW(
    TgFCN_EM_CALLBACK ARG0, TgUINT_PTR_C ARG1, TgSINT_F32_C ARG2, TgSINT_F32_C ARG3 );
...
tgEM_TE_FRM_Set_Start_Frame(
    TgEM_TE_FRM_ID ARG0, TgSINT_F32_C ARG1 );
...
tgEM_TE_FRM_Query_Start_Frame(
    TgSINT_F32_PCU OUT0, TgEM_TE_FRM_ID ARG1 );
