...
#define KTgID__INVALID_VALUE                0ui64
...
/* -.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.- */
    ...
    #define TgMALLOC_EXACT(A)                   tgMM_Malloc_With_Trace( ETgMM_ALLOCATOR_OS, A, TgU8_TEXT_WITH_QUOTE(__FILE__), __LINE__ )
    #define TgFREE__EXACT(A)                    tgMM_Free_With_Trace( ETgMM_ALLOCATOR_OS, A, TgU8_TEXT_WITH_QUOTE(__FILE__), __LINE__ )
    #define TgMALLOC_POOL(A)                    tgMM_Malloc_With_Trace( ETgMM_ALLOCATOR_POOL, A, TgU8_TEXT_WITH_QUOTE(__FILE__), __LINE__ )
    #define TgFREE_POOL(A)                      tgMM_Free_With_Trace( ETgMM_ALLOCATOR_POOL, A, TgU8_TEXT_WITH_QUOTE(__FILE__), __LINE__ )
    #define TgREALLOC_POOL(A,B)                 tgMM_Realloc_With_Trace( ETgMM_ALLOCATOR_POOL, A, B, TgU8_TEXT_WITH_QUOTE(__FILE__), __LINE__ )
