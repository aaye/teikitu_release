...
FCN_VO(tgGM_LN_Reset)(
    VEC_OBJ_T(TgLINE,PCU) NONULL OUT );
...
FCN_VO(tgGM_LN_Is_Valid)(
    VEC_OBJ_T(TgLINE,CPCU) NONULL ARG );
...
TgINLINE TgVOID
FCN_VO(tgGM_LN_BA)(
    VEC_OBJ_T(TgBOXAA,PCU) NONULL ARG0, VEC_OBJ_T(TgLINE,CPCU) NONULL ARG1 );
...
FCN_VO(tgGM_LN_Sweep_BA)(
    VEC_OBJ_T(TgBOXAA,PCU) NONULL ARG0, VEC_OBJ_T(TgLINE,CPCU) NONULL ARG1, VEC_T(1,C) ARG2 );
...
FCN_VO(tgGM_LN_Project)(
    VEC_T(1,PCU) NONULL ARG0, VEC_T(1,PCU) NONULL ARG1, VEC_OBJ_T(TgLINE,CPCU) NONULL ARG2, VEC_T(1,C) ARG3 );
...
FCN_VO(tgGM_LN_Is_Contained)(
    VEC_OBJ_T(TgLINE,CPCU) NONULL ARG0, VEC_T(1,C) ARG1 );
...
TgINLINE TgVOID
FCN_VO(tgGM_LN_TX)(
    VEC_OBJ_T(TgLINE,PCU) NONULL ARG0, VEC_T(3,CPCU) NONULL ARG1 );
...
FCN_VO(tgGM_LN_Copy_TX)(
    VEC_OBJ_T(TgLINE,PCU) NONULL ARG0, VEC_OBJ_T(TgLINE,CPCU) NONULL ARG1, VEC_T(3,CPCU) NONULL ARG2 );
...
TgINLINE TgVOID
FCN_VO(tgGM_LN_Init)(
    VEC_OBJ_T(TgLINE,PCU) NONULL ARG0, VEC_T(1,C) ARG1, VEC_T(1,C) ARG2 );
...
TgINLINE TgVOID
FCN_VO(tgGM_LN_Copy)(
    VEC_OBJ_T(TgLINE,PCU) NONULL ARG0, VEC_OBJ_T(TgLINE,CPCU) NONULL ARG1 );
...
FCN_VO(tgGM_LN_Set_Origin)(
    VEC_OBJ_T(TgLINE,PCU) NONULL ARG0, VEC_T(1,C) ARG1 );
