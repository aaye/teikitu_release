...
FCN_VO(tgGM_CI_Reset)(
    VEC_OBJ_T(TgCIRCLE,PCU) NONULL OUT );
...
FCN_VO(tgGM_CI_Is_Valid)(
    VEC_OBJ_T(TgCIRCLE,CPCU) NONULL ARG );
...
FCN_VO(tgGM_CI_Support_Point)(
    VEC_OBJ_T(TgCIRCLE,CPCU) NONULL ARG0, VEC_T(1,C) ARG1 );
...
TgEXTN TgVOID
FCN_VO(tgGM_CI_BA)(
    VEC_OBJ_T(TgBOXAA,PCU) NONULL ARG0, VEC_OBJ_T(TgCIRCLE,CPCU) NONULL ARG1 );
...
FCN_VO(tgGM_CI_Sweep_BA)(
    VEC_OBJ_T(TgBOXAA,PCU) NONULL ARG0, VEC_OBJ_T(TgCIRCLE,CPCU) NONULL ARG1, VEC_T(1,C) ARG2 );
...
FCN_VO(tgGM_CI_Project)(
    VEC_T(1,PCU) NONULL ARG0, VEC_T(1,PCU) NONULL ARG1, VEC_OBJ_T(TgCIRCLE,CPCU) NONULL ARG2, VEC_T(1,C) ARG3 );
...
TgINLINE TgVOID
FCN_VO(tgGM_CI_TX)(
    VEC_OBJ_T(TgCIRCLE,PCU) NONULL ARG0, VEC_T(3,CPCU) NONULL ARG1 );
...
FCN_VO(tgGM_CI_Copy_TX)(
    VEC_OBJ_T(TgCIRCLE,PCU) NONULL ARG0, VEC_OBJ_T(TgCIRCLE,CPCU) NONULL ARG1, VEC_T(3,CPCU) NONULL ARG2 );
...
TgINLINE TgVOID
FCN_VO(tgGM_CI_Init)(
    VEC_OBJ_T(TgCIRCLE,PCU) NONULL ARG0, VEC_T(3,CPCU) NONULL ARG1, VEC_T(1,C) ARG2 );
...
TgINLINE TgVOID
FCN_VO(tgGM_CI_Copy)(
    VEC_OBJ_T(TgCIRCLE,PCU) NONULL ARG0, VEC_OBJ_T(TgCIRCLE,CPCU) NONULL ARG1 );
...
FCN_VO(tgGM_CI_Set_Origin)(
    VEC_OBJ_T(TgCIRCLE,PCU) NONULL ARG0, VEC_T(1,C) ARG1 );
