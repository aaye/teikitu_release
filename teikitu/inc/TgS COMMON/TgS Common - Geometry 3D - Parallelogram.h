...
FCN_VO(tgGM_PE_Reset)(
    VEC_OBJ_T(TgPARALLELOGRAM,PCU) NONULL OUT );
...
FCN_VO(tgGM_PE_Is_Valid)(
    VEC_OBJ_T(TgPARALLELOGRAM,CPCU) NONULL ARG );
...
FCN_VO(tgGM_PE_Support_Point)(
    VEC_OBJ_T(TgPARALLELOGRAM,CPCU) NONULL ARG0, VEC_T(1,C) ARG1 );
...
TgINLINE TgVOID
FCN_VO(tgGM_PE_BA)(
    VEC_OBJ_T(TgBOXAA,PCU) NONULL ARG0, VEC_OBJ_T(TgPARALLELOGRAM,CPCU) NONULL ARG1 );
...
FCN_VO(tgGM_PE_Sweep_BA)(
    VEC_OBJ_T(TgBOXAA,PCU) NONULL ARG0, VEC_OBJ_T(TgPARALLELOGRAM,CPCU) NONULL ARG1, VEC_T(1,C) ARG2 );
...
FCN_VO(tgGM_PE_Project)(
    VEC_T(1,PCU) NONULL ARG0, VEC_T(1,PCU) NONULL ARG1, VEC_OBJ_T(TgPARALLELOGRAM,CPCU) NONULL ARG2, VEC_T(1,C) ARG3 );
...
TgINLINE TgVOID
FCN_VO(tgGM_PE_TX)(
    VEC_OBJ_T(TgPARALLELOGRAM,PCU) NONULL ARG0, VEC_T(3,CPCU) NONULL ARG1 );
...
FCN_VO(tgGM_PE_Copy_TX)(
    VEC_OBJ_T(TgPARALLELOGRAM,PCU) NONULL ARG0, VEC_OBJ_T(TgPARALLELOGRAM,CPCU) NONULL ARG1, VEC_T(3,CPCU) NONULL ARG2 );
...
TgINLINE TgVOID
FCN_VO(tgGM_PE_Copy)(
    VEC_OBJ_T(TgPARALLELOGRAM,PCU) NONULL ARG0, VEC_OBJ_T(TgPARALLELOGRAM,CPCU) NONULL ARG1 );
...
FCN_VO(tgGM_PE_Set_Origin)(
    VEC_OBJ_T(TgPARALLELOGRAM,PCU) NONULL ARG0, VEC_T(1,C) ARG1 );
...
FCN_VO(tgGM_PE_Set_Edge)(
    VEC_OBJ_T(TgPARALLELOGRAM,PCU) NONULL ARG0, VEC_T(1,C) ARG1, VEC_T(1,C) ARG2 );
...
FCN_VO(tgGM_PE_Set_Edge_Normal)(
    VEC_OBJ_T(TgPARALLELOGRAM,PCU) NONULL ARG0, VEC_T(1,C) ARG1, VEC_T(1,C) ARG2, VEC_T(1,C) ARG3 );
