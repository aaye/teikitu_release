...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgINLINE TgVOID FCN_M(tgMH_Init_Basis_From_Vector_And_Position)( MAT_T(PC) pmOUT_0, VEC_T(1,C) vARG_1, VEC_T(1,C) vARG_2 )
{
    MAT_UN_PTR_T()                      uM0;
    VEC_UN_T(1)                         uV0, uV1;
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgINLINE TgVOID FCN_M(tgMH_Init_Reference_Frame)( MAT_T(PC) NONULL pmOUT_0, VEC_T(1,C) vARG_1, VEC_T(1,C) vARG_2, VEC_T(1,C) vARG_3, VEC_T(1,C) vARG_4 )
{
    MAT_UN_PTR_T()                      uM0;
    ...
    FCN_M(tgMH_Init_Reference_Frame_S)( VEC_S_UN_PTR_M_MEMBER(uM0), VEC_S_UN_1_MEMBER(uV0), VEC_S_UN_1_MEMBER(uV1), VEC_S_UN_1_MEMBER(uV2), VEC_S_UN_1_MEMBER(uV3) );
}
