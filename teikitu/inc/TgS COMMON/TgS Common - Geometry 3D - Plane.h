...
FCN_VO(tgGM_PN_Is_Valid)(
    VEC_OBJ_T(TgPLANE,CPCU) NONULL ARG );
...
FCN_VO(tgGM_PN_Is_Contained)(
    VEC_OBJ_T(TgPLANE,CPCU) NONULL ARG0, VEC_T(1,C) ARG1 );
...
TgINLINE TgVOID
FCN_VO(tgGM_PN_TX)(
    VEC_OBJ_T(TgPLANE,PCU) NONULL ARG0, VEC_T(3,CPCU) NONULL ARG1 );
...
FCN_VO(tgGM_PN_Copy_TX)(
    VEC_OBJ_T(TgPLANE,PCU) NONULL ARG0, VEC_OBJ_T(TgPLANE,CPCU) NONULL ARG1, VEC_T(3,CPCU) NONULL ARG2 );
...
FCN_VO(tgGM_PN_Init_ND)(
    VEC_OBJ_T(TgPLANE,PCU) NONULL ARG0, VEC_T(1,C) ARG1, VEC_T(1,C) ARG2 );
...
TgINLINE TgVOID
FCN_VO(tgGM_PN_Copy)(
    VEC_OBJ_T(TgPLANE,PCU) NONULL ARG0, VEC_OBJ_T(TgPLANE,CPCU) NONULL ARG1 );
...
FCN_VO(tgGM_PN_Set_PlnEqN)(
    VEC_OBJ_T(TgPLANE,PCU) NONULL ARG0, VEC_T(1,C) ARG1 );
...
FCN_VO(tgGM_Sign_Closest_PN_PT)(
    VEC_T(1,PCU) NONULL ARG0, VEC_OBJ_T(TgPLANE,CPCU) NONULL ARG1, VEC_T(1,C) ARG2 );
