...
FCN_VO(tgGM_MA_Reset)(
    VEC_OBJ_T(TgMESH_BA,PCU) NONULL OUT );
...
FCN_VO(tgGM_MA_Is_Valid)(
    VEC_OBJ_T(TgMESH_BA,CPCU) NONULL ARG );
...
FCN_VO(tgGM_MA_Support_Point)(
    VEC_OBJ_T(TgMESH_BA,CPCU) NONULL ARG0, VEC_T(1,C) ARG1 );
...
TgINLINE TgVOID
FCN_VO(tgGM_MA_BA)(
    VEC_OBJ_T(TgBOXAA,PCU) NONULL ARG0, VEC_OBJ_T(TgMESH_BA,CPCU) NONULL ARG1 );
...
FCN_VO(tgGM_MA_Sweep_BA)(
    VEC_OBJ_T(TgBOXAA,PCU) NONULL ARG0, VEC_OBJ_T(TgMESH_BA,CPCU) NONULL ARG1, VEC_T(1,C) ARG2 );
...
FCN_VO(tgGM_MA_Project)(
    VEC_T(1,PCU) NONULL ARG0, VEC_T(1,PCU) NONULL ARG1, VEC_OBJ_T(TgMESH_BA,CPCU) NONULL ARG2, VEC_T(1,C) ARG3);
...
TgEXTN TgVOID
FCN_VO(tgGM_MA_TX)(
    VEC_OBJ_T(TgMESH_BA,PCU) NONULL ARG0, VEC_T(3,CPCU) NONULL ARG1 );
...
FCN_VO(tgGM_MA_Copy_TX)(
    VEC_OBJ_T(TgMESH_BA,PCU) NONULL ARG0, VEC_OBJ_T(TgMESH_BA,CPCU) NONULL ARG1, VEC_T(3,CPCU) NONULL ARG2 );
...
FCN_VO(tgGM_MA_Init_MS)(
    VEC_OBJ_T(TgMESH_BA,PCU) NONULL ARG0, VEC_OBJ_T(TgMESH_SIMPLE,CPCU) NONULL ARG1 );
...
FCN_VO(tgGM_MA_Init_MS_TX_TL)(
    VEC_OBJ_T(TgMESH_BA,PCU) NONULL ARG0, VEC_OBJ_T(TgMESH_SIMPLE,CPCU) NONULL ARG1, VEC_T(3,CPCU) NONULL ARG2, VEC_T(1,C) ARG3 );
...
FCN_VO(tgGM_MA_Init_MS_TX_TX)(
    VEC_OBJ_T(TgMESH_BA,PCU) NONULL ARG0, VEC_OBJ_T(TgMESH_SIMPLE,CPCU) NONULL ARG1, VEC_T(3,CPCU) NONULL ARG2, VEC_T(3,CPCU) NONULL ARG3 );
...
TgINLINE TgVOID
FCN_VO(tgGM_MA_Copy)(
    VEC_OBJ_T(TgMESH_BA,PCU) NONULL ARG0, VEC_OBJ_T(TgMESH_BA,CPCU) NONULL ARG1 );
...
FCN_VO(tgGM_MA_Update_Face_BA)(
    VEC_OBJ_T(TgMESH_BA,PCU) NONULL ARG );
