...
TgTYPE_ENUM_FLAG( ETgFILE_PLATFORM, TgUINT_F32,
...
TgTYPE_ENUM_FLAG( ETgFILE_FLAG, TgUINT_F32,
...
tgCM_Path_Add_Extension(
    TgCHAR_U8_PC OUT0, TgRSIZE_C ARG1, TgCHAR_U8_CPC ARG2, TgRSIZE_C ARG3 );
...
tgCM_Path_Common_Prefix_Size_U08(
    TgCHAR_U8_CP ARG0, TgRSIZE ARG1, TgCHAR_U8_CP ARG2, TgRSIZE ARG3 );
...
tgCM_Path_Common_Prefix(
    TgCHAR_U8_P OUT0, TgRSIZE ARG1, TgCHAR_U8_CP ARG2, TgRSIZE ARG3, TgCHAR_U8_CP ARG4, TgRSIZE ARG5 );
...
tgCM_Path_Find_Extension(
    TgRSIZE_P OUT0, TgCHAR_U8_CPC ARG1, TgRSIZE_C ARG2 );
...
tgCM_File_Output_Header(
    STg2_Output_P OUT0, STg2_File_Block_CPC ARG1 );
...
tgCM_File_Query_Data(
    TgVOID_CPP OUT0, STg2_File_Block_CPC ARG1, TgUINT_F32_C ARG2 );
...
tgCM_File_Query_Data_Size(
    TgRSIZE_P OUT0, STg2_File_Block_CPC ARG1, TgUINT_F32_C ARG2 );
