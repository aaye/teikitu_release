...
FCN_VO(tgGM_TB_Reset)(
    VEC_OBJ_T(TgTUBE,PCU) NONULL OUT );
...
TgINLINE TgVOID
FCN_VO(tgGM_TB_TX)(
    VEC_OBJ_T(TgTUBE,PCU) NONULL ARG0, VEC_T(3,CPCU) NONULL ARG1 );
...
FCN_VO(tgGM_TB_Copy_TX)(
    VEC_OBJ_T(TgTUBE,PCU) NONULL ARG0, VEC_OBJ_T(TgTUBE,CPCU) NONULL ARG1, VEC_T(3,CPCU) NONULL ARG2 );
...
TgINLINE TgVOID
FCN_VO(tgGM_TB_Init)(
    VEC_OBJ_T(TgTUBE,PCU) NONULL ARG0, VEC_T(3,CPCU) NONULL ARG1, VEC_T(1,C) ARG2, VEC_T(1,C) ARG3 );
...
TgINLINE TgVOID
FCN_VO(tgGM_TB_Copy)(
    VEC_OBJ_T(TgTUBE,PCU) NONULL ARG0, VEC_OBJ_T(TgTUBE,CPCU) NONULL ARG1 );
...
FCN_VO(tgGM_TB_Set_Origin)(
    VEC_OBJ_T(TgTUBE,PCU) NONULL ARG0, VEC_T(1,C) ARG1 );
