...
FCN_VO(tgGM_EL_Reset)(
    VEC_OBJ_T(TgELLIPSE,PCU) NONULL OUT );
...
FCN_VO(tgGM_EL_Is_Valid)(
    VEC_OBJ_T(TgELLIPSE,CPCU) NONULL ARG );
...
FCN_VO(tgGM_EL_Support_Point)(
    VEC_OBJ_T(TgELLIPSE,CPCU) NONULL ARG0, VEC_T(1,C) ARG1 );
...
TgINLINE TgVOID
FCN_VO(tgGM_EL_BA)(
    VEC_OBJ_T(TgBOXAA,PCU) NONULL ARG0, VEC_OBJ_T(TgELLIPSE,CPCU) NONULL ARG1 );
...
FCN_VO(tgGM_EL_Sweep_BA)(
    VEC_OBJ_T(TgBOXAA,PCU) NONULL ARG0, VEC_OBJ_T(TgELLIPSE,CPCU) NONULL ARG1, VEC_T(1,C) ARG2 );
...
FCN_VO(tgGM_EL_Project)(
    VEC_T(1,PCU) NONULL ARG0, VEC_T(1,PCU) NONULL ARG1, VEC_OBJ_T(TgELLIPSE,CPCU) NONULL ARG2, VEC_T(1,C) ARG3);
...
TgINLINE TgVOID
FCN_VO(tgGM_EL_TX)(
    VEC_OBJ_T(TgELLIPSE,PCU) NONULL ARG0, VEC_T(3,CPCU) NONULL ARG1 );
...
FCN_VO(tgGM_EL_Copy_TX)(
    VEC_OBJ_T(TgELLIPSE,PCU) NONULL ARG0, VEC_OBJ_T(TgELLIPSE,CPCU) NONULL ARG1, VEC_T(3,CPCU) NONULL ARG2 );
...
TgINLINE TgVOID
FCN_VO(tgGM_EL_Init)(
    VEC_OBJ_T(TgELLIPSE,PCU) NONULL ARG0, VEC_T(3,CPCU) NONULL ARG1, VEC_T(1,C) ARG2, VEC_T(1,C) ARG3 );
...
TgINLINE TgVOID
FCN_VO(tgGM_EL_Copy)(
    VEC_OBJ_T(TgELLIPSE,PCU) NONULL ARG0, VEC_OBJ_T(TgELLIPSE,CPCU) NONULL ARG1 );
...
FCN_VO(tgGM_EL_Set_Origin)(
    VEC_OBJ_T(TgELLIPSE,PCU) NONULL ARG0, VEC_T(1,C) ARG1 );
