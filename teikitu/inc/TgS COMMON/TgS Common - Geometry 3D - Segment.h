...
FCN_VO(tgGM_SG_Reset)(
    VEC_OBJ_T(TgSEGMENT,PCU) NONULL OUT );
...
FCN_VO(tgGM_SG_Is_Valid)(
    VEC_OBJ_T(TgSEGMENT,CPCU) NONULL ARG );
...
TgINLINE TgVOID
FCN_VO(tgGM_SG_BA)(
    VEC_OBJ_T(TgBOXAA,PCU) NONULL ARG0, VEC_OBJ_T(TgSEGMENT,CPCU) NONULL ARG1 );
...
FCN_VO(tgGM_SG_Sweep_BA)(
    VEC_OBJ_T(TgBOXAA,PCU) NONULL ARG0, VEC_OBJ_T(TgSEGMENT,CPCU) NONULL ARG1, VEC_T(1,C) ARG2 );
...
FCN_VO(tgGM_SG_Project)(
    VEC_T(1,PCU) NONULL ARG0, VEC_T(1,PCU) NONULL ARG1, VEC_OBJ_T(TgSEGMENT,CPCU) NONULL ARG2, VEC_T(1,C) ARG3);
...
FCN_VO(tgGM_SG_Is_Contained)(
    VEC_OBJ_T(TgSEGMENT,CPCU) NONULL ARG0, VEC_T(1,C) ARG1 );
...
TgINLINE TgVOID
FCN_VO(tgGM_SG_TX)(
    VEC_OBJ_T(TgSEGMENT,PCU) NONULL ARG0, VEC_T(3,CPCU) NONULL ARG1 );
...
FCN_VO(tgGM_SG_Copy_TX)(
    VEC_OBJ_T(TgSEGMENT,PCU) NONULL ARG0, VEC_OBJ_T(TgSEGMENT,CPCU) NONULL ARG1, VEC_T(3,CPCU) NONULL ARG2 );
...
TgINLINE TgVOID
FCN_VO(tgGM_SG_Init)(
    VEC_OBJ_T(TgSEGMENT,PCU) NONULL ARG0, VEC_T(1,C) ARG1, VEC_T(1,C) ARG2 );
...
TgINLINE TgVOID
FCN_VO(tgGM_SG_Copy)(
    VEC_OBJ_T(TgSEGMENT,PCU) NONULL ARG0, VEC_OBJ_T(TgSEGMENT,CPCU) NONULL ARG1 );
...
FCN_VO(tgGM_SG_Set_Origin)(
    VEC_OBJ_T(TgSEGMENT,PCU) NONULL ARG0, VEC_T(1,C) ARG1 );
