...
namespace Unit_Test___Ring_0___TgS_COMMON
{
    ...
    TgSINT_F32 UnitTest_UTILITY::s_iCommand_Expected_Results[ETgRWLOCK_COMMAND_SIZE];
    TgUINT_F08 UnitTest_UTILITY::s_uiCommand_List[ETgRWLOCK_COMMAND_SIZE];
    TgSINT_F32 UnitTest_UTILITY::s_iCommand_Results[ETgRWLOCK_COMMAND_SIZE];
