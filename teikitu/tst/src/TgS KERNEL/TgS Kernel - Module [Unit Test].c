...
tgUnit_Test__KN_Notify_Func(
    TgUINT_PTR_C uiParam, TgUINT_F64_C uiParam0, TgUINT_F64_C uiParam1 );
...
static TgSINT_F32                           g_iUnit_Test__KN_Notify_Signal;
...
TEST_METHOD( UNIT_TEST__TEST__KN_File_BL )
{
    ...
    sOpen_Command.m_enMode = ETgFILE_IO_ACCESS__WRITE | ETgFILE_IO_ACCESS__CREATE;
...
static TgNOTHROW TgVOID tgUnit_Test__KN_Notify_Func( TgUINT_PTR_C uiParam, TgUINT_F64_C uiParam0, TgUINT_F64_C uiParam1 )
{
...
static TgNOTHROW TgVOID tgUnit_Test__KN_File_Job_Write_Callback( STg2_KN_File_Write_Command_PCU psWrite_CMD )
{
    union
    {
        STg2_KN_File_Write_Command_P    psWrite;
...
static TgNOTHROW TgVOID tgUnit_Test__KN_File_Job_Read_Callback( STg2_KN_File_Read_Command_PCU psRead_CMD )
{
    union
    {
        STg2_KN_File_Read_Command_P     psRead;
