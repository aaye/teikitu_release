...
#if defined(_M_ARM64) && defined(__clang__) && __clang_major__ == 11 // TRANSITION, LLVM 12
inline unsigned char _InterlockedCompareExchange128(
    __int64 volatile* _Destination, __int64 _Val_high, __int64 _Val_low, __int64* _Comparand) {
    auto _Dest = reinterpret_cast<__int128 volatile*>(_Destination);
    auto _Cmp = reinterpret_cast<__int128*>(_Comparand);
    __int128 _Val;
    reinterpret_cast<__int64*>(&_Val)[0] = _Val_low;
    reinterpret_cast<__int64*>(&_Val)[1] = _Val_high;

    __int128 _Stored;
    do {
        if (_Stored = __builtin_arm_ldaex(_Dest); _Stored != *_Cmp) {
            *_Cmp = _Stored;
            return 0;
        }
    } while (__builtin_arm_stlex(_Val, _Dest));

    return 1;
}

inline unsigned char _InterlockedCompareExchange128_acq(
    __int64 volatile* _Destination, __int64 _Val_high, __int64 _Val_low, __int64* _Comparand) {
    auto _Dest = reinterpret_cast<__int128 volatile*>(_Destination);
    auto _Cmp = reinterpret_cast<__int128*>(_Comparand);
    __int128 _Val;
...
inline unsigned char _InterlockedCompareExchange128_nf(
    __int64 volatile* _Destination, __int64 _Val_high, __int64 _Val_low, __int64* _Comparand) {
    auto _Dest = reinterpret_cast<__int128 volatile*>(_Destination);
    auto _Cmp = reinterpret_cast<__int128*>(_Comparand);
    __int128 _Val;
    ...
    __int128 _Stored;
    do {
        if (_Stored = __builtin_arm_ldrex(_Dest); _Stored != *_Cmp) {
            *_Cmp = _Stored;
            return 0;
        }
    } while (__builtin_arm_strex(_Val, _Dest));
...
inline unsigned char _InterlockedCompareExchange128_rel(
    __int64 volatile* _Destination, __int64 _Val_high, __int64 _Val_low, __int64* _Comparand) {
    auto _Dest = reinterpret_cast<__int128 volatile*>(_Destination);
    auto _Cmp = reinterpret_cast<__int128*>(_Comparand);
    __int128 _Val;
...
#endif // ^^^ ARM64 && LLVM 11 workaround ^^^
