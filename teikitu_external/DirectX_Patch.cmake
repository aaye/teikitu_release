...
SET (WORKING_DIR ${GIT_ROOT_PATH}/teikitu_external/_repo_clone/directx/)
# MESSAGE(STATUS "WORKING DIR: ${GIT_ROOT_PATH}/teikitu_external/_repo_clone/directx/")
...
# MESSAGE (STATUS "BRANCH LIST: ${GIT_TAG_LIST}")

IF (NOT GIT_TAG_LIST)
    MESSAGE (FATAL_ERROR "Could not get a tag list for the repo")
ENDIF ()

# Switch to the patch branch, or create it.
IF (NOT ${GIT_TAG_LIST} MATCHES "teikitu")

    GIT_PATCH( "Patch #0001 DirectX C Fixes.patch" "Fixes for a C compilation.")
