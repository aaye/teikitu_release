...
IF (MK_BUILD__OS_TEXT_WIDE OR ("${MK_BUILD__UNIVERSAL}" STREQUAL "UWP"))
    SET (MK_BUILD__OS_TEXT_WIDE                     1)
    SET (MK_PROJECT_NAME                            "${MK_PROJECT_NAME} WC")
    SET (MK_BUILD__TARGET_DIRECTORY                 "${MK_BUILD__TARGET_DIRECTORY}_wc")
ELSE ()
    SET (MK_PROJECT_NAME                            "${MK_PROJECT_NAME} U8")
    SET (MK_BUILD__TARGET_DIRECTORY                 "${MK_BUILD__TARGET_DIRECTORY}_u8")
ENDIF ()
...
ELSEIF ("${MK_FEATURE__GRAPHICS}" STREQUAL "METAL")
    SET (MK_BUILD__GRAPHICS_NAME                    "METL")
ELSEIF ("${MK_FEATURE__GRAPHICS}" STREQUAL "VULKAN")
    SET (MK_BUILD__GRAPHICS_NAME                    "VLKN")
...
SET (MK_BUILD__HARDWARE__CPU_CACHE_LINE_SIZE    0)
...
IF ("${MK_BUILD__TARGET_HARDWARE}" STREQUAL "C17_ARM")
    ...
    SET (MK_BUILD__HARDWARE__CPU_CACHE_LINE_SIZE    64)
    SET (MK_BUILD__HARDWARE__X64                    FALSE)
    SET (MK_BUILD__HARDWARE__ARM                    TRUE)
ELSEIF ("${MK_BUILD__TARGET_HARDWARE}" STREQUAL "INTEL_X64")
    SET (MK_BUILD__HARDWARE_NAME                    "INTEL_X64")
    SET (MK_BUILD__HARDWARE__POINTER_SIZE           8)
    SET (MK_BUILD__HARDWARE__WORDSIZE               8)
    SET (MK_BUILD__HARDWARE__CPU_CACHE_LINE_SIZE    64)
...
ADD_COMPILE_DEFINITIONS (TgBUILD_HARDWARE__CPU_CACHE_LINE_SIZE=${MK_BUILD__HARDWARE__CPU_CACHE_LINE_SIZE})
...
ELSEIF (CMAKE_BUILD_TYPE_LOWER MATCHES final)
    SET (MK_COMPILE__TYPE                         "FINAL")
ELSEIF (CMAKE_BUILD_TYPE_LOWER MATCHES tools)
...
SET (MK_COMPILE__TYPE=${MK_COMPILE__TYPE})
