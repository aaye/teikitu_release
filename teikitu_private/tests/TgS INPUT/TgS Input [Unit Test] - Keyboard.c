...
TEST_METHOD_DEFINE(TEST__Input_GUI_Keyboard)
{
    ...
    while (atomic_load( &s_xuiTest_Count ) < 20)
    {
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
static TgBOOL TEST__Consumer_Keyboard( TgUINT_PTR_C UNUSED_PARAM uiUnused, TgFLOAT32_C UNUSED_PARAM fDT, STg2_IN_Event_CPC psEvent )
{
