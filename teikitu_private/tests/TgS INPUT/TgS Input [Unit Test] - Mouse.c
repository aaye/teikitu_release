...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
static TgBOOL TEST__Consumer_Mouse( TgUINT_PTR_C UNUSED_PARAM uiUnused, TgFLOAT32_C UNUSED_PARAM fDT, STg2_IN_Event_CPC psEvent )
{
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
static TgBOOL TEST__Consumer_GUI_Mouse( TgUINT_PTR_C UNUSED_PARAM uiA, TgFLOAT32_C UNUSED_PARAM fA, STg2_IN_Event_CPC pEvent )
{
    ...
    TgMSGF(0xC, u8"%-16.16s(GUI Mouse - %-20.20s): %d\n", "Input Test", szNameList[pEvent->m_enProp.GUI_Mouse], (TgSINT_F16 )(pEvent->m_uiUTF32 & 0xFFFF));
    atomic_fetch_add( &s_xuiTest_Count, 1 );
    return (true);
}
