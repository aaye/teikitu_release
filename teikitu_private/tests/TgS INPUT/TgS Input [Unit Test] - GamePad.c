...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
static TgBOOL TEST__Consumer_GamePad( TgATTRIBUTE_MAYBE_UNUSED TgUINT_PTR_C uiUnused, TgATTRIBUTE_MAYBE_UNUSED TgFLOAT32_C fDT, STg2_IN_Event_CPC psEvent )
{
