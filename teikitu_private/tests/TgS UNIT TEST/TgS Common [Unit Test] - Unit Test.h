...
typedef TgVOID(*TgREPORT_CSE_REPORT)( Test_Context_PC, Test_Case_PC, TgUINT_E32_C );
...
struct Test_Context
{
    ...
    TgUINT_E32 m_psRestart_Case_Test;
    TgUINT_E32 m_iPad0;
    ...
    TgUINT_E32 m_nuiCase_Passed, m_nuiCase_Failed, m_nuiCase_Total;
    TgUINT_E32 m_nuiSet_Passed, m_nuiSet_Failed, m_nuiSet_Total;
    TgUINT_E32 m_iPad1;
...
TgEXTN TgVOID Unit_Test__Sleep( TgUINT_E32_C );

TgEXTN TgVOID Unit_Test__Register( Test_Set_PC );
TgEXTN TgRESULT Unit_Test__Execute( Test_Context_PC );

TgEXTN TgVOID Default_Report_Case_Report_Passed( Test_Context_PC, Test_Case_PC, TgUINT_E32_C );
TgEXTN TgVOID Default_Report_Case_Report_Failed( Test_Context_PC, Test_Case_PC, TgUINT_E32_C );
