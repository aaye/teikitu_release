...
TEST_METHOD( UNIT_TEST__TEST__CM_UT_LF__SN__SLOW_THREAD )
{
    ...
    for (uiIndex = 0; uiIndex < (TgUINT_E32)KTgMAX_U16; ++uiIndex)
    {
...
/* ---- Spin_Unit_Test ----------------------------------------------------------------------------------------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
static TgUINT_E32 Spin_Unit_Test( TgATTRIBUTE_MAYBE_UNUSED TgUINT_PTR_C uiUnused ) TgATTRIBUTE_NO_EXCEPT
{
    TgUINT_E32                          uiIndex;
...
/* ---- Suspend_Resume_Unit_Test ------------------------------------------------------------------------------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
static TgUINT_E32 Suspend_Resume_Unit_Test( TgATTRIBUTE_MAYBE_UNUSED TgUINT_PTR_C uiUnused ) TgATTRIBUTE_NO_EXCEPT
{
    TgUINT_E32                          uiIndex;
