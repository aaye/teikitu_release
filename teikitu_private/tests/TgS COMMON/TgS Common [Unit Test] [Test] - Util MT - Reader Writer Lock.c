...
static TgSINT_E32                           s_iCommand_Expected_Results[KTgRWLOCK_COMMAND_SIZE];
static TgUINT_E08                           s_uiCommand_List[KTgRWLOCK_COMMAND_SIZE];
static TgSINT_E32                           s_iCommand_Results[KTgRWLOCK_COMMAND_SIZE];
static TgSINT_E32_A                         s_niCommand_Read, s_niCommand_Execute;
static TgSINT_E32_A                         s_niCommand_Write;
...
TEST_METHOD( UNIT_TEST__TEST__CM_UT_LF__RW__Enter_Read_Wait_Yield )
{
    ...
    tgCM_UT_LF__RW__Enter_Read_Yield_Block( &sAM_RW );
...
TEST_METHOD( UNIT_TEST__TEST__CM_UT_LF__RW__Enter_Read_Wait_Spin )
{
    ...
    tgCM_UT_LF__RW__Enter_Read_Spin_Block( &sAM_RW );
...
TEST_METHOD( UNIT_TEST__TEST__CM_UT_LF__RW__Enter_Write_Wait_Yield )
{
    ...
    tgCM_UT_LF__RW__Enter_Write_Yield_Block( &sAM_RW );
...
TEST_METHOD( UNIT_TEST__TEST__CM_UT_LF__RW__Enter_Write_Wait_Spin )
{
    ...
    tgCM_UT_LF__RW__Enter_Write_Spin_Block( &sAM_RW );
...
TEST_METHOD( UNIT_TEST__TEST__CM_UT_MT__RW__SLOW_THREAD )
{
    ...
    TgSINT_E32                          iIndex;
    TgSINT_E32                          niCommand_Expected_Results;
    ...
    if (tgGB_CMD_Query_Argument_Index( u8"-slow" ) >= 0 || TgCOMPILE__SLOW_UNIT_TEST)
    {
        ...
        Test__Expect_EQ(KTgS_OK, tgCM_UT_LF__RW__Init( &s_sAM_RW ));
        TgSTD_ATOMIC(store)( &s_niCommand_Execute, 0 );
        TgSTD_ATOMIC(store)( &s_niCommand_Read, 0 );
        TgSTD_ATOMIC(store)( &s_niCommand_Write, 0 );
        for (iIndex = 0; iIndex < KTgRWLOCK_NUM_THREADS; ++iIndex)
        {
        ...
        tgCM_UT_LF__RW__Free( &s_sAM_RW );
        Test__Expect_EQ(true, niCommand_Expected_Results == TgSTD_ATOMIC(load)( &s_niCommand_Write ));
...
/* ---- Thread_AM_RW_Read_Unit_Test ---------------------------------------------------------------------------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TEST_LOCAL TgUINT_E32 Thread_AM_RW_Read_Unit_Test( TgATTRIBUTE_MAYBE_UNUSED TgUINT_PTR_C uiUnused ) TgATTRIBUTE_NO_EXCEPT
{
    TgSINT_E32                          iIndex;
...
/* ---- Thread_AM_RW_Write_Unit_Test --------------------------------------------------------------------------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TEST_LOCAL TgUINT_E32 Thread_AM_RW_Write_Unit_Test( TgATTRIBUTE_MAYBE_UNUSED TgUINT_PTR_C uiUnused ) TgATTRIBUTE_NO_EXCEPT
{
    TgSINT_E32                          iIndex;
...
/* ---- Thread_AM_RW_Command_Unit_Test ------------------------------------------------------------------------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TEST_LOCAL TgUINT_E32 Thread_AM_RW_Command_Unit_Test( TgATTRIBUTE_MAYBE_UNUSED TgUINT_PTR_C uiUnused ) TgATTRIBUTE_NO_EXCEPT
{
    TgSINT_E32                          iIndex;
    TgSINT_E32                          niWrite;
    TgSINT_E32                          niCommand;
    TgUINT_E08                          iCommand;
    ...
    {
        niCommand = TgSTD_ATOMIC(fetch_add)( &s_niCommand_Read, 1 );
        iCommand = s_uiCommand_List[niCommand % KTgRWLOCK_COMMAND_SIZE];

        while (TgSTD_ATOMIC(load)( &s_niCommand_Execute ) != niCommand)
        {
            tgTR_Pause();
        };
        ...
        switch (iCommand % 2)
        {
            case 1:
                tgCM_UT_LF__RW__Enter_Read_Yield_Block( &s_sAM_RW );
                TgSTD_ATOMIC(fetch_add)( &s_niCommand_Execute, 1 );
                Unit_Test__Sleep( tgCM_RAND_U64() % 30000 );
                tgCM_UT_LF__RW__Exit_Read( &s_sAM_RW );
                break;
            ...
            case 0:
                tgCM_UT_LF__RW__Enter_Write_Yield_Block( &s_sAM_RW );
                TgSTD_ATOMIC(fetch_add)( &s_niCommand_Execute, 1 );
                niWrite = TgSTD_ATOMIC(fetch_add)( &s_niCommand_Write, 1 );
...
/* ---- Thread_SN_RW_Read_Unit_Test ---------------------------------------------------------------------------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TEST_LOCAL TgUINT_E32 Thread_SN_RW_Read_Unit_Test( TgATTRIBUTE_MAYBE_UNUSED TgUINT_PTR_C uiUnused ) TgATTRIBUTE_NO_EXCEPT
{
    TgSINT_E32                          iIndex;
...
/* ---- Thread_SN_RW_Write_Unit_Test --------------------------------------------------------------------------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TEST_LOCAL TgUINT_E32 Thread_SN_RW_Write_Unit_Test( TgATTRIBUTE_MAYBE_UNUSED TgUINT_PTR_C uiUnused ) TgATTRIBUTE_NO_EXCEPT
{
    TgSINT_E32                          iIndex;
...
/* ---- Thread_SN_RW_Command_Unit_Test ------------------------------------------------------------------------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TEST_LOCAL TgUINT_E32 Thread_SN_RW_Command_Unit_Test( TgATTRIBUTE_MAYBE_UNUSED TgUINT_PTR_C uiUnused ) TgATTRIBUTE_NO_EXCEPT
{
    TgSINT_E32                          iIndex;
    TgSINT_E32                          niWrite;
    TgSINT_E32                          niCommand;
...
/* ---- Thread_RW_Read_Unit_Test ------------------------------------------------------------------------------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TEST_LOCAL TgUINT_E32 Thread_RW_Read_Unit_Test( TgATTRIBUTE_MAYBE_UNUSED TgUINT_PTR_C uiUnused ) TgATTRIBUTE_NO_EXCEPT
{
    TgSINT_E32                          iIndex;
...
/* ---- Thread_RW_Write_Unit_Test ------------------------------------------------------------------------------------------------------------------------------------------------ */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TEST_LOCAL TgUINT_E32 Thread_RW_Write_Unit_Test( TgATTRIBUTE_MAYBE_UNUSED TgUINT_PTR_C uiUnused ) TgATTRIBUTE_NO_EXCEPT
{
    TgSINT_E32                          iIndex;
...
/* ---- Thread_RW_Command_Unit_Test ---------------------------------------------------------------------------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TEST_LOCAL TgUINT_E32 Thread_RW_Command_Unit_Test( TgATTRIBUTE_MAYBE_UNUSED TgUINT_PTR_C uiUnused ) TgATTRIBUTE_NO_EXCEPT
{
    TgSINT_E32                          iIndex;
    TgSINT_E32                          niWrite;
    TgSINT_E32                          niCommand;
