...
UNIT_TEST__TEST__MUTEX(
    TgATTRIBUTE_MAYBE_UNUSED TgUINT_PTR_C uiUnused ) TgATTRIBUTE_NO_EXCEPT;
...
TEST_LOCAL TgUINT_E32 UNIT_TEST__TEST__MUTEX( TgATTRIBUTE_MAYBE_UNUSED TgUINT_PTR_C uiUnused ) TgATTRIBUTE_NO_EXCEPT
{
    ...
    TgSTD_ATOMIC(store)( &s_iTest_Enabled, 3 );

    return (0);
}


TEST_LOCAL TgUINT_E32 UNIT_TEST__TEST__SEMAPHORE( TgATTRIBUTE_MAYBE_UNUSED TgUINT_PTR_C uiUnused ) TgATTRIBUTE_NO_EXCEPT
{
    TgSTD_ATOMIC(store)( &s_iTest_Enabled, 1 );
