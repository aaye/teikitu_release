...
TEST_LOCAL TgSINT_E32_A                     s_iTest;
TEST_LOCAL TgSINT_E32_A                     s_iTest_Enabled;
...
TEST_LOCAL TgUINT_E32 Thread_Unit_Test( TgATTRIBUTE_MAYBE_UNUSED TgUINT_PTR_C uiUnused ) TgATTRIBUTE_NO_EXCEPT
{
    tgTR_Yield();
    TgSTD_ATOMIC(fetch_add)( &s_iTest, 1 );
    s_tiTest_Thread = tgTR_Query_Id();
    return (0);
}


TEST_LOCAL TgUINT_E32 Thread_Unit_Test_Gated( TgATTRIBUTE_MAYBE_UNUSED TgUINT_PTR_C uiUnused ) TgATTRIBUTE_NO_EXCEPT
{
    TgSTD_ATOMIC(store)( &s_iTest_Enabled, 1 );
    while (0 != TgSTD_ATOMIC(load)( &s_iTest_Enabled ))
    {
        tgTR_Yield();
    }
    return (0);
...
TEST_LOCAL TgUINT_E32 Thread_Unit_Test_Noop( TgATTRIBUTE_MAYBE_UNUSED TgUINT_PTR_C uiUnused ) TgATTRIBUTE_NO_EXCEPT
{
    return (0);
}


TEST_LOCAL TgUINT_E32 Thread_Unit_Test_Sleep( TgATTRIBUTE_MAYBE_UNUSED TgUINT_PTR_C uiUnused ) TgATTRIBUTE_NO_EXCEPT
{
    tgTR_Sleep(1000000);
    return (0);
}
...
TEST_METHOD( UNIT_TEST__TEST__TR_Create )
{
    ...
    tgTR_Close( tiThread );
    Test__Expect_EQ(1, TgSTD_ATOMIC(load)( &s_iTest ));
/*# TgCOMPILE__THREAD */
#endif
...
TEST_METHOD( UNIT_TEST__TEST__TR_Status )
{
    ...
    TgSTD_ATOMIC(store)( &s_iTest_Enabled, 0 );
    tgTR_Close( tiThread );
