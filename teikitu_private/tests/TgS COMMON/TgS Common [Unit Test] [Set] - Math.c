...
EXTN_METHOD_DECLARE( UNIT_TEST__TEST__Math_Constant );
EXTN_METHOD_DECLARE( UNIT_TEST__TEST__MATH_Vector_F_Algorithm_F32 );
EXTN_METHOD_DECLARE( UNIT_TEST__TEST__MATH_Vector_F_Polynomial_F32 );
EXTN_METHOD_DECLARE( UNIT_TEST__TEST__MATH_Vector_F_Algorithm_F64 );
EXTN_METHOD_DECLARE( UNIT_TEST__TEST__MATH_Vector_F_Polynomial_F64 );
