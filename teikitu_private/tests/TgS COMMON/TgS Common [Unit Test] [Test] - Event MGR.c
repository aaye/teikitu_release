...
static TgSINT_E32 s_iEvent_MGR_Test;
...
static TgVOID EM_TE_FRM_Unit_Test( TgATTRIBUTE_MAYBE_UNUSED TgUINT_PTR_C uiParam ) TgATTRIBUTE_NO_EXCEPT
{
    ++s_iEvent_MGR_Test;
}

static TgVOID EM_TE_SEC_Unit_Test( TgATTRIBUTE_MAYBE_UNUSED TgUINT_PTR_C uiParam ) TgATTRIBUTE_NO_EXCEPT
{
    ++s_iEvent_MGR_Test;
}
