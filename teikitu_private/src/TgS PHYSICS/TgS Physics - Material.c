...
PHYSICS_FUNCTION_ACCESSOR__DEFINITION_ASSIGN_SIMPLE(Material,MATERIAL,Density,TgFLOAT32,m_fDensity)
PHYSICS_FUNCTION_ACCESSOR__DEFINITION_ASSIGN_SIMPLE(Material,MATERIAL,Hardness_Brinell,TgFLOAT32,m_fHardness_Brinell)
PHYSICS_FUNCTION_ACCESSOR__DEFINITION_ASSIGN_SIMPLE(Material,MATERIAL,Tensile_Strength_Ultimate,TgFLOAT32,m_fTensile_Strength_Ultimate)
PHYSICS_FUNCTION_ACCESSOR__DEFINITION_ASSIGN_SIMPLE(Material,MATERIAL,Tensile_Strength_Yield,TgFLOAT32,m_fTensile_Strength_Yield)
PHYSICS_FUNCTION_ACCESSOR__DEFINITION_ASSIGN_SIMPLE(Material,MATERIAL,Elongation_At_Break,TgFLOAT32,m_fElongation_At_Break)
PHYSICS_FUNCTION_ACCESSOR__DEFINITION_ASSIGN_SIMPLE(Material,MATERIAL,Modulus_Elasticity,TgFLOAT32,m_fModulus_Elasticity)
PHYSICS_FUNCTION_ACCESSOR__DEFINITION_ASSIGN_SIMPLE(Material,MATERIAL,Poisson_Ratio,TgFLOAT32,m_fPoisson_Ratio)
PHYSICS_FUNCTION_ACCESSOR__DEFINITION_ASSIGN_SIMPLE(Material,MATERIAL,Shear_Modulus,TgFLOAT32,m_fShear_Modulus)


/* ---- tgPH_Material Accessors - Thermal Component ------------------------------------------------------------------------------------------------------------------------------ */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */

PHYSICS_FUNCTION_ACCESSOR__DEFINITION_ASSIGN_SIMPLE(Material,MATERIAL,Thermal_Conductivity,TgFLOAT32,m_fThermal_Conductivity)
PHYSICS_FUNCTION_ACCESSOR__DEFINITION_ASSIGN_SIMPLE(Material,MATERIAL,Thermal_Expansion,TgFLOAT32,m_fThermal_Expansion)
PHYSICS_FUNCTION_ACCESSOR__DEFINITION_ASSIGN_SIMPLE(Material,MATERIAL,Melting_Temperature,TgFLOAT32,m_fMelting_Temperature)
PHYSICS_FUNCTION_ACCESSOR__DEFINITION_ASSIGN_SIMPLE(Material,MATERIAL,Boiling_Temperature,TgFLOAT32,m_fBoiling_Temperature)


/* ---- tgPH_Material Accessors - Fluid Component -------------------------------------------------------------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */

PHYSICS_FUNCTION_ACCESSOR__DEFINITION_ASSIGN_SIMPLE(Material,MATERIAL,Vapour_Pressure,TgFLOAT32,m_fVapour_Pressure)
PHYSICS_FUNCTION_ACCESSOR__DEFINITION_ASSIGN_SIMPLE(Material,MATERIAL,Surface_Tension,TgFLOAT32,m_fSurface_Tension)
PHYSICS_FUNCTION_ACCESSOR__DEFINITION_ASSIGN_SIMPLE(Material,MATERIAL,Dynamic_Viscosity,TgFLOAT32,m_fDynamic_Viscosity)
PHYSICS_FUNCTION_ACCESSOR__DEFINITION_ASSIGN_SIMPLE(Material,MATERIAL,Kinematic_Viscosity,TgFLOAT32,m_fKinematic_Viscosity)
PHYSICS_FUNCTION_ACCESSOR__DEFINITION_ASSIGN_SIMPLE(Material,MATERIAL,Speed_of_Sound,TgFLOAT32,m_fSpeed_of_Sound)
...
TgVOID tgPH_Material_Reset_Do_Command( TgVOID_CPC pCommand_Buffer, TgRSIZE_C nbyCommand_Buffer )
{
    ...
    atomic_fetch_sub( &g_xnuiPH_Material, 1 );
}
