...
TgVOID T_NAME(tgPH_Module_,_Init)( TgVOID )
{
...
#endif
    {
        ...
        T_NAME_VAR(apsPH_,_Used) = (T_NAME(STg2_PH_,_PP))TgMALLOC_POOL_COMMENT( T_NAME_VAR(nuiPH_,_Total_Reserve) * sizeof(T_NAME(STg2_PH_,_P)), TgMACRO_USZ_MACRO(MALLOC_COMMENT) );
