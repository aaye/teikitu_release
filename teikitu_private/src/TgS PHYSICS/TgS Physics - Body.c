...
PHYSICS_FUNCTION_DEFER_DEFINITION__COPY(Body_Add_Form_Command, Body, BODY, STg2_PH_Form_Command_Data, UNUSED,
    ...
    tgPH_Body_Add_Form_IMM( uCMD.pCommand->tiID, uCMD.pCommand->Val.m_tiFM0, uCMD.pCommand->Val.m_vPosB, uCMD.pCommand->Val.m_qRotB, &uCMD.pCommand->Val.m_sMass );
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgVOID tgPH_Body_Add_Form_IMM( TgPH_BODY_ID_C tiBY, TgPH_FORM_ID_C tiFM, TgVEC_F32_04_1_C vPosO2B, TgVEC_F32_04_1_C vRotO2B, STg2_PH_Mass_CPC pMass )
{
    STg2_PH_Form_P                      psFM;
    STg2_PH_Body_P                      psBY;
    STg2_PH_Mass                        sMass;
    ...
    tgMM_Copy( &sMass, sizeof(sMass), pMass, sizeof(pMass) );
    tgPH_Mass_Rotate_Eul( &sMass, vRotO2B );
    tgPH_Mass_Move( &sMass, vPosO2B );
    #pragma endregion
