...
TgVOID tgPH_Ragdoll_Init_Do_Command( TgVOID_CPC pCommand_Buffer, TgRSIZE_C nbyCommand_Buffer )
{
    ...
    g_aapsPH_Ragdoll_Used[psRL->m_tiRagdoll.m_uiWorld][psRL->m_uiUsed_Index] = psRL;
}
...
TgVOID tgPH_Ragdoll_Reset_Do_Command( TgVOID_CPC pCommand_Buffer, TgRSIZE_C nbyCommand_Buffer )
{
    ...
    uiIndex = TgSTD_ATOMIC(fetch_sub_explicit)( g_axnuiPH_Ragdoll_Total__Used + psRL->m_tiRagdoll.m_uiWorld, 1, TgSTD_MEMORY_ORDER(relaxed) );
    g_aapsPH_Ragdoll_Used[psRL->m_tiRagdoll.m_uiWorld][psRL->m_uiUsed_Index] = g_aapsPH_Ragdoll_Used[psRL->m_tiRagdoll.m_uiWorld][uiIndex - 1];
