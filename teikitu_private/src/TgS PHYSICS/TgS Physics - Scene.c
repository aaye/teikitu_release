...
/* ---- tgPH_Scene_Enable -------------------------------------------------------------------------------------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgRESULT tgPH_Scene_Enable( TgPH_SCENE_ID_C UNUSED_PARAM tiScene )
{
    return (KTgE_FAIL);
}


/* ---- tgPH_Scene_Insert_Body --------------------------------------------------------------------------------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgRESULT tgPH_Scene_Insert_Body( TgPH_SCENE_ID_C UNUSED_PARAM tiScene, TgPH_BODY_ID_C UNUSED_PARAM tiBody )
{
    return (KTgE_FAIL);
}


/* ---- tgPH_Scene_Insert_Constraint --------------------------------------------------------------------------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgRESULT tgPH_Scene_Insert_Constraint( TgPH_SCENE_ID_C UNUSED_PARAM tiScene, TgPH_BODY_ID_C UNUSED_PARAM tiBody )
{
    return (KTgE_FAIL);
}


/* ---- tgPH_Scene_Insert_Rag_Doll ----------------------------------------------------------------------------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgRESULT tgPH_Scene_Insert_Rag_Doll( TgPH_SCENE_ID_C UNUSED_PARAM tiScene, TgPH_BODY_ID_C UNUSED_PARAM tiBody )
{
    return (KTgE_FAIL);
}
...
/* ---- tgPH_Load_File ----------------------------------------------------------------------------------------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgPH_SCENE_ID tgPH_Load_File( TgUINT_F32_C UNUSED_PARAM ARG0, STg2_Input_PC UNUSED_PARAM ARG1, TgUINT_PTR_C UNUSED_PARAM ARG2, UNUSED_PARAM TgVOID(*ARG3)( TgUINT_PTR_C, TgPH_SCENE_ID_C) )
{
    return (KTgPH_SCENE_ID__INVALID);
}
...
TgVOID tgPH_Scene_Reset_Do_Command( TgVOID_CPC pCommand_Buffer, TgRSIZE_C nbyCommand_Buffer )
{
    ...
    //atomic_fetch_sub( g_axnuiPH_Scene + uCMD.pCommand->tiID.m_uiWorld, 1 );
}
