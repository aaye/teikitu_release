...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgRESULT tgKN_GPU_Select_Context__Init_From_Config( TgATTRIBUTE_MAYBE_UNUSED STg2_KN_GPU_Select_PCU psSelect )
{
    /* #IMPLEMENT */
    return (KTgS_OK);
}
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgRESULT tgKN_GPU_Select_Context__Init_From_Enumeration( TgATTRIBUTE_MAYBE_UNUSED STg2_KN_GPU_Select_PCU psSelect )
{
    /* #IMPLEMENT */
    return (KTgS_OK);
}
