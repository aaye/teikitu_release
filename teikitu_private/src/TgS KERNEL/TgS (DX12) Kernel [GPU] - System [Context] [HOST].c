...
MSVC_WARN_DISABLE_PUSH(5103)
#include TgMACRO_CONCAT3_SZ(TgBUILD_CONFIG, TgPLATFORM__BARE_PATH_SEPARATOR, Standard_Particle_00_PS_FX_vs.hlsl.h)
#include TgMACRO_CONCAT3_SZ(TgBUILD_CONFIG, TgPLATFORM__BARE_PATH_SEPARATOR, Standard_Particle_01_PS_FX_vs.hlsl.h)
#include TgMACRO_CONCAT3_SZ(TgBUILD_CONFIG, TgPLATFORM__BARE_PATH_SEPARATOR, Standard_Debug_Geom_00_PS_P_vs.hlsl.h)
#include TgMACRO_CONCAT3_SZ(TgBUILD_CONFIG, TgPLATFORM__BARE_PATH_SEPARATOR, Standard_Debug_Geom_01_PS_PC_vs.hlsl.h)
#include TgMACRO_CONCAT3_SZ(TgBUILD_CONFIG, TgPLATFORM__BARE_PATH_SEPARATOR, Standard_Debug_Geom_02_PS_PNC_vs.hlsl.h)
#include TgMACRO_CONCAT3_SZ(TgBUILD_CONFIG, TgPLATFORM__BARE_PATH_SEPARATOR, Standard_Debug_Geom_02I_PS_PNC_vs.hlsl.h)
#include TgMACRO_CONCAT3_SZ(TgBUILD_CONFIG, TgPLATFORM__BARE_PATH_SEPARATOR, Standard_Debug_Geom_03_PS_PNC_vs.hlsl.h)
#include TgMACRO_CONCAT3_SZ(TgBUILD_CONFIG, TgPLATFORM__BARE_PATH_SEPARATOR, Standard_Debug_Line_PS_PC_vs.hlsl.h)
#include TgMACRO_CONCAT3_SZ(TgBUILD_CONFIG, TgPLATFORM__BARE_PATH_SEPARATOR, Standard_Debug_UI_PS_UI_vs.hlsl.h)
#include TgMACRO_CONCAT3_SZ(TgBUILD_CONFIG, TgPLATFORM__BARE_PATH_SEPARATOR, Standard_Debug_UI_Text_PS_UIT_vs.hlsl.h)
#include TgMACRO_CONCAT3_SZ(TgBUILD_CONFIG, TgPLATFORM__BARE_PATH_SEPARATOR, Standard_FX_ps.hlsl.h)
#include TgMACRO_CONCAT3_SZ(TgBUILD_CONFIG, TgPLATFORM__BARE_PATH_SEPARATOR, Standard_Debug_P_ps.hlsl.h)
#include TgMACRO_CONCAT3_SZ(TgBUILD_CONFIG, TgPLATFORM__BARE_PATH_SEPARATOR, Standard_Debug_PC_ps.hlsl.h)
#include TgMACRO_CONCAT3_SZ(TgBUILD_CONFIG, TgPLATFORM__BARE_PATH_SEPARATOR, Standard_Debug_PCG_ps.hlsl.h)
#include TgMACRO_CONCAT3_SZ(TgBUILD_CONFIG, TgPLATFORM__BARE_PATH_SEPARATOR, Standard_Debug_PN_ps.hlsl.h)
#include TgMACRO_CONCAT3_SZ(TgBUILD_CONFIG, TgPLATFORM__BARE_PATH_SEPARATOR, Standard_Debug_PNC_ps.hlsl.h)
#include TgMACRO_CONCAT3_SZ(TgBUILD_CONFIG, TgPLATFORM__BARE_PATH_SEPARATOR, Standard_Debug_UI_ps.hlsl.h)
#include TgMACRO_CONCAT3_SZ(TgBUILD_CONFIG, TgPLATFORM__BARE_PATH_SEPARATOR, Standard_Debug_UIG_ps.hlsl.h)
#include TgMACRO_CONCAT3_SZ(TgBUILD_CONFIG, TgPLATFORM__BARE_PATH_SEPARATOR, Standard_Debug_UIT_ps.hlsl.h)
#include TgMACRO_CONCAT3_SZ(TgBUILD_CONFIG, TgPLATFORM__BARE_PATH_SEPARATOR, Standard_Test_PNC_ps.hlsl.h)
MSVC_WARN_DISABLE_POP(5103)
