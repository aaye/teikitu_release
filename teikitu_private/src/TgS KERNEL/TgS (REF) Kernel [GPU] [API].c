...
TgVOID tgKN_GPU_EXT__CMD__Render_Debug_Geom( UTg2_KN_GPU_CMD_C ARG0, ETgKN_GPU_DEBUG_PM ARG1, STg2_KN_GPU_HLSL_CB_Debug_Model_CPC ARG2 )
{
}
...
TgUINT_E32 tgKN_GPU_EXT_Query_Mode_List( STg2_KN_GPU_Mode_P ARG0, TgUINT_E32_C ARG1, TgUINT_E32_C ARG2, TgUINT_E32_C ARG3, ETgKN_GPU_EXT_FORMAT_C ARG4 )
{
    return (0);
}
...
TgRESULT tgKN_GPU_EXT__Execute__Init_Debug( UTg2_KN_GPU_CMD_C ARG0 )
{
    return (KTgS_OK);
}
...
TgVOID tgKN_GPU_EXT__Execute__Register_Debug_Geometry( UTg2_KN_GPU_CMD_C ARG0, ETgKN_GPU_DEBUG_PM ARG1, TgKN_GPU_DBG_PM_Generate_CPCU ARG2 )
{
}
