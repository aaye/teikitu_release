...
TgEXTN TgRESULT
tgKN_IF__Open(
    STg2_Input_File_PCU OUT0, TgKN_FS_MOUNT_ID_C ARG1, TgUINT_E32_C ARG2, TgUINT_E32_C ARG3 );
...
TgEXTN TgRESULT
tgKN_OF__Open(
    STg2_Output_File_PCU OUT0, TgKN_FS_MOUNT_ID_C ARG1, TgUINT_E32_C ARG2, TgUINT_E32_C ARG3 );
