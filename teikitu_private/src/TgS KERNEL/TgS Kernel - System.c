...
/* ---- tgKN_Notify_Start -------------------------------------------------------------------------------------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgKN_NOTIFY_ID tgKN_Notify_Start( TgKN_FCN_NOTIFY_CALLBACK psFCN, TgUINT_PTR_C uiParam0, TgUINT_E64_C uiMSG )
{
    TgRSIZE                             uiCount;
    TgUINT_MAX                          uiHash;
...
/* ---- tgKN_Notify_MSG ---------------------------------------------------------------------------------------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgRESULT tgKN_Notify_MSG( TgUINT_E64_C uiMSG, TgUINT_E64_C uiParam1, TgUINT_E64_C uiParam2 )
{
    TgUINT_MAX                          uiHash;
    TgRSIZE                             uiCount;
    TgRSIZE                             uiIndex;
