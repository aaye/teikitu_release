...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgRESULT T(tgKN_GPU_,__Execute_Load)( TgKN_FILE_ID_C tiFile, TgATTRIBUTE_MAYBE_UNUSED TgRSIZE_C uiFile_Offset, T(STg2_KN_GPU_,_DESC_CPC) psDESC, TgATTRIBUTE_MAYBE_UNUSED ETgKN_GPU_ALLOCATOR_C enAllocator,
