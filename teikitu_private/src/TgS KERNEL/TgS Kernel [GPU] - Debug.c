...
TgRESULT tgKN_GPU__Execute__Init_Debug( TgKN_GPU_CXT_EXEC_ID_C tiCXT_EXEC )
{
    ...
    #if defined(TgCOMPILE__RENDER_DEBUG_OUTPUT) || TgS_DEBUG__KERNEL || TgS_DEBUG__RENDER
    ...
    /*# defined(TgCOMPILE__RENDER_DEBUG_OUTPUT) || TgS_DEBUG__KERNEL || TgS_DEBUG__RENDER */ 
    #endif
