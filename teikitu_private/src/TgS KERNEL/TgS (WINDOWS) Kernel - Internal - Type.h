...
/*  »Project«   Teikitu Gaming System (TgS) (∂)
    »File«      TgS (WINDOWS) Kernel - Internal - Type.h
...
/* =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-==-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=--=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-= */
#if !defined(TGS_WINDOWS_KERNEL_INTERNAL_TYPE_H)
#define TGS_WINDOWS_KERNEL_INTERNAL_TYPE_H
#pragma once
...
TgTYPE_STRUCT(STg2_KN_OS_HWND,)
{
    ...
    TgSINT_E32                                  m_iWindow_Saved_X;
    TgSINT_E32                                  m_iWindow_Saved_Y;
    TgSINT_E32                                  m_iWindow_Saved_W;
    TgSINT_E32                                  m_iWindow_Saved_H;
