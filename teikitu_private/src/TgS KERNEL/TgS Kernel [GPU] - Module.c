...
#if TgCOMPILE__CONSOLE && defined(TgCOMPILE__RENDER_DEBUG_OUTPUT)
    tgCN_Register_Render_Callback( nullptr );
/*# TgCOMPILE__CONSOLE && defined(TgCOMPILE__RENDER_DEBUG_OUTPUT) */
#endif
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgRESULT tgKN_GPU_Module_Update( TgATTRIBUTE_MAYBE_UNUSED TgFLOAT32_C fDT )
{
    return (KTgS_OK);
}
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
#if TgS_STAT__KERNEL
TgVOID tgKN_GPU_Stats( TgATTRIBUTE_MAYBE_UNUSED STg2_Output_P psOUT )
{
}
/*# TgS_STAT__KERNEL */
#endif
