        ...
        for (uiRTScanOut = 0; uiRTScanOut < KTgKN_GPU_EXT_FORMAT_RT_SCANOUT_MAX; ++uiRTScanOut)
        {
            ...
            for (uiDSScanOut = 0; uiDSScanOut < KTgKN_GPU_EXT_FORMAT_DS_SCANOUT_MAX; ++uiDSScanOut)
            {
                ...
                else
                {
                    ...
                    {
                        TgCHAR_U8_CPC                       uszRT = tgKN_GPU_EXT_FMT_To_USZ( (ETgKN_GPU_EXT_FORMAT)KTgKN_GPU_EXT_FORMAT_RT_SCANOUT[uiRTScanOut] );
                        TgCHAR_U8_CPC                       uszDS = tgKN_GPU_EXT_FMT_To_USZ( (ETgKN_GPU_EXT_FORMAT)KTgKN_GPU_EXT_FORMAT_DS_SCANOUT[uiDSScanOut] );
