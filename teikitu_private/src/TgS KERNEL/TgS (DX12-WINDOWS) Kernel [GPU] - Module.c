...
/*  »Project«   Teikitu Gaming System (TgS) (∂)
    »File«      TgS (DX12-WIN) Kernel - Module [GPU].c
...
TgEXTN TgDLL_EXPORT const UINT              D3D12SDKVersion;
       TgDLL_EXPORT const UINT              D3D12SDKVersion = D3D12_SDK_VERSION;
TgEXTN TgDLL_EXPORT const TgCHAR_U8 *       D3D12SDKPath;
       TgDLL_EXPORT const TgCHAR_U8 *       D3D12SDKPath = u8".\\";
...
tgKN_GPU_EXT_Query_Monitor_Min_Resolution(
    TgUINT_E32_P puiW, TgUINT_E32_P puiH, HMONITOR hMonitor );
...
tgKN_GPU_EXT_Query_Swap_Context_Mode_Width_and_Height(
    TgUINT_E32_P puiW, TgUINT_E32_P puiH, HWND hWnd, HMONITOR hMonitor );
...
/*# !defined(TGS_FINAL) */
    ...
    else if ( /* Load the needed functions from the DLL */
    ...
    {
        TgERROR_MSGF( 0, STD_MSG_LITERAL_1, STD_MSG_POST, u8"Unable to find function in WinPixEventRuntime DLL." );
        goto tgKN_OS_GPU_API_Module_Init_FAIL;
    };
...
/* ---- tgKN_GPU_EXT_Query_Monitor_Min_Resolution -------------------------------------------------------------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
static TgVOID tgKN_GPU_EXT_Query_Monitor_Min_Resolution( TgUINT_E32_P puiW, TgUINT_E32_P puiH, HMONITOR hMonitor )
{
...
/* ---- tgKN_GPU_EXT_Query_Monitor_Max_Resolution -------------------------------------------------------------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
static TgVOID tgKN_GPU_EXT_Query_Monitor_Max_Resolution( TgUINT_E32_P puiW, TgUINT_E32_P puiH, HMONITOR hMonitor )
{
    TgRSIZE                             uiAdapter, uiOutput;
    DXGI_MODE_DESC1_P                   psDXGI_Mode;
...
/* ---- tgKN_GPU_EXT_Query_Swap_Context_Mode_Width_and_Height -------------------------------------------------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
static TgVOID tgKN_GPU_EXT_Query_Swap_Context_Mode_Width_and_Height( TgUINT_E32_P puiW, TgUINT_E32_P puiH, HWND hWnd, HMONITOR hMonitor )
{
...
/* ---- tgKN_GPU_EXT_Query_Closest_Output_Mode_Width_and_Height_Rounded_Down ----------------------------------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
static TgVOID tgKN_GPU_EXT_Query_Closest_Output_Mode_Width_and_Height_Rounded_Down( TgUINT_E32_P puiW, TgUINT_E32_P puiH, HWND hWnd, HMONITOR hMonitor )
{
    TgUINT_E32                          uiAdapter, uiOutput, uiSwap;
