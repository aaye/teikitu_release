...
TgRESULT T(tgKN_GPU_EXT_,__Execute_Load)(
    TgATTRIBUTE_MAYBE_UNUSED TgKN_FILE_ID_C ARG0, TgATTRIBUTE_MAYBE_UNUSED TgRSIZE_C ARG1, TgATTRIBUTE_MAYBE_UNUSED T(STg2_KN_GPU_,_DESC_CPC) ARG2,
    TgATTRIBUTE_MAYBE_UNUSED ETgKN_GPU_ALLOCATOR_C ARG3, TgATTRIBUTE_MAYBE_UNUSED T(TgKN_GPU_,_ID_C) ARG4 )
{
    return (KTgS_OK);
}
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgVOID T(tgKN_GPU_EXT_,__Execute_Free)( TgATTRIBUTE_MAYBE_UNUSED T(TgKN_GPU_,_ID_C) sID )
{
