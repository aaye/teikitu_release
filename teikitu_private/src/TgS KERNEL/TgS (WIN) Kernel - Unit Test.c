...
/*  »Project«   Teikitu Gaming System (TgS) (∂)
    »File«      TgS (WIN) Kernel - Unit Test.c
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
static TgSINT_F64 __stdcall tgKN_OS_UNIT_TEST__UTIL__Window_Update( HWND hWnd, TgUINT_F32 uMessage, TgUINT_F64 wParam, TgSINT_F64 lParam )
{
