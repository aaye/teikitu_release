...
TgRESULT FCN_VO(tgCO_ST_Intersect_ST)(VEC_OBJ_T(STg2_CO_Packet,PC) psPacket, VEC_OBJ_T(TgSTRI,CPC) psST0, VEC_OBJ_T(TgSTRI,CPC) psST1)
{
    ...
    else
    {
        ...
        psCL->m_nuiPoint = 0;
        psCL->m_nuiMax = 8;
        TgCRITICAL_MSGF( nullptr != psCL, STD_MSG_LITERAL_1, STD_MSG_POST, u8"Failed to allocate memory." );
        ...
        else
        {
            ...
            switch (nuiPoint)
            {
                ...
                TgATTRIBUTE_FALLTHROUGH case 1:
                    psContact = psPacket->m_psContact + psPacket->m_nuiContact;
...
static TgRESULT FCN_VO(tgCO_ST_Internal_CoP_ST)( VEC_OBJ_T(STg2_CO_Packet,PC) psPacket, VEC_OBJ_T(STg2_CO_Clip_List,PC) psCL, VEC_T(1,C) vT0, VEC_T(1,C) vNormal )
{
    ...
    switch (nuiPoint)
    {
        ...
        TgATTRIBUTE_FALLTHROUGH case 5:
            psContact = psPacket->m_psContact + psPacket->m_nuiContact;
        ...
        TgATTRIBUTE_FALLTHROUGH case 4:
            psContact = psPacket->m_psContact + psPacket->m_nuiContact;
        ...
        TgATTRIBUTE_FALLTHROUGH case 3:
            psContact = psPacket->m_psContact + psPacket->m_nuiContact;
        ...
        TgATTRIBUTE_FALLTHROUGH case 2:
            psContact = psPacket->m_psContact + psPacket->m_nuiContact;
            psContact->m_vS0 = psCL->m_avPoint[1];
            psContact->m_vN0 = vNormal;
            psContact->m_vT0 = vT0;
                                             ...
                                             VEC_OBJ_T(TgDELTA,CPC) psDT )
{
    ...
    switch (iResult)
    {
        ...
        TgATTRIBUTE_FALLTHROUGH case 0: /* Contact occurred in valid interval, but earlier contact already recorded. */
            break;
