...
/* -.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.- */
/*  Internal Types for Matrix Functions                                                                                                                                            */
/* -.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.- */

typedef VEC_T(1)                            (*FCN_VO(TgCO_FCN_ClosestSq))( VEC_T(1,PC), VEC_T(1,PC), TgVOID_CPC, TgVOID_CPC );
typedef VEC_T(1)                            (*FCN_VO(TgCO_FCN_Closest))( VEC_T(1,PC), VEC_T(1,PC), TgVOID_CPC, TgVOID_CPC );
typedef VEC_T(1)                            (*FCN_VO(TgCO_FCN_DistSq))( TgVOID_CPC, TgVOID_CPC );
typedef VEC_T(1)                            (*FCN_VO(TgCO_FCN_Dist))( TgVOID_CPC, TgVOID_CPC );
typedef TgRESULT                            (*FCN_VO(TgCO_FCN_Penetrate))( VEC_OBJ_T(STg2_CO_Packet,PC), TgVOID_CPC, TgVOID_CPC );
typedef TgRESULT                            (*FCN_VO(TgCO_FCN_Sweep))( VEC_OBJ_T(STg2_CO_Packet,PC), VEC_T(1,PC), TgVOID_CPC, TgVOID_CPC, VEC_OBJ_T(TgDELTA,CPC) );
typedef TgBOOL                              (*FCN_VO(TgCO_FCN_Test))( TgVOID_CPC, TgVOID_CPC );




/* -.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.- */
/*  Internal Data for Matrix Functions                                                                                                                                             */
/* -.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.- */

TgEXTN FCN_VO(TgCO_FCN_ClosestSq)           FCN_VO(g_apfnCO_ClosestSq)[ETgPM_MAX][ETgPM_MAX];
TgEXTN FCN_VO(TgCO_FCN_Closest)             FCN_VO(g_apfnCO_Closest)[ETgPM_MAX][ETgPM_MAX];
TgEXTN FCN_VO(TgCO_FCN_DistSq)              FCN_VO(g_apfnCO_DistSq)[ETgPM_MAX][ETgPM_MAX];
TgEXTN FCN_VO(TgCO_FCN_Dist)                FCN_VO(g_apfnCO_Dist)[ETgPM_MAX][ETgPM_MAX];
TgEXTN FCN_VO(TgCO_FCN_Penetrate)           FCN_VO(g_apfnCO_Penetrate)[ETgPM_MAX][ETgPM_MAX];
TgEXTN FCN_VO(TgCO_FCN_Sweep)               FCN_VO(g_apfnCO_Sweep)[ETgPM_MAX][ETgPM_MAX];
TgEXTN FCN_VO(TgCO_FCN_Test)                FCN_VO(g_apfnCO_Test)[ETgPM_MAX][ETgPM_MAX];
...
TgEXTN TgVOID
FCN_VO(tgCO_FCN_Matrix_Setup_ClosestSq)( TgVOID );

TgEXTN TgVOID
FCN_VO(tgCO_FCN_Matrix_Setup_Closest)( TgVOID );

TgEXTN TgVOID
FCN_VO(tgCO_FCN_Matrix_Setup_DistSq)( TgVOID );

TgEXTN TgVOID
FCN_VO(tgCO_FCN_Matrix_Setup_Dist)( TgVOID );

TgEXTN TgVOID
FCN_VO(tgCO_FCN_Matrix_Setup_Penetrate)( TgVOID );

TgEXTN TgVOID
FCN_VO(tgCO_FCN_Matrix_Setup_Sweep)( TgVOID );

TgEXTN TgVOID
FCN_VO(tgCO_FCN_Matrix_Setup_Test)( TgVOID );
