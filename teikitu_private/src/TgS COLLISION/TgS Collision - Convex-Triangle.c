...
TgRESULT FCN_VO(tgCO_ST_Sweep_CX)(
    VEC_OBJ_T(STg2_CO_Packet,PC) psPacket, VEC_T(1,PC) pvPM, VEC_OBJ_T(TgSTRI,CPC) psST0, VEC_OBJ_T(TgSTRI,CPC) apsST, TgATTRIBUTE_MAYBE_UNUSED VEC_OBJ_T(TgBOXAA,CPC) apsBA, 
