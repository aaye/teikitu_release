...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgRESULT VI(tgCO_CY_Intersect_LR)( TgATTRIBUTE_MAYBE_UNUSED VEC_OBJ_T(STg2_CO_Packet,PC) psPacket, TgATTRIBUTE_MAYBE_UNUSED VEC_OBJ_T(TgTUBE,CPC) psCY0,
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgRESULT VI(tgCO_CY_Internal_PM_LR)( TgATTRIBUTE_MAYBE_UNUSED VEC_T(1,P) pfLN0, TgATTRIBUTE_MAYBE_UNUSED VEC_T(1,P) pfLN1, TgATTRIBUTE_MAYBE_UNUSED VEC_T(1,PC) pvN0,
                                     TgATTRIBUTE_MAYBE_UNUSED VEC_T(1,PC) pvN1, TgATTRIBUTE_MAYBE_UNUSED VEC_OBJ_T(TgTUBE,CPC) psCY0, TgATTRIBUTE_MAYBE_UNUSED VEC_T(1,C) vS0,
