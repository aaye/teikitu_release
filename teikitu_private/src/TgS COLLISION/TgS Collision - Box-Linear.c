...
//    VEC_T(1,P), VEC_T(1,C), VEC_T(1,C), TgSINT_E32_C , TgSINT_E32_C , TgSINT_E32_C , VEC_OBJ_T(TgBOX,CPC) );
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
VEC_T(1) VI(tgCO_BX_ClosestSq_PM_LR)( TgATTRIBUTE_MAYBE_UNUSED VEC_T(1,PC) pvBX0, TgATTRIBUTE_MAYBE_UNUSED VEC_T(1,PC) pvBX1, TgATTRIBUTE_MAYBE_UNUSED VEC_T(1,PC) pvBX2,
                                      TgATTRIBUTE_MAYBE_UNUSED VEC_T(1,PC) pvLN0, TgATTRIBUTE_MAYBE_UNUSED VEC_OBJ_T(TgBOX,CPC) psBX0, TgATTRIBUTE_MAYBE_UNUSED VEC_T(1,C) vS0,
                                      TgATTRIBUTE_MAYBE_UNUSED VEC_T(1,C) vD0 )
{
...
/* Return: Result Code.                                                                                                                                                            */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgRESULT VI(tgCO_BX_Clip_PM_LR)( TgATTRIBUTE_MAYBE_UNUSED VEC_T(1,P) pfLN0, TgATTRIBUTE_MAYBE_UNUSED VEC_T(1,P) pfLN1, TgATTRIBUTE_MAYBE_UNUSED VEC_OBJ_T(TgBOX,CPC) psBX0,
                                 TgATTRIBUTE_MAYBE_UNUSED VEC_T(1,C) vS0, TgATTRIBUTE_MAYBE_UNUSED VEC_T(1,C) vD0 )
{
    return (KTgE_FAIL);
...
/* Return: Result Code                                                                                                                                                             */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
//VAR_T() VI(tgCO_BX_Box_DoF2_LR)( VAR_T(P) pfLN0, VEC_T(1,PC) pvDS, VEC_T(1,C) vD0, TgSINT_E32_C i0, TgSINT_E32_C i1, TgATTRIBUTE_MAYBE_UNUSED TgSINT_E32_C i2, VEC_OBJ_T(TgBOX,CPC) psBX0 )
//{
