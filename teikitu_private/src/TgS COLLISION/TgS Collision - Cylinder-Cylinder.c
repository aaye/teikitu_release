...
//    VEC_OBJ_T(STg2_CO_Contact,PU) OUT0, TgSINT_E32_PC OUT1, VEC_T(1,C) ARG2, VEC_OBJ_T(TgELLIPSE,CPC) ARG3, VEC_OBJ_T(TgTUBE,CPC) ARG4, VEC_OBJ_T(TgTUBE,CPC) ARG5 );
//
//static TgRESULT
//FCN_VO(tgCO_CY_Internal_CapContained_CY)(
//    VEC_OBJ_T(STg2_CO_Contact,PU) OUT0, TgSINT_E32_PC OUT1, VEC_T(1,C) ARG2, VEC_OBJ_T(TgTUBE,CPC) ARG3, VEC_OBJ_T(TgTUBE,CPC) ARG4 );
//
//static TgRESULT
...
//    TgSINT_E32                          niMax, iIdx, niPoint = 0;
//
...
//    VEC_OBJ_T(STg2_CO_Contact,PU) psContact, TgSINT_E32_PC pniPoint, VEC_T(1,C) vNormal, VEC_OBJ_T(TgELLIPSE,CPC) psEL0, VEC_OBJ_T(TgTUBE,CPC) psCY0, VEC_OBJ_T(TgTUBE,CPC) psCY1 )
//{
//    TgSINT_E32                          niPoint = 0;
//    VAR_T()                             fT0, fT1;
//    VAR_T()                             fTest;
...
//    VEC_OBJ_T(STg2_CO_Contact,PU) psContact, TgSINT_E32_PC pniPoint, VEC_T(1,C) vNormal, VEC_OBJ_T(TgTUBE,CPC) psCY0, VEC_OBJ_T(TgTUBE,CPC) psCY1 )
//{
//    TgSINT_E32                          niPoint = 0;
//    VAR_T()                             fTest;
//
...
///* Return: Result Code                                                                                                                                                             */
///* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
//static TgRESULT FCN_VO(tgCO_CY_Internal_AxisCap_CY)( VEC_OBJ_T(STg2_CO_Contact,PU) psContact, TgSINT_E32_PC pniPoint, VEC_T(1,C) vNormal, VEC_OBJ_T(TgTUBE,CPC) psCY0, VEC_OBJ_T(TgTUBE,CPC) psCY1 )
//{
//    VAR_T()                             fT0, fT1;
//
//    VAR_T(C)        fK1 = FCN_F(tgPM_FSEL)(FCN_V(tgMH_DOT)(pvNormal, &psCY1->m_vU_HAX), -TYPE_K(1), TYPE_K(1));
