...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgPNS_OBJECT_ID tgPA_PnS_Insert_Object( STg2_PA_PnS_PCU psPnS, TgUINT_MAX_C uiCallbackID, TgUINT_F64_C uiCategory, TgUINT_F64_C uiCollide, TgBOXAA_F32_04_CPCU psBA )
{
    TgUINT_F32                          uiIndex_Object;
...
/* ---- tgPA_PnS_Test_AABB ------------------------------------------------------------------------------------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgBOOL tgPA_PnS_Test_AABB( STg2_PA_PnS_PCU psPnS, TgUINT_F64_C uiCategory, TgUINT_F64_C uiCollide, TgBOXAA_F32_04_CPCU psBA )
{
    /* Check this object against all current objects, adding all existing pair-wise potential contact sets */
    ...
    STg2_PA_PnS_PCU psPnS, STg2_PA_PnS_PointEnd_PCU psX, TgFLOAT32_C fMin0, TgFLOAT32_C fMax0, TgFLOAT32_C fMin1, TgFLOAT32_C fMax1, TgPNS_OBJECT_ID_C tiObject )
{
    ...
    TgUINT_F64_C                        uiCategory = psPnS->m_uiCategory[tiObject.m_uiI];
    TgUINT_F64_C                        uiCollide = psPnS->m_uiCollide[tiObject.m_uiI];
