...
/*  »Project«   Teikitu Gaming System (TgS) (∂)
    »File«      TgS (WINDOWS) Input - Mouse.c
...
{
    TgSINT_E32                                  m_iX, m_iY, m_iZ;
    TgUINT_E08                                  m_uiButtons[8];
};
...
static DIOBJECTDATAFORMAT s_asMouse_Layout[] = {
    { &MS_GUID_XAxis, (TgUINT_E32)offsetof( TgIN_MOUSE_DATA, m_iX ), DIDFT_AXIS | DIDFT_ANYINSTANCE, 0, },
    { &MS_GUID_YAxis, (TgUINT_E32)offsetof( TgIN_MOUSE_DATA, m_iY ), DIDFT_AXIS | DIDFT_ANYINSTANCE, 0, },
    { &MS_GUID_ZAxis, (TgUINT_E32)offsetof( TgIN_MOUSE_DATA, m_iZ ), DIDFT_AXIS | DIDFT_ANYINSTANCE | 0x80000000, 0, },
    { 0, (TgUINT_E32)offsetof( TgIN_MOUSE_DATA, m_uiButtons[0] ), DIDFT_BUTTON | DIDFT_ANYINSTANCE, 0, },
    { 0, (TgUINT_E32)offsetof( TgIN_MOUSE_DATA, m_uiButtons[1] ), DIDFT_BUTTON | DIDFT_ANYINSTANCE, 0, },
    { 0, (TgUINT_E32)offsetof( TgIN_MOUSE_DATA, m_uiButtons[2] ), DIDFT_BUTTON | DIDFT_ANYINSTANCE | 0x80000000, 0, },
    { 0, (TgUINT_E32)offsetof( TgIN_MOUSE_DATA, m_uiButtons[3] ), DIDFT_BUTTON | DIDFT_ANYINSTANCE | 0x80000000, 0, },
    { 0, (TgUINT_E32)offsetof( TgIN_MOUSE_DATA, m_uiButtons[4] ), DIDFT_BUTTON | DIDFT_ANYINSTANCE | 0x80000000, 0, },
    { 0, (TgUINT_E32)offsetof( TgIN_MOUSE_DATA, m_uiButtons[5] ), DIDFT_BUTTON | DIDFT_ANYINSTANCE | 0x80000000, 0, },
    { 0, (TgUINT_E32)offsetof( TgIN_MOUSE_DATA, m_uiButtons[6] ), DIDFT_BUTTON | DIDFT_ANYINSTANCE | 0x80000000, 0, },
    { 0, (TgUINT_E32)offsetof( TgIN_MOUSE_DATA, m_uiButtons[7] ), DIDFT_BUTTON | DIDFT_ANYINSTANCE | 0x80000000, 0, },
};
...
TgFORCEINLINE TgFLOAT32                     tgIN_Convert_Movement_Value( TgSINT_E32 , TgFLOAT32_C );
...
TgRESULT tgIN_PM_Stop_Mouse( TgVOID )
{
    ...
    g_asController_Active[ETgCONTROLLER_MOUSE].m_enController = ETgCONTROLLER__MAX;
    tgCM_UT_LF__LA_RB_SRSW__Init( &g_asController_Active[ETgCONTROLLER_MOUSE].m_sLA_RB_SRSW, KTgCONTROLLER_MAX_EVENT );
    g_asController_Active[ETgCONTROLLER_MOUSE].m_psConsumer = nullptr;
...
{
    TgUINT_E32_C    uiID = (TgUINT_E32)(enController - ETgCONTROLLER_MOUSE);
    TgUINT_E32_C    uiNext = s_asMouse[uiID].m_uiBuffer ^ 1;
    TgUINT_E32_C    uiPrev = s_asMouse[uiID].m_uiBuffer;
    TgUINT_E32                          uiIndex;
    TgUINT_E32                          uiEvent;
    TgUINT_E32                          uiState = ETgSTATE_MOUSE_VALID;
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgFORCEINLINE TgFLOAT32 tgIN_Convert_Movement_Value( TgSINT_E32 sValue, TgFLOAT32_C fDeadZone )
{
