...
STg2_Input_Producer                         g_asController_Active[ETgCONTROLLER__MAX];
STg2_Input_Rumble                           g_asController_Rumble[ETgCONTROLLER__MAX];
TgBOOL                                      g_abController_Paused[ETgCONTROLLER__MAX];
...
#if TgS_STAT__INPUT
TgUINT_E32                                  g_nuiStat_Insert[ETgCONTROLLER__MAX + 1], g_nuiStat_Remove[ETgCONTROLLER__MAX + 1];
#endif
