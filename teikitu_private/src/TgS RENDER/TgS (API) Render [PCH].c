...
TgVOID Prevent2183_REF_Render_Static( TgVOID )
{
}


#if defined(TgBUILD_FEATURE__GRAPHICS)
TgVOID tgRN_Calc_UV_Animation( TgATTRIBUTE_MAYBE_UNUSED TgVEC_F32_04_1_PCU ARG0, TgATTRIBUTE_MAYBE_UNUSED TgVEC_F32_04_1_PCU ARG1, TgATTRIBUTE_MAYBE_UNUSED TgRN_MATERIAL_ID_C ARG2, TgATTRIBUTE_MAYBE_UNUSED TgVEC_F32_04_1 ARG3, TgATTRIBUTE_MAYBE_UNUSED TgVEC_F32_04_1 ARG4 ) {} /* #IMPLEMENT */
