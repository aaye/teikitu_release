...
TgRSIZE tgFX_Effect__Beam__Render_Quad_Count( STg2_FX__Beam_P psBeam )
{
    ...
    TgUINT_E32                          uiStart_Frame, uiEnd_Frame;
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgUINT_E32 T(tgFX__Render__Beam_Render_Generate_Particle)( STg2_FX_Rnd_Output_PC psRndOut, STg2_RN_Particle_Header_PC psHeader, STg2_FX__Beam_P psBeam )
{
    STg2_FX_Beam__File_Data_CPC         psFile_Data = psBeam->m_psFile_Data;
    ...
    TgUINT_E32                          uiStart_Frame, uiEnd_Frame, uiFrame;
    TgRSIZE                             nuiQuad;
    TgBOOL                              bQuad_Camera_Facing;
