...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgVOID tgFX__Scene__Beam_Cull__Insert_Frame_Mesh( TgATTRIBUTE_MAYBE_UNUSED STg2_SE_Context_PC psSE_Context, TgATTRIBUTE_MAYBE_UNUSED TgRSIZE_C uiView_Index, TgATTRIBUTE_MAYBE_UNUSED TgFX_DATA_INST_ID tiActive )
{
