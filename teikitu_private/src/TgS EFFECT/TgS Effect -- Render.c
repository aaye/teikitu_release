...
TgRESULT tgFX__Render__Job__Allocate_Render_Buffers( STg2_Job_CPC psJob )
{
    union
    {
        STg2_FX_Job__Render_Allocate_CPC    psRender_Allocate;
        TgUINT_E08_CPC                      pui;
    } const                             sUnion = { .pui = psJob->m_auiData };
    TgRSIZE                             nbyTotal_Particle_Memory;
    TgFLOAT32                           fMin_Quality_Score;

    TgERROR( 0 == TgSTD_ATOMIC(load)(&g_xuiFX_FENCE__RENDER__PROCESS_HEADERS) );

    fMin_Quality_Score = 0.0F;
    do
    {
        nbyTotal_Particle_Memory  = TgSTD_ATOMIC(load)( &g_nbyFX__Beam__Scene__Particle_Memory );
        nbyTotal_Particle_Memory += TgSTD_ATOMIC(load)( &g_nbyFX__Billboard__Scene__Particle_Memory );
        nbyTotal_Particle_Memory += TgSTD_ATOMIC(load)( &g_nbyFX__Decal__Scene__Particle_Memory );
        nbyTotal_Particle_Memory += TgSTD_ATOMIC(load)( &g_nbyFX__Emitter__Scene__Particle_Memory );
        nbyTotal_Particle_Memory += TgSTD_ATOMIC(load)( &g_nbyFX__GIB__Scene__Particle_Memory );
        nbyTotal_Particle_Memory += TgSTD_ATOMIC(load)( &g_nbyFX__Glass__Scene__Particle_Memory );
        nbyTotal_Particle_Memory += TgSTD_ATOMIC(load)( &g_nbyFX__Liquid__Scene__Particle_Memory );
        nbyTotal_Particle_Memory += TgSTD_ATOMIC(load)( &g_nbyFX__Trail__Scene__Particle_Memory );
    ...
    sUnion.psRender_Allocate->m_psRndOut->m_nbyUsed += TgSTD_ATOMIC(load)( &g_nbyFX__Beam__Scene__Particle_Memory );
    sUnion.psRender_Allocate->m_psRndOut->m_nbyFree -= TgSTD_ATOMIC(load)( &g_nbyFX__Beam__Scene__Particle_Memory );
    ...
    sUnion.psRender_Allocate->m_psRndOut->m_nbyUsed += TgSTD_ATOMIC(load)( &g_nbyFX__Billboard__Scene__Particle_Memory );
    sUnion.psRender_Allocate->m_psRndOut->m_nbyFree -= TgSTD_ATOMIC(load)( &g_nbyFX__Billboard__Scene__Particle_Memory );
    ...
    sUnion.psRender_Allocate->m_psRndOut->m_nbyUsed += TgSTD_ATOMIC(load)( &g_nbyFX__Decal__Scene__Particle_Memory );
    sUnion.psRender_Allocate->m_psRndOut->m_nbyFree -= TgSTD_ATOMIC(load)( &g_nbyFX__Decal__Scene__Particle_Memory );
    ...
    sUnion.psRender_Allocate->m_psRndOut->m_nbyUsed += TgSTD_ATOMIC(load)( &g_nbyFX__Emitter__Scene__Particle_Memory );
    sUnion.psRender_Allocate->m_psRndOut->m_nbyFree -= TgSTD_ATOMIC(load)( &g_nbyFX__Emitter__Scene__Particle_Memory );
    ...
    sUnion.psRender_Allocate->m_psRndOut->m_nbyUsed += TgSTD_ATOMIC(load)( &g_nbyFX__GIB__Scene__Particle_Memory );
    sUnion.psRender_Allocate->m_psRndOut->m_nbyFree -= TgSTD_ATOMIC(load)( &g_nbyFX__GIB__Scene__Particle_Memory );
    ...
    sUnion.psRender_Allocate->m_psRndOut->m_nbyUsed += TgSTD_ATOMIC(load)( &g_nbyFX__Glass__Scene__Particle_Memory );
    sUnion.psRender_Allocate->m_psRndOut->m_nbyFree -= TgSTD_ATOMIC(load)( &g_nbyFX__Glass__Scene__Particle_Memory );
    ...
    sUnion.psRender_Allocate->m_psRndOut->m_nbyUsed += TgSTD_ATOMIC(load)( &g_nbyFX__Liquid__Scene__Particle_Memory );
    sUnion.psRender_Allocate->m_psRndOut->m_nbyFree -= TgSTD_ATOMIC(load)( &g_nbyFX__Liquid__Scene__Particle_Memory );
    ...
    sUnion.psRender_Allocate->m_psRndOut->m_nbyUsed += TgSTD_ATOMIC(load)( &g_nbyFX__Trail__Scene__Particle_Memory );
    sUnion.psRender_Allocate->m_psRndOut->m_nbyFree -= TgSTD_ATOMIC(load)( &g_nbyFX__Trail__Scene__Particle_Memory );
...
TgVOID tgFX__Render__Submit_Job__Allocate_Render_Buffers( STg2_FX_Rnd_Output_PC psRndOut )
{
    ...
    TgERROR( 0 == TgSTD_ATOMIC(load)( &g_xuiFX_FENCE__RENDER__ALLOCATE ) );

    TgSTD_ATOMIC(fetch_add)( &g_xuiFX_FENCE__RENDER__ALLOCATE, 1 );
    ...
    g_sFX__Job__Render__Allocate_Render_Buffers.m_pxuiTrigger = &g_xuiFX_FENCE__RENDER__PROCESS_HEADERS;
    ...
    {
        TgWARNING_MSGF( false, STD_MSG_LITERAL_1, STD_MSG_POST, u8"Failed to submit job." );
        tgFX__Render__Job__Allocate_Render_Buffers( &g_sFX__Job__Render__Allocate_Render_Buffers );
        TgSTD_ATOMIC(fetch_sub)( &g_xuiFX_FENCE__RENDER__ALLOCATE, 1 );
    };
}
/*# defined(TgBUILD_FEATURE__GRAPHICS_VFX) */
#endif
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgINLINE TgRSIZE tgFX__Render__Billboard_Render_Memory_Particle_00( TgATTRIBUTE_MAYBE_UNUSED STg2_FX__Billboard_P psBillboard )
{
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgINLINE TgRSIZE tgFX__Render__Billboard_Render_Memory_Particle_01( TgATTRIBUTE_MAYBE_UNUSED STg2_FX__Billboard_P psBillboard )
{
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgINLINE TgRSIZE tgFX__Render__GIB_Render_Memory_Particle_00( TgATTRIBUTE_MAYBE_UNUSED STg2_FX__GIB_P psGIB )
{
    /* #IMPLEMENT */
    return (0);
}
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgINLINE TgRSIZE tgFX__Render__GIB_Render_Memory_Particle_01( TgATTRIBUTE_MAYBE_UNUSED STg2_FX__GIB_P psGIB )
{
    /* #IMPLEMENT */
    return (0);
}
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgINLINE TgRSIZE tgFX__Render__Glass_Render_Memory_Particle_00( TgATTRIBUTE_MAYBE_UNUSED STg2_FX__Glass_P psGlass )
{
    /* #IMPLEMENT */
    return (0);
}
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgINLINE TgRSIZE tgFX__Render__Glass_Render_Memory_Particle_01( TgATTRIBUTE_MAYBE_UNUSED STg2_FX__Glass_P psGlass )
{
    /* #IMPLEMENT */
    return (0);
}
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgINLINE TgRSIZE tgFX__Render__Liquid_Render_Memory_Particle_00( TgATTRIBUTE_MAYBE_UNUSED STg2_FX__Liquid_P psLiquid )
{
    /* #IMPLEMENT */
    return (0);
}
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgINLINE TgRSIZE tgFX__Render__Liquid_Render_Memory_Particle_01( TgATTRIBUTE_MAYBE_UNUSED STg2_FX__Liquid_P psLiquid )
{
    /* #IMPLEMENT */
    return (0);
}
...
{
    return (6 * tgFX_Effect__Trail__Render_Quad_Count( psTrail ) * sizeof( STg2_KN_GPU_Vertex_Particle_00 ));
}
...
{
    return (6 * tgFX_Effect__Trail__Render_Quad_Count( psTrail ) * sizeof( STg2_KN_GPU_Vertex_Particle_01 ));
}
...
TgVOID T_NAME(tgFX__Client__,_Init_Render)( TgVOID )
{
    ...
    TgSTD_ATOMIC(store)( &T_TYPE(g_xuiFX_FENCE__RENDER__PROCESS_HEADERS__,), 0 );
    TgSTD_ATOMIC(store)( &T_TYPE(g_xuiFX_FENCE__RENDER__GENERATE__,), 0 );
    for (uiIndex = 0; uiIndex < ETgFX_UPDATE__MAX; ++uiIndex)
    {
        TgSTD_ATOMIC(store)( T_TYPE(g_axuiFX_FENCE__RENDER__PROCESS_HEADERS__,) + uiIndex, 0 );
    };
    ...
    TgSTD_ATOMIC(store)( &T_NAME(g_xuiFX_Command__,__SceneToRender_Offset), 0 );
}
...
TgVOID T_NAME(tgFX__Client__,_Boot_Render)( TgVOID )
{
    ...
    T_NAME(g_sFX__Render__Job__,_Render_Generate).m_pxuiTrigger = &g_xuiFX_FENCE__RENDER__ALLOCATE;
...
TgVOID T_NAME(tgFX__Render__Submit_Job__,_Process_Headers)( STg2_FX_Rnd_Output_PC psRndOut )
{
    ...
    TgSTD_ATOMIC(store)( &T_NAME(g_nbyFX__,__Scene__Particle_Memory), 0 );

    TgSTD_ATOMIC(fetch_add)( &T_TYPE(g_xuiFX_FENCE__RENDER__PROCESS_HEADERS__,), 1 );
    TgSTD_ATOMIC(fetch_add)( &g_xuiFX_FENCE__RENDER, 1 );
    TgSTD_ATOMIC(fetch_add)( &g_xuiFX_FENCE__RENDER__PROCESS_HEADERS, 1 );
    TgSTD_ATOMIC(fetch_add)( T_TYPE(g_axuiFX_FENCE__RENDER__PROCESS_HEADERS__,) + ETgFX_UPDATE__DEFAULT, 1 );
    ...
    {
        TgWARNING_MSGF( false, STD_MSG_LITERAL_1, STD_MSG_POST, u8"Failed to submit job." );
        T_NAME(tgFX__Render__Job__,_Process_Headers)( T_NAME(g_asFX__Render__Job__,_Process_Headers) + ETgFX_UPDATE__DEFAULT );
        TgSTD_ATOMIC(fetch_sub)( &T_TYPE(g_xuiFX_FENCE__RENDER__PROCESS_HEADERS__,), 1 );
    }

    TgSTD_ATOMIC(fetch_add)( &T_TYPE(g_xuiFX_FENCE__RENDER__PROCESS_HEADERS__,), 1 );
    TgSTD_ATOMIC(fetch_add)( &g_xuiFX_FENCE__RENDER, 1 );
    TgSTD_ATOMIC(fetch_add)( &g_xuiFX_FENCE__RENDER__PROCESS_HEADERS, 1 );
    TgSTD_ATOMIC(fetch_add)( T_TYPE(g_axuiFX_FENCE__RENDER__PROCESS_HEADERS__,) + ETgFX_UPDATE__EXTERNAL, 1 );
    ...
    {
        TgWARNING_MSGF( false, STD_MSG_LITERAL_1, STD_MSG_POST, u8"Failed to submit job." );
        T_NAME(tgFX__Render__Job__,_Process_Headers)( T_NAME(g_asFX__Render__Job__,_Process_Headers) + ETgFX_UPDATE__EXTERNAL );
        TgSTD_ATOMIC(fetch_sub)( &T_TYPE(g_xuiFX_FENCE__RENDER__PROCESS_HEADERS__,), 1 );
    }
}
...
TgVOID T_NAME(tgFX__Render__Submit_Job__,_Render_Generate)( STg2_FX_Rnd_Output_PC psRndOut )
{
    ...
    TgSTD_ATOMIC(fetch_add)( &T_TYPE(g_xuiFX_FENCE__RENDER__GENERATE__,), 1 );
    TgSTD_ATOMIC(fetch_add)( &g_xuiFX_FENCE__RENDER, 1 );
    TgSTD_ATOMIC(fetch_add)( &g_xuiFX_FENCE__RENDER__GENERATE, 1 );
    ...
    {
        TgWARNING_MSGF( false, STD_MSG_LITERAL_1, STD_MSG_POST, u8"Failed to submit job." );
        T_NAME(tgFX__Render__Job__,_Render_Generate)( &T_NAME(g_sFX__Render__Job__,_Render_Generate) );
        TgSTD_ATOMIC(fetch_sub)( &T_TYPE(g_xuiFX_FENCE__RENDER__GENERATE__,), 1 );
    }
}
...
{
#if TgS_DEBUG__EFFECT && defined(TgCOMPILE__RENDER_DEBUG_OUTPUT)
    {
        TgBOOL                              bDraw;
...
/*# TgS_DEBUG__EFFECT && defined(TgCOMPILE__RENDER_DEBUG_OUTPUT) */
#endif
...
static TgVOID T_NAME(tgFX__Render__,_Process_Headers)( STg2_FX_Rnd_Output_PC psRndOut, ETgFX_UPDATE_C enUpdate )
{
    ...
    uiHeader_Index = TgSTD_ATOMIC(fetch_add)( &psRndOut->m_xnuiFX_Header, uiHeader_Count );
    ...
    while (KTgID__INVALID_VALUE != tiActive.m_uiKI && uiHeader_Count > 0)
    {
        ...
        TgSTD_ATOMIC(fetch_add)( &T_NAME(g_nbyFX__,__Scene__Particle_Memory), psFX_Header->m_nbyVertex );
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
static TgRESULT T_NAME(tgFX__Render__Job__,_Process_Headers)( STg2_Job_CPC psJob )
{
    union
    {
        STg2_FX_Job__Process_Headers_CP     psProcess_Headers;
        TgUINT_E08_CP                       pui;
    }                                   sUnion;

    TgERROR(0 == TgSTD_ATOMIC(load)(&T_TYPE(g_xuiFX_FENCE__SCENE__CULL__,)));
    ...
    TgSTD_ATOMIC(fetch_sub)( &g_xuiFX_FENCE__RENDER, 1 );
    TgSTD_ATOMIC(fetch_sub)( &g_xuiFX_FENCE__RENDER__PROCESS_HEADERS, 1 );
    TgSTD_ATOMIC(fetch_sub)( T_TYPE(g_axuiFX_FENCE__RENDER__PROCESS_HEADERS__,) + sUnion.psProcess_Headers->m_enUpdate, 1 );
...
static TgVOID T_NAME(tgFX__Render__,_Render_ReCalculate_CPU_Vertex_Buffer_Size_Required)( STg2_FX_Rnd_Output_PC psRndOut, TgFLOAT32_C fMin_Quality_Score )
{
    ...
    nbyTotal_Size = 0;
    for (enFX_Update = ETgFX_UPDATE__DEFAULT; enFX_Update <= ETgFX_UPDATE__EXTERNAL; enFX_Update = (ETgFX_UPDATE)((TgSINT_E32)enFX_Update + 1))
    {
    ...
    TgSTD_ATOMIC(store)( &T_NAME(g_nbyFX__,__Scene__Particle_Memory), nbyTotal_Size );
}


/* ---- tgFX__Render__,_Render_Allocate_CPU_Vertex_Buffer ------------------------------------------------------------------------------------------------------------------------ */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
static TgVOID T_NAME(tgFX__Render__,_Render_Allocate_CPU_Vertex_Buffer)( STg2_FX_Rnd_Output_PC psRndOut, TgRSIZE nbyOffset )
{
    TgRSIZE                             nbyUsed_Check = nbyOffset;
    ETgFX_UPDATE                        enFX_Update;
    TgFX_DATA_INST_ID                   tiActive;
    T_NAME(STg2_FX__,_P)                psEffect;
    T_NAME(STg2_FX__,_P)                psPrev_Effect;
    ...
    for (enFX_Update = ETgFX_UPDATE__DEFAULT; enFX_Update <= ETgFX_UPDATE__EXTERNAL; enFX_Update = (ETgFX_UPDATE)((TgSINT_E32)enFX_Update + 1))
    {
        ...
        while (KTgID__INVALID_VALUE != tiActive.m_uiKI)
        {
            ...
            psRndOut->m_psFX_Header[psEffect->m_uiIndex_In_RN_Context].m_uiBuffer_Offset = nbyOffset;
            nbyOffset += psRndOut->m_psFX_Header[psEffect->m_uiIndex_In_RN_Context].m_nbyVertex;
            TgERROR(nbyOffset - nbyUsed_Check <= TgSTD_ATOMIC(load)( &T_NAME(g_nbyFX__,__Scene__Particle_Memory) ));
...
/*# TgS_DEBUG__EFFECT */
    ...
    while (KTgID__INVALID_VALUE != tiActive.m_uiKI)
    {
        ...
        if (0 == psFX_Header->m_nbyVertex)
        {
            psFX_Header->m_uiGenerated_Vertices = 0;
        }
        else if (ETgKN_GPU_DEFAULT_INPUT_LAYOUT_VERTEX_PARTICLE_00 == psEffect->m_enVertex)
        {
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
static TgRESULT T_NAME(tgFX__Render__Job__,_Render_Generate)( STg2_Job_CPC psJob )
{
    union
    {
        STg2_FX_Job__Render_Generate_CP     psRender_Generate;
        TgUINT_E08_CP                       pui;
    }                                   sUnion;
    ...
    TgSTD_ATOMIC(fetch_sub)( &g_xuiFX_FENCE__RENDER, 1 );
    TgSTD_ATOMIC(fetch_sub)( &g_xuiFX_FENCE__RENDER__GENERATE, 1 );
