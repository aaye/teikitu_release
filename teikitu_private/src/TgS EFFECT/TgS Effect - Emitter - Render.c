...
static TgVOID tgFX_Effect__Emitter__Reference_Frame( STg2_FX__Emitter__Render_Point_P psPoint, TgVEC_F32_04_1_C vPos_W )
{
    ...
    switch (psPoint->m_psExtend->m_psFile_Data__Particle->m_enOrientation)
    {
        ...
        case ETgFX_PARTICLE_ORIENTATION__VELOCITY_TANGENT: TgATTRIBUTE_FALLTHROUGH
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgUINT_E32 T(tgFX__Render__Emitter_Render_Generate_Particle)( STg2_FX_Rnd_Output_PC psRndOut, STg2_RN_Particle_Header_PC psHeader, STg2_FX__Emitter_P psEmitter )
{
    union
    {
        TgUINT_E08_P                        pui;
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
static TgUINT_E32 T(tgFX__Render__Emitter_Render_Generate_Particle_Tangent)(
