...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgBOOL tgFX__Update__Light_Create_Command( TgATTRIBUTE_MAYBE_UNUSED STg2_FX_Instance_CP psInst, TgFX_DATA_INST_ID_C tiData, TgATTRIBUTE_MAYBE_UNUSED TgVOID_CP pData1 )
{
