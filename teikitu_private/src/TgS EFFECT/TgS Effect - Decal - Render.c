...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgUINT_E32 T(tgFX__Render__Decal_Render_Generate_Particle)( STg2_FX_Rnd_Output_PC psRndOut, STg2_RN_Particle_Header_PC psHeader, STg2_FX__Decal_P psDecal )
{
    union
    {
        TgUINT_E08_P                        pui;
    ...
    TgUINT_E32                          nuiMaxVert;

    sVert.pui = psRndOut->m_puiBuffer + psHeader->m_uiBuffer_Offset;
    nuiMaxVert = (TgUINT_E32)(psHeader->m_nbyVertex / sizeof( T(STg2_KN_GPU_Vertex_Particle) ));
    TgERROR( nuiMaxVert >= 3 );

    nuiMaxVert = tgCM_MIN_U32( nuiMaxVert, (TgUINT_E32)psDecal->m_sExtend.m_nuiVert );
