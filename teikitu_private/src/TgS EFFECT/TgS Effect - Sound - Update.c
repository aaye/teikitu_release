...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgVOID tgFX__File__Sound_Patch_File_Data( TgATTRIBUTE_MAYBE_UNUSED STg2_FX_Sound__File_Data_P psData )
{
}
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgBOOL tgFX__Update__Sound_Create_Command( TgATTRIBUTE_MAYBE_UNUSED STg2_FX_Instance_CP psInst, TgFX_DATA_INST_ID_C tiData, TgATTRIBUTE_MAYBE_UNUSED TgVOID_CP pData1 )
{
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgVOID tgFX__Update__Sound_Update( TgATTRIBUTE_MAYBE_UNUSED TgVEC_F32_04_1 vdT, TgATTRIBUTE_MAYBE_UNUSED TgFLOAT32_C fDT, ETgFX_UPDATE_C enUpdate )
{
