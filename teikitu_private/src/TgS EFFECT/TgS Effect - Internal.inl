...
TgINLINE TgVOID tgFX__Update__Set_Render_Data_From_Material_Hash( TgATTRIBUTE_MAYBE_UNUSED TgRN_MESH_SET_ID_P ARG0, TgRN_MATERIAL_ID_P ARG1, ETgKN_GPU_DEFAULT_INPUT_LAYOUT_P ARG2, TgATTRIBUTE_MAYBE_UNUSED TgUINT_MAX_C ARG3 )
{
    ARG1->m_uiI = 1;
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgINLINE TgUINT_E32 tgFX_Quality_Setting_Lerp__Value_U32( TgATTRIBUTE_MAYBE_UNUSED TgUINT_E32_CP puiVal )
{
    /* #IMPLEMENT */
    return (0);
}
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgINLINE TgSINT_E32 tgFX_Quality_Setting_Lerp__Value_S32( TgATTRIBUTE_MAYBE_UNUSED TgSINT_E32_CP psVal )
{
    /* #IMPLEMENT */
    return (0);
}
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgINLINE TgUINT_E32 tgFX_Quality_Setting_Lerp__Range_U32( TgATTRIBUTE_MAYBE_UNUSED TgUINT_E32_CP puiMID, TgATTRIBUTE_MAYBE_UNUSED TgUINT_E32_CP puiRNG )
{
    /* #IMPLEMENT */
    return (0);
}
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgINLINE TgSINT_E32 tgFX_Quality_Setting_Lerp__Range_S32( TgATTRIBUTE_MAYBE_UNUSED TgSINT_E32_CP piMID, TgATTRIBUTE_MAYBE_UNUSED TgSINT_E32_CP piRNG )
{
    /* #IMPLEMENT */
    return (0);
}
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgINLINE TgBOOL T_NAME(tgFX__Client__,_ToClient)( TgATTRIBUTE_MAYBE_UNUSED TgFX_CLIENT_INST_ID_C tiClient, ETgFX_COMMAND_C enCommand, TgVOID_CP pData )
{
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgINLINE TgUINT_E08_P T_NAME(tgFX_,__ToClient__Reserve_Command)( ETgFX_COMMAND_C enCommand )
{
    ...
    uiCommand_Offset = TgSTD_ATOMIC(load)( &T_NAME(g_xuiFX_Command__,__ToClient_Offset) );
    while (1)
    {
        if ((uiCommand_Offset + uiCommand_Size) >= ETgFX_COMMAND__CLIENT_TO_UPDATE__BYTE_MAX)
        {
            ...
            TgSTD_ATOMIC(store)( &g_xuiFX_Fence__TO_CLIENT__COMMAND_QUEUE_FULL, 1 );
            return (nullptr);
        };

        if(TgSTD_ATOMIC(compare_exchange_strong)( &T_NAME(g_xuiFX_Command__,__ToClient_Offset), &uiCommand_Offset, uiCommand_Offset + uiCommand_Size ))
        {
