...
/*# TgS_DEBUG__EFFECT */
    ...
    TgERROR( 0 == TgSTD_ATOMIC(load)( &g_xuiFX_FENCE__UPDATE ) );
    TgERROR( 0 == TgSTD_ATOMIC(load)( &g_xuiFX_FENCE__SCENE ) );
    TgERROR( 0 == TgSTD_ATOMIC(load)( &g_xuiFX_FENCE__RENDER ) );
    ...
    //while (0 != TgSTD_ATOMIC(load)(&g_xuiFX_FENCE__UPDATE__UPDATE)) {};
}
...
TgVOID tgFX__Client__Update_2( TgFLOAT32_C fDT )
{
    ...
    if (0 != g_xuiFX_Fence__CLIENT_TO_UPDATE__COMMAND_QUEUE_FULL)
    {
        ...
        TgVERIFY( 0 != TgSTD_ATOMIC(exchange)( &g_xuiFX_Fence__CLIENT_TO_UPDATE__COMMAND_QUEUE_FULL, 0 ) );
    };
...
TgVOID tgFX__Client__Update_Finish( TgVOID )
{
    ...
    //while (0 != TgSTD_ATOMIC(load)(&g_xuiFX_FENCE__UPDATE__FINISH)) {};
    ...
    //while (0 != TgSTD_ATOMIC(load)(&g_xuiFX_FENCE__SCENE__REFRESH_BA)) {};
}


/* ---- tgFX__Client__Wait_For_Update_Completion --------------------------------------------------------------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
#if defined(TgBUILD_FEATURE__GRAPHICS_VFX)
TgVOID tgFX__Client__Wait_For_Update_Completion( TgVOID )
{
    while (0 != TgSTD_ATOMIC(load)(&g_xuiFX_FENCE__UPDATE__FINISH)) {};
    while (0 != TgSTD_ATOMIC(load)(&g_xuiFX_FENCE__SCENE__REFRESH_BA)) {};
}
...
/*# TgS_DEBUG__EFFECT */
    ...
    //while (0 != TgSTD_ATOMIC(load)(&g_xuiFX_FENCE__SCENE__CULL)) {};
}
/*# defined(TgBUILD_FEATURE__GRAPHICS_VFX) */
#endif
...
TgVOID tgFX__Render__Update( STg2_FX_Rnd_Output_PC psRndOut )
{
    ...
    TgERROR( 0 == TgSTD_ATOMIC(load)( &g_xuiFX_FENCE__RENDER__GENERATE ) );
...
/*# TgS_DEBUG__EFFECT */
    ...
    //while (0 != TgSTD_ATOMIC(load)(&g_xuiFX_FENCE__RENDER__PROCESS_HEADERS)) {};
    ...
    //while (0 != TgSTD_ATOMIC(load)(&g_xuiFX_FENCE__RENDER__ALLOCATE)) {};
    ...
    //while (0 != TgSTD_ATOMIC(load)(&g_xuiFX_FENCE__RENDER__GENERATE)) {};
}
/*# defined(TgBUILD_FEATURE__GRAPHICS_VFX) */
#endif
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
#if defined(TgBUILD_FEATURE__GRAPHICS_VFX)
TgVOID tgFX__Client__Wait_For_Render_Completion( TgVOID )
{
    while (0 != TgSTD_ATOMIC(load)(&g_xuiFX_FENCE__RENDER__GENERATE)) {};
}
/*# defined(TgBUILD_FEATURE__GRAPHICS_VFX) */
...
{
    tgFX__Client__ToClient__Process_Command_Internal( g_asFX_Command__Beam__ToClient, TgSTD_ATOMIC(load)( &g_xuiFX_Command__Beam__ToClient_Offset ) );
    tgFX__Client__ToClient__Process_Command_Internal( g_asFX_Command__Billboard__ToClient, TgSTD_ATOMIC(load)( &g_xuiFX_Command__Billboard__ToClient_Offset ) );
    tgFX__Client__ToClient__Process_Command_Internal( g_asFX_Command__Decal__ToClient, TgSTD_ATOMIC(load)( &g_xuiFX_Command__Decal__ToClient_Offset ) );
    tgFX__Client__ToClient__Process_Command_Internal( g_asFX_Command__Emitter__ToClient, TgSTD_ATOMIC(load)( &g_xuiFX_Command__Emitter__ToClient_Offset ) );
    tgFX__Client__ToClient__Process_Command_Internal( g_asFX_Command__GIB__ToClient, TgSTD_ATOMIC(load)( &g_xuiFX_Command__GIB__ToClient_Offset ) );
    tgFX__Client__ToClient__Process_Command_Internal( g_asFX_Command__Glass__ToClient, TgSTD_ATOMIC(load)( &g_xuiFX_Command__Glass__ToClient_Offset ) );
    tgFX__Client__ToClient__Process_Command_Internal( g_asFX_Command__Group__ToClient, TgSTD_ATOMIC(load)( &g_xuiFX_Command__Group__ToClient_Offset ) );
    tgFX__Client__ToClient__Process_Command_Internal( g_asFX_Command__Liquid__ToClient, TgSTD_ATOMIC(load)( &g_xuiFX_Command__Liquid__ToClient_Offset ) );
    tgFX__Client__ToClient__Process_Command_Internal( g_asFX_Command__Light__ToClient, TgSTD_ATOMIC(load)( &g_xuiFX_Command__Light__ToClient_Offset ) );
    tgFX__Client__ToClient__Process_Command_Internal( g_asFX_Command__Sound__ToClient, TgSTD_ATOMIC(load)( &g_xuiFX_Command__Sound__ToClient_Offset ) );
    tgFX__Client__ToClient__Process_Command_Internal( g_asFX_Command__Post__ToClient, TgSTD_ATOMIC(load)( &g_xuiFX_Command__Post__ToClient_Offset ) );
    tgFX__Client__ToClient__Process_Command_Internal( g_asFX_Command__Trail__ToClient, TgSTD_ATOMIC(load)( &g_xuiFX_Command__Trail__ToClient_Offset ) );
}
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgVOID tgFX__Client__Collect_Collision_Results( TgATTRIBUTE_MAYBE_UNUSED TgBOOL_C bWait )
{
...
/* ---- tgFX__Update__Group__Update_Command__Process_Command --------------------------------------------------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
static TgVOID tgFX__Update__Group__Update_Command__Process_Command( TgATTRIBUTE_MAYBE_UNUSED ETgFX_COMMAND_C enCommand, TgATTRIBUTE_MAYBE_UNUSED TgVOID_CP pData )
{
}
...
/* ---- tgFX__Client__ToClient__Process_Command_Internal ------------------------------------------------------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
static TgVOID tgFX__Client__ToClient__Process_Command_Internal( TgUINT_E08_P puiCommand_Stream, TgRSIZE uiOffset )
{
    ...
    for (uiIndex = 0; uiIndex < uiBuffer_Size; )
    {
        ...
        switch (enCommand)
        {
            ...
            case ETgFX_COMMAND__UPDATE_TO_CLIENT__NOTIFY:
            {
                ...
                switch (sCommand_Payload.ps->m_uiMessage)
                {
                    case ETgFX_NOTIFY__FRAME_COMPLETE:
                        TgSTD_ATOMIC(fetch_add)( (TgUINT_PTR_AP)(sCommand_Payload.ps->m_pNotify), 1 );
                        break;
                    default:
            ...
            case ETgFX_COMMAND__CLIENT_TO_UPDATE__BEGIN: TgATTRIBUTE_FALLTHROUGH
            case ETgFX_COMMAND__CLIENT_TO_UPDATE__CREATE: TgATTRIBUTE_FALLTHROUGH
            case ETgFX_COMMAND__CLIENT_TO_UPDATE__KILL: TgATTRIBUTE_FALLTHROUGH
            case ETgFX_COMMAND__CLIENT_TO_UPDATE__STOP: TgATTRIBUTE_FALLTHROUGH
            case ETgFX_COMMAND__CLIENT_TO_UPDATE__POSITION_SET: TgATTRIBUTE_FALLTHROUGH
            case ETgFX_COMMAND__CLIENT_TO_UPDATE__POSITION_UPDATE_FROM_PARENT: TgATTRIBUTE_FALLTHROUGH
            case ETgFX_COMMAND__CLIENT_TO_UPDATE__ROTATION_SET: TgATTRIBUTE_FALLTHROUGH
            case ETgFX_COMMAND__CLIENT_TO_UPDATE__ROTATION_UPDATE_FROM_PARENT: TgATTRIBUTE_FALLTHROUGH
            case ETgFX_COMMAND__CLIENT_TO_UPDATE__SPIN: TgATTRIBUTE_FALLTHROUGH
            case ETgFX_COMMAND__CLIENT_TO_UPDATE__VISIBLE: TgATTRIBUTE_FALLTHROUGH
            case ETgFX_COMMAND__SCENE_TO_RENDER__PATCH_CONTEXT: TgATTRIBUTE_FALLTHROUGH
