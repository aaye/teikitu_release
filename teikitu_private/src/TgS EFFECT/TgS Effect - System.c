...
/*# TgS_DEBUG__EFFECT */
    ...
    //while (0 != atomic_load(&g_xuiFX_FENCE__UPDATE__UPDATE)) {};
}
...
TgVOID tgFX__Client__Update_Finish( TgVOID )
{
    ...
    //while (0 != atomic_load(&g_xuiFX_FENCE__UPDATE__FINISH)) {};
    ...
    //while (0 != atomic_load(&g_xuiFX_FENCE__SCENE__REFRESH_BA)) {};
}
...
/*# TgS_DEBUG__EFFECT */
    ...
    //while (0 != atomic_load(&g_xuiFX_FENCE__SCENE__CULL)) {};
}
/*# defined(TgBUILD_FEATURE__GRAPHICS_VFX) */
#endif
...
/*# TgS_DEBUG__EFFECT */
    ...
    //while (0 != atomic_load(&g_xuiFX_FENCE__RENDER__PROCESS_HEADERS)) {};
    ...
    //while (0 != atomic_load(&g_xuiFX_FENCE__RENDER__ALLOCATE)) {};
    ...
    //while (0 != atomic_load(&g_xuiFX_FENCE__RENDER__GENERATE)) {};
}
/*# defined(TgBUILD_FEATURE__GRAPHICS_VFX) */
#endif
