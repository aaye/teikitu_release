...
//TgCLANG_WARN_DISABLE_PUSH(extended-offsetof)
TgCOMPILER_ASSERT( sizeof( TgUINT_E32  ) == sizeof( ETgFX_COMMAND ), 0 );
TgCOMPILER_ASSERT( sizeof( TgUINT_E64  ) == sizeof( TgFX_DATA_INST_ID ), 0 );
TgCOMPILER_ASSERT( sizeof( TgUINT_E64  ) == sizeof( TgFX_CLIENT_INST_ID ), 0 );
...
//TgCLANG_WARN_DISABLE_POP(extended-offsetof)
...
TgUINT_E32_C                                g_uiFX_Command_Size[ETgFX_COMMAND__MAX + 1] =
                                            {
...
TgUINT_E32                                  g_uiParticle_Header_Index;
STg2_Job                                    g_sFX__Job__Render__Allocate_Render_Buffers;
/*# defined(TgBUILD_FEATURE__GRAPHICS_VFX) */
#endif

TgSINT_E32                                  g_aiFX__Client__Shared_State[KTgFX_MAX_EFFECT_INSTANCE];
...
TgSINT_E32                                  g_niFX__Client__Update__Active;
...
TgUINT_E32                                  T_NAME(g_uiFX__,__Shared__Notify_State);
...
TgUINT_E08                                  T_NAME(g_asFX_Command__,__ToClient)[ETgFX_COMMAND__TO_CLIENT__BYTE_MAX];
...
TgSINT_E32                                  T_NAME(g_niFX__,__Update__Active);
...
TgUINT_E08                                  T_NAME(g_asFX_Command__,__Update_Command_Buffer)[ETgFX_COMMAND__CLIENT_TO_UPDATE__BYTE_MAX];
TgUINT_E08                                  T_NAME(g_asFX_Command__,__ClientToUpdate)[ETgFX_COMMAND__CLIENT_TO_UPDATE__BYTE_MAX];
/*# T_EFFECT_UPDATE */
#endif
...
TgSINT_E32                                  T_NAME(g_aniFX__,__Scene__Culled)[ETgFX_UPDATE__MAX];
/*# T_EFFECT_RENDER */
#else
TgFX_DATA_INST_ID                           T_NAME(g_atiFX__,__Scene__Effect_Head)[ETgFX_UPDATE__MAX];
TgSINT_E32                                  T_NAME(g_niFX__,__Scene__Effect_Active);
/*# T_EFFECT_RENDER */
#endif
...
TgSINT_E32                                  T_NAME(g_niFX__,__Render_Header__Active);
TgFX_DATA_INST_ID                           T_NAME(g_tiFX__,__Render_Generate__Head);
TgSINT_E32                                  T_NAME(g_niFX__,__Render_Generate__Active);
...
TgUINT_E08                                  T_NAME(g_asFX_Command__,__SceneToRender)[ETgFX_COMMAND__SCENE_TO_RENDER__BYTE_MAX];
/*# T_EFFECT_RENDER */
#endif
