...
static TgVOID tgFX_Effect__Billboard__Render_Reference_Frame( STg2_FX__Billboard__Render_Point_P psPoint )
{
    ...
    switch (psBillboard_File_Data->m_enOrientation)
    {
        ...
        case ETgFX_BILLBOARD_ORIENTATION__CAMERA_FACE_PLANE: TgATTRIBUTE_FALLTHROUGH
        case ETgFX_BILLBOARD_ORIENTATION__CAMERA_FACE_PLANE__FIXED_Y: TgATTRIBUTE_FALLTHROUGH
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgUINT_E32 T(tgFX__Render__Billboard_Render_Generate_Particle)( STg2_FX_Rnd_Output_PC psRndOut, STg2_RN_Particle_Header_PC psHeader, STg2_FX__Billboard_P psBillboard )
{
    union
    {
        TgUINT_E08_P                        pui;
