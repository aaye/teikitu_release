...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgVOID tgFX__File__Liquid_Patch_File_Data( TgATTRIBUTE_MAYBE_UNUSED STg2_FX_Liquid__File_Data_P psData )
{
}
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgBOOL tgFX__Update__Liquid_Create_Command( TgATTRIBUTE_MAYBE_UNUSED STg2_FX_Instance_CP psInst, TgFX_DATA_INST_ID_C tiData, TgATTRIBUTE_MAYBE_UNUSED TgVOID_CP pData1 )
{
