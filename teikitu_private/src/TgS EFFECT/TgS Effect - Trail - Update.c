...
TgVOID tgFX__Update__Trail_Process_Update_Command( ETgFX_COMMAND_C enCommand, TgVOID_CP pData, TgFX_DATA_INST_ID_C tiData )
{
    ...
    switch (enCommand)
    {
        ...
        SWITCH_FALLTHROUGH case ETgFX_COMMAND__CLIENT_TO_UPDATE__STOP: /* Fall Through - Intentionally Blank */
            break;

        case ETgFX_COMMAND__CLIENT_TO_UPDATE__POSITION_SET: /* Fall Through - Treated as the same command */
        SWITCH_FALLTHROUGH case ETgFX_COMMAND__CLIENT_TO_UPDATE__POSITION_UPDATE_FROM_PARENT:
        ...
        SWITCH_FALLTHROUGH case ETgFX_COMMAND__CLIENT_TO_UPDATE__ROTATION_UPDATE_FROM_PARENT: /* Fall Through - Rotation is not conceptually valid */
        SWITCH_FALLTHROUGH case ETgFX_COMMAND__CLIENT_TO_UPDATE__VISIBLE: /* Fall Through - Intentionally Blank */
            break;
