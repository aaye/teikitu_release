...
tgFX__Client__Group_Add_Child(
    TgFX_DATA_INST_ID_C, TgUINT_E32_C , TgFX_CLIENT_INST_ID_C );
...
T_NAME(tgFX__Client__,_ToClient)(
    TgATTRIBUTE_MAYBE_UNUSED TgFX_CLIENT_INST_ID_C tiClient, ETgFX_COMMAND_C enCommand, TgVOID_CP pData );
