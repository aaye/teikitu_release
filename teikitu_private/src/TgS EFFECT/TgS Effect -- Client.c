...
/*# TgS_DEBUG__EFFECT */
    ...
    TgSTD_ATOMIC(store)( &T_NAME(g_xuiFX_Command__,__ToClient_Offset), 0 );
...
#if T_EFFECT_GROUP
    TgUINT_E08                          uiCommand[sizeof( STg2_FX_Command__Client__Create ) + 32];
/*# T_EFFECT_GROUP */
#endif

    TgPARAM_CHECK( g_uiFX_Command_Size[ETgFX_COMMAND__CLIENT_TO_UPDATE__CREATE] >= sizeof( STg2_FX_Instance ) );
    TgPARAM_CHECK( sizeof( TgUINT_E64  ) == sizeof( TgFX_DATA_INST_ID ) );
...
/*# T_EFFECT_GROUP */
    ...
    tiData = tgFX_DATA_INST_ID_Init( &tiData_Singleton, (TgUINT_E32)iInstance );
