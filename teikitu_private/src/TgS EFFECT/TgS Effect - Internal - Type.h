...
TgTYPE_STRUCT(STg2_FX__Emitter__Particle,)
{
    ...
    TgVEC_F32_04_1                              m_vSpawn_LVel_N; /**< Linear Velocity in Particle Root Reference */
    ...
    TgVEC_F32_04_1                              m_vLVel_NT; /**< Displacement due to linear velocity at time T in Particle Root Reference Frame. */
    ...
    TgVEC_F32_04_1                              m_vLVel_W; /**< Linear velocity at time T in the World Reference Frame. */
    TgVEC_F32_04_1                              m_vLVel_WT; /**< Displacement due to linear velocity at time T in the World Reference Frame. */
...
{
    /* ------------ Update Data ------------ */
    TgVEC_F32_04_1                              m_avPos_N2W[KTgFX_MAX_POINTS_IN_TRAIL];
    TgVEC_F32_04_1                              m_vScaleFactor; /**< Single scale value */
    TgFLOAT32                                   m_afU[KTgFX_MAX_POINTS_IN_TRAIL];
