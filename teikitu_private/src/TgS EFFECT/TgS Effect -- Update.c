...
TgVOID T_NAME(tgFX__Client__,_Init_Update)( TgVOID )
{
    ...
    /* Fence Controls */
    TgSTD_ATOMIC(store)( &T_TYPE(g_xuiFX_FENCE__UPDATE__UPDATE__,), 0 );
    for (uiIndex = 0; uiIndex < ETgFX_UPDATE__MAX; ++uiIndex)
    {
        TgSTD_ATOMIC(store)( T_TYPE(g_axuiFX_FENCE__UPDATE__UPDATE__,) + uiIndex, 0 );
    };
    TgSTD_ATOMIC(store)( &T_TYPE(g_xuiFX_FENCE__UPDATE__FINISH__,), 0 );
    ...
    TgSTD_ATOMIC(store)( &T_NAME(g_xuiFX_Command__,__Update_Command_Offset), 0 );
    TgSTD_ATOMIC(store)( &T_NAME(g_xuiFX_Command__,__ClientToUpdate_Offset), 0 );
}
...
{
    TgUINT_E08_P                        puiCommand_Stream;
...
TgVOID T_NAME(tgFX__Client__Submit_Job__,_Update)( TgVEC_F32_04_1 vDT, TgFLOAT32_C fDT, ETgFX_UPDATE_C enUpdate )
{
    ...
    TgERROR((TgRSIZE)enUpdate >= TgSTD_ATOMIC(load)( &T_TYPE(g_xuiFX_FENCE__UPDATE__UPDATE__,) ));
    ...
    TgSTD_ATOMIC(fetch_add)( &T_TYPE(g_xuiFX_FENCE__UPDATE__UPDATE__,), 1 );
    TgSTD_ATOMIC(fetch_add)( &g_xuiFX_FENCE__UPDATE, 1 );
    TgSTD_ATOMIC(fetch_add)( &g_xuiFX_FENCE__UPDATE__UPDATE, 1 );
    TgSTD_ATOMIC(fetch_add)( T_TYPE(g_axuiFX_FENCE__UPDATE__UPDATE__,) + enUpdate, 1 );
    ...
    if (TgFAILED(tgJM_Queue_Job( g_sJob_Queue__Client_Normal, T_NAME(g_sFX__Job__,__Update) + enUpdate )))
    {
        ...
        T_NAME(tgFX__Update__Job__,_Update)( T_NAME(g_sFX__Job__,__Update) + enUpdate );
        TgSTD_ATOMIC(fetch_sub)( &T_TYPE(g_xuiFX_FENCE__UPDATE__UPDATE__,), 1 );
    };
}
...
TgVOID T_NAME(tgFX__Client__Submit_Job__,_Update_Finish)( TgVOID )
{
    ...
    TgSTD_ATOMIC(fetch_add)( &T_TYPE(g_xuiFX_FENCE__UPDATE__FINISH__,), 1 );
    TgSTD_ATOMIC(fetch_add)( &g_xuiFX_FENCE__UPDATE, 1 );
    TgSTD_ATOMIC(fetch_add)( &g_xuiFX_FENCE__UPDATE__FINISH, 1 );

    if (TgFAILED(tgJM_Queue_Job( g_sJob_Queue__Client_Normal, & T_NAME(g_sFX__Job__,__Update__Update_Finish) )))
    {
        TgWARNING_MSGF( false, STD_MSG_LITERAL_1, STD_MSG_POST, u8"Failed to submit job." );
        T_NAME(tgFX__Update__Job__,_Update_Finish)( & T_NAME(g_sFX__Job__,__Update__Update_Finish) );
        TgSTD_ATOMIC(fetch_sub)( &T_TYPE(g_xuiFX_FENCE__UPDATE__FINISH__,), 1 );
    };
}
...
TgRSIZE T_NAME(tgFX__Update__,_Process_Update_Command_Buffer)( TgUINT_E08_CP puiCommand_Stream, TgRSIZE uiIndex )
{
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgUINT_E08_P T_NAME(tgFX_,__Reserve_Update_Command)( ETgFX_COMMAND_C enCommand )
{
    ...
    uiCommand_Offset = TgSTD_ATOMIC(load)( &T_NAME(g_xuiFX_Command__,__Update_Command_Offset) );
    while (1)
    {
        ...
        if (TgSTD_ATOMIC(compare_exchange_strong)( &T_NAME(g_xuiFX_Command__,__Update_Command_Offset), &uiCommand_Offset, uiCommand_Offset + uiCommand_Size ))
        {
...
TgVOID T_NAME(tgFX__Update__,_Process_Update_Command_Default)( ETgFX_COMMAND_C enCommand, TgVOID_CP pData, TgFX_DATA_INST_ID_C tiData )
{
    ...
    switch (enCommand)
    {
        ...
        TgATTRIBUTE_FALLTHROUGH case ETgFX_COMMAND__CLIENT_TO_UPDATE__STOP: /**< Fall Through - Intentionally Blank */
            break;
        ...
        case ETgFX_COMMAND__CLIENT_TO_UPDATE__NOTIFY: TgATTRIBUTE_FALLTHROUGH /**< Fall Through - Invalid */
        case ETgFX_COMMAND__CLIENT_TO_UPDATE__CREATE: TgATTRIBUTE_FALLTHROUGH /**< Fall Through - Invalid */
        case ETgFX_COMMAND__CLIENT_TO_UPDATE__SPIN: TgATTRIBUTE_FALLTHROUGH /**< Fall Through - Invalid */
        case ETgFX_COMMAND__SCENE_TO_RENDER__BEGIN: TgATTRIBUTE_FALLTHROUGH /**< Fall Through - Invalid */
        case ETgFX_COMMAND__UPDATE_TO_CLIENT__BEGIN: TgATTRIBUTE_FALLTHROUGH /**< Fall Through - Invalid */
        case ETgFX_COMMAND__UPDATE_TO_CLIENT__NOTIFY: TgATTRIBUTE_FALLTHROUGH /**< Fall Through - Invalid */
        case ETgFX_COMMAND__UPDATE_TO_CLIENT__FREE: TgATTRIBUTE_FALLTHROUGH /**< Fall Through - Invalid */
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgRESULT T_NAME(tgFX__Update__Job__,_Update)( STg2_Job_CPC psJob )
{
    union
    {
        TgUINT_E08_CP                       pui;
        STg2_FX_Job__Update_Data_CP         psUpdate_Data;
    ...
    TgSTD_ATOMIC(fetch_sub)( &g_xuiFX_FENCE__UPDATE, 1 );
    TgSTD_ATOMIC(fetch_sub)( &g_xuiFX_FENCE__UPDATE__UPDATE, 1 );
    TgSTD_ATOMIC(fetch_sub)( T_TYPE(g_axuiFX_FENCE__UPDATE__UPDATE__,) + sUnion.psUpdate_Data->m_enUpdate, 1 );
...
TgVOID T_NAME(tgFX__Update__,_Update_Finish)( TgVOID )
{
    ...
    for (uiIndex = 0, uiRead_Offset = 0; !TgSTD_ATOMIC(compare_exchange_strong)( &T_NAME(g_xuiFX_Command__,__Update_Command_Offset), &uiRead_Offset, 0 ); )
    {
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgRESULT T_NAME(tgFX__Update__Job__,_Update_Finish)( TgATTRIBUTE_MAYBE_UNUSED STg2_Job_CPC psJob )
{
    TgERROR( 0 == T_TYPE(g_xuiFX_FENCE__UPDATE__UPDATE__,) );

    T_NAME(tgFX__Update__,_Update_Finish)();

    TgSTD_ATOMIC(fetch_sub)( &g_xuiFX_FENCE__UPDATE, 1 );
    TgSTD_ATOMIC(fetch_sub)( &g_xuiFX_FENCE__UPDATE__FINISH, 1 );
