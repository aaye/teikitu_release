...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgBOOL tgFX_Debug__Is_Valid( TgATTRIBUTE_MAYBE_UNUSED TgFX_CLIENT_INST_ID_C tiClient, TgATTRIBUTE_MAYBE_UNUSED TgFX_DATA_INST_ID_C tiData )
{
    return (true);
}
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgRESULT tgFX_Debug__Client__Reload_Effect( TgATTRIBUTE_MAYBE_UNUSED TgFX_EFFECT_ID_C tiEffect, TgATTRIBUTE_MAYBE_UNUSED STg2_Input_CPC psInput, TgATTRIBUTE_MAYBE_UNUSED TgUINT_PTR_C uiParam, TgATTRIBUTE_MAYBE_UNUSED TgVOID(*pgnCallback)( TgUINT_PTR_C, TgFX_EFFECT_ID_C ) )
{
    /* #IMPLEMENT */
    return (KTgE_FAIL);
}
