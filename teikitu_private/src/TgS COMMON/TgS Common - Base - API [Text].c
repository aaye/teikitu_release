...
TgCLANG_WARN_SUPPRESS(disabled-macro-expansion)
#endif
...
/* ---- FCN(From_U08) ------------------------------------------------------------------------------------------------------------------------------------------------------------ */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgRESULT FCN(From_U08)( CHAR(PC) ARG0, TgRSIZE_C nbyMaxARG0, TgUINT_E08_C ARG2 )
{
    TgSINT_E32                          iRet;
...
/* ---- FCN(From_U16) ------------------------------------------------------------------------------------------------------------------------------------------------------------ */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgRESULT FCN(From_U16)( CHAR(PC) ARG0, TgRSIZE_C nbyMaxARG0, TgUINT_E16_C ARG2 )
{
    TgSINT_E32                          iRet;
...
/* ---- FCN(From_U32) ------------------------------------------------------------------------------------------------------------------------------------------------------------ */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgRESULT FCN(From_U32)( CHAR(PC) ARG0, TgRSIZE_C nbyMaxARG0, TgUINT_E32_C ARG2 )
{
    TgSINT_E32                          iRet;
...
/* ---- FCN(From_U64) ------------------------------------------------------------------------------------------------------------------------------------------------------------ */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgRESULT FCN(From_U64)( CHAR(PC) ARG0, TgRSIZE_C nbyMaxARG0, TgUINT_E64_C ARG2 )
{
    TgSINT_E32                          iRet;
...
/* ---- FCN(From_S08) ------------------------------------------------------------------------------------------------------------------------------------------------------------ */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgRESULT FCN(From_S08)( CHAR(PC) ARG0, TgRSIZE_C nbyMaxARG0, TgSINT_E08_C ARG2 )
{
    TgSINT_E32                          iRet;
...
/* ---- FCN(From_S16) ------------------------------------------------------------------------------------------------------------------------------------------------------------ */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgRESULT FCN(From_S16)( CHAR(PC) ARG0, TgRSIZE_C nbyMaxARG0, TgSINT_E16_C ARG2 )
{
    TgSINT_E32                          iRet;
...
/* ---- FCN(From_S32) ------------------------------------------------------------------------------------------------------------------------------------------------------------ */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgRESULT FCN(From_S32)( CHAR(PC) ARG0, TgRSIZE_C nbyMaxARG0, TgSINT_E32_C ARG2 )
{
    TgSINT_E32                          iRet;
...
/* ---- FCN(From_S64) ------------------------------------------------------------------------------------------------------------------------------------------------------------ */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgRESULT FCN(From_S64)( CHAR(PC) ARG0, TgRSIZE_C nbyMaxARG0, TgSINT_E64_C ARG2 )
{
    TgSINT_E32                          iRet;
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgRESULT FCN(Formatted_From_U32)( CHAR(PC) ARG0, TgRSIZE_C nbyMaxARG0, TgUINT_E32_C ARG2 )
{
    CHAR()                              szTemp[32];
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgRESULT FCN(Formatted_From_U64)( CHAR(PC) ARG0, TgRSIZE_C nbyMaxARG0, TgUINT_E64_C ARG2 )
{
    CHAR()                              szTemp[32];
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgRESULT FCN(Formatted_From_S32)( CHAR(PC) ARG0, TgRSIZE_C nbyMaxARG0, TgSINT_E32_C ARG2 )
{
    CHAR()                              szTemp[32];
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgRESULT FCN(Formatted_From_S64)( CHAR(PC) ARG0, TgRSIZE_C nbyMaxARG0, TgSINT_E64_C ARG2 )
{
    CHAR()                              szTemp[32];
...
/* ---- FCN(To_U32) -------------------------------------------------------------------------------------------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgUINT_E32 FCN(To_U32)( CHAR(CPC) ARG0, TgRSIZE_C nbyMaxARG0 )
{
    TgPARAM_CHECK(nullptr != ARG0 && nbyMaxARG0 > 0);
#if defined(GENERATE__WSZ)
    return (TgUINT_E32)(wcstoul( ARG0, nullptr, UINT32_C(10) ));
#else
    return (TgUINT_E32)(strtoul( (TgCHAR_NC_CP)ARG0, nullptr, UINT32_C(10) ));
#endif
}
...
/* ---- FCN(To_U64) -------------------------------------------------------------------------------------------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgUINT_E64 FCN(To_U64)( CHAR(CPC) ARG0, TgRSIZE_C nbyMaxARG0 )
{
    TgPARAM_CHECK(nullptr != ARG0 && nbyMaxARG0 > 0);
#if defined(GENERATE__WSZ)
    return (TgUINT_E64)(wcstoull( ARG0, nullptr, UINT64_C(10) ));
#else
    return (TgUINT_E64)(strtoull( (TgCHAR_NC_CP)ARG0, nullptr, UINT64_C(10) ));
#endif
}
...
/* ---- FCN(To_S32) -------------------------------------------------------------------------------------------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgSINT_E32 FCN(To_S32)( CHAR(CPC) ARG0, TgRSIZE_C nbyMaxARG0 )
{
    TgPARAM_CHECK(nullptr != ARG0 && nbyMaxARG0 > 0);
#if defined(GENERATE__WSZ)
    return (TgSINT_E32)(wcstol( ARG0, nullptr, INT32_C(10) ));
#else
    return ((TgSINT_E32)strtol( (TgCHAR_NC_CP)ARG0, nullptr, INT32_C(10) ));
#endif
}
...
/* ---- FCN(To_S64) -------------------------------------------------------------------------------------------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgSINT_E64 FCN(To_S64)( CHAR(CPC) ARG0, TgRSIZE_C nbyMaxARG0 )
{
    TgPARAM_CHECK(nullptr != ARG0 && nbyMaxARG0 > 0);
#if defined(GENERATE__WSZ)
    return (TgSINT_E64)(wcstoll( ARG0, nullptr, INT64_C(10) ));
#else
    return (TgSINT_E64)(strtoll( (TgCHAR_NC_CP)ARG0, nullptr, INT64_C(10) ));
#endif
}
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgRESULT FCN(Compare_Internal)( TgSINT_E08_P OUT0,
                                ...
                                TgBOOL_C bNoCase, TgBOOL_C bLexographical )
{
...
#if defined(GENERATE__USZ)
    {
        ...
        for (; nbyRemain0 && nbyRemain1 && uiMaxRead ; pIN0 += nby08_0, nbyRemain0 -= nby08_0, pIN1 += nby08_1, nbyRemain1 -= nby08_1, --uiMaxRead)
        {
            ...
            *OUT0 = (bLexographical ? (TgSINT_E08)wcscoll( wczCMP0, wczCMP1 ) : (wczCMP0[0] < wczCMP1[0]) ? -INT8_C(1) : INT8_C(1));
            return (KTgS_OK);
        };
...
//#       *OUT0 = !uiMaxRead ? 0 : ((!nbyRemain0 && !nbyRemain1) ? 0 : ((nbyRemain0 < nbyRemain1) ? -1 : 1));
    ...
    else
    {
        if (bNoCase)
        {
            *OUT0 = (TgSINT_E08)wcsncasecmp( ARG1 + uiOffset_1, ARG2 + uiOffset_2, KTgMAX_S32 < uiMaxRead ? KTgMAX_S32 : uiMaxRead );
        }
        else
        {
            *OUT0 = (TgSINT_E08)wcsncmp( ARG1 + uiOffset_1, ARG2 + uiOffset_2, KTgMAX_S32 < uiMaxRead ? KTgMAX_S32 : uiMaxRead );
        };
    };
    ...
    else
    {
        if (bNoCase)
        {
            *OUT0 = (TgSINT_E08)strncasecmp( ARG1 + uiOffset_1, ARG2 + uiOffset_2, KTgMAX_S32 < uiMaxRead ? KTgMAX_S32 : uiMaxRead );
        }
        else
        {
            *OUT0 = (TgSINT_E08)strncmp( ARG1 + uiOffset_1, ARG2 + uiOffset_2, KTgMAX_S32 < uiMaxRead ? KTgMAX_S32 : uiMaxRead );
        };
    };
...
/* ---- FCN(Token_List) ---------------------------------------------------------------------------------------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgEXTN TgSINT_E32 FCN(Token_List)( CHAR(PP) ARG0, TgSINT_E32_C ARG1, CHAR(PC) ARG2, TgRSIZE_C ARG3 )
{
    CHAR(P)                            mbzNext;
    TgSINT_E32                          iToken;
...
/* ---- FCN(LengthVF_Count) ------------------------------------------------------------------------------------------------------------------------------------------------------ */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgCLANG_WARN_DISABLE_PUSH(format-nonliteral)
...
TgCLANG_WARN_DISABLE_POP(format-nonliteral)
...
static TgRESULT FCN(Formated_From_SZ)( CHAR(P) ARG0, TgRSIZE_C nbyMaxARG0, CHAR(CPU) ARG2, TgRSIZE_C nbyMaxARG2 )
{
    ...
    switch (nuiSrc % 3) /* Modified Duff's Device */
    {
        ...
        TgATTRIBUTE_FALLTHROUGH case 2: *ARG0++ = *ARG2++; /* Fall through */
        TgATTRIBUTE_FALLTHROUGH case 1: *ARG0++ = *ARG2++; /* Fall through */
    };
