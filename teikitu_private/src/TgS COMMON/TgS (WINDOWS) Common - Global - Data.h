...
/*  »Project«   Teikitu Gaming System (TgS) (∂)
    »File«      TgS (WINDOWS) Common - Global - Data.h
...
/* =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-==-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- */
#if !defined(TGS_WINDOWS_COMMON_GLOBAL_DATA_H)
#define TGS_WINDOWS_COMMON_GLOBAL_DATA_H
#pragma once
...
TgEXTN BOOL                                 (__stdcall *g_pfnSetThreadPriority)( TgVOID_P, TgSINT_E32 );
TgEXTN TgSINT_E32                           (__stdcall *g_pfnSwitchToThread)( TgVOID );
TgEXTN TgSINT_E32                           (__stdcall *g_pfnIsProcessorFeaturePresent)( DWORD );

/*  API Set: api-ms-win-core-handle-l1-1-0 */
TgEXTN TgSINT_E32                           (__stdcall *g_pfnCloseHandle)( TgVOID_P );
TgEXTN TgSINT_E32                           (__stdcall *g_pfnDuplicateHandle)( TgVOID_P, TgVOID_P, TgVOID_P, TgVOID_PP, DWORD, BOOL, DWORD );
...
TgEXTN TgUINT_E64                           (__stdcall *g_pfnGetTickCount64)( TgVOID );
#if !defined(TgBUILD_UNIVERSAL__UWP)
TgEXTN BOOL                                 (__stdcall *g_pfnGetComputerNameEx)( COMPUTER_NAME_FORMAT, TgOSCHAR_P, LPDWORD );
TgEXTN TgUINT_E32                           (__stdcall *g_pfnGetSystemDirectory)( TgOSCHAR_P, TgUINT_E32 );
TgEXTN TgUINT_E32                           (__stdcall *g_pfnGetWindowsDirectory)( TgOSCHAR_P, TgUINT_E32 );
...
TgEXTN TgVOID_P                             (__stdcall *g_pfnVirtualAllocFromApp)( TgVOID_P, TgUINT_E64, DWORD, DWORD );
/*# !defined(TgBUILD_UNIVERSAL__UWP) */
#endif

#if !defined(TgBUILD_UNIVERSAL__UWP)
 /*  API Set: api-ms-win-core-realtime-l1-1-0 */
TgEXTN BOOL                                 (__stdcall *g_pfnQueryProcessCycleTime)( TgVOID_P, TgUINT_E64_P );
TgEXTN BOOL                                 (__stdcall *g_pfnQueryThreadCycleTime)( TgVOID_P, TgUINT_E64_P );

/*  API Set: ext-ms-win-ntuser-sysparams-ext-l1-1-0 */
TgEXTN TgSINT_E32                           (__stdcall *g_pfnGetSystemMetrics)( TgSINT_E32 );
TgEXTN TgSINT_E32                           (__stdcall *g_pfnSystemParametersInfo)( TgUINT_E32, TgUINT_E32, TgVOID_P, TgUINT_E32 );
...
TgEXTN BOOL                                 (__stdcall *g_pfnGetCurrentHwProfile)( LPHW_PROFILE_INFO );
 ...
 /* Psapi */
TgEXTN BOOL                                 (__stdcall *g_pfnEnumProcessModulesEx)( TgVOID_P, HINSTANCE*, DWORD, TgUINT_E32_P, DWORD );
