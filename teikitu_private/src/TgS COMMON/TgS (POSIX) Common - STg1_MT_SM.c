...
/* ---- tgPM_MT_SM_Init ---------------------------------------------------------------------------------------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgRESULT tgPM_MT_SM_Init( STg1_MT_SM_PCU NONULL psSM, TgCHAR_U8_CPCU OKNULL mbzName, TgUINT_F32_C uiInit, TgUINT_F32_C UNUSED_PARAM uiMax )
{
    if (nullptr == mbzName)
    {
...
/* ---- tgPM_MT_SM_Signal -------------------------------------------------------------------------------------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgVOID tgPM_MT_SM_Signal( STg1_MT_SM_PCU NONULL psSM, TgUINT_F32_C nuiSignal )
{
    TgSINT_F32                          iRet;
