...
/* ---- tgEM_TE_FRM_NEW ---------------------------------------------------------------------------------------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgEM_TE_FRM_ID tgEM_TE_FRM_NEW( TgFCN_EM_CALLBACK pfnCallback, TgUINT_PTR_C uiParam, TgSINT_E32_C iStart, TgSINT_E32_C iEnd )
{
    TgSINT_E32                          iPool, iIndex;
    ...
    if (nullptr == g_psEM_TE_FRM_Free_List)
    {
        ...
        TgCRITICAL_MSGF( nullptr != psPool, STD_MSG_LITERAL_1, STD_MSG_POST, u8"Failed to allocate memory." );
        tgEM_TP_Init( psPool );
    ...
    iIndex = (TgSINT_E32 )(psPool->m_psFree - psPool->m_asTB);
    psPool->m_psFree = psPool->m_psFree->m_psHead_Next;
    tgCM_UT_LF__SN__Signal( &g_asEM_TE_FRM_NewDel_Lock[iPool].m_sLock );

    psPool->m_atiEM_TE_FRM_NoSingleton[iIndex] = tgEM_TE_FRM_ID_Init( &xtiTE_Singleton, (TgUINT_E32)((iPool << 16) | iIndex) );
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgRESULT tgEM_TE_FRM_Set_Start_Frame( TgEM_TE_FRM_ID tiTE, TgSINT_E32_C iFrame )
{
    TgUINT_E32                        uiIndex, uiPool;
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgRESULT tgEM_TE_FRM_Set_End_Frame( TgEM_TE_FRM_ID tiTE, TgSINT_E32_C iFrame )
{
    TgUINT_E32                        uiIndex, uiPool;
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgRESULT tgEM_TE_FRM_Set_Frame_To_Live( TgEM_TE_FRM_ID tiTE, TgSINT_E32_C iFrame )
{
    TgUINT_E32                        uiIndex, uiPool;
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgRESULT tgEM_TE_FRM_Query_Start_Frame( TgSINT_E32_PCU piFrame, TgEM_TE_FRM_ID tiTE )
{
    TgUINT_E32                        uiIndex, uiPool;
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgRESULT tgEM_TE_FRM_Query_End_Frame( TgSINT_E32_PCU piFrame, TgEM_TE_FRM_ID tiTE )
{
    TgUINT_E32                        uiIndex, uiPool;
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgRESULT tgEM_TE_FRM_Query_Frame_To_Live( TgSINT_E32_PCU piFrame, TgEM_TE_FRM_ID tiTE )
{
    TgUINT_E32                        uiIndex, uiPool;
...
TgEM_TE_SEC_ID tgEM_TE_SEC_NEW( TgFCN_EM_CALLBACK pfnCallback, TgUINT_PTR_C uiParam, TgFLOAT32_C fStart, TgFLOAT32_C fEnd )
{
    ...
    psPool->m_atiEM_TE_SEC_NoSingleton[iIndex] = tgEM_TE_SEC_ID_Init( &xtiTE_Singleton, (TgUINT_E32)((iPool << 16) | iIndex) );
