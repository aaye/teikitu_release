...
TgVOID tgCM_File_Output_Header( STg2_Output_P psOUT, STg2_File_Block_CPC psFileBlock )
{
    ...
    psSection.pui = (TgUINT_E08_CP)psFileBlock->m_asSection;
...
TgVOID tgCM_File_Output_Data_Headers( STg2_Output_P psOUT, STg2_File_Block_CPC psFileBlock )
{
    ...
    for (uiIndex = 0; uiIndex < psFileBlock->m_uiSection_Count; ++uiIndex)
    {
        psData.pui = (TgUINT_E08_CP)psFileBlock + psSection.ps->m_uiOffset;
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgBOOL tgCM_File_Query_Data( TgVOID const **ppRet, STg2_File_Block_CPC psFileBlock, TgUINT_E32_C uiBlockIndex )
{
    union
    {
        TgUINT_E08_CP                       pui;
    ...
    psSection.pui = (TgUINT_E08_CP)psFileBlock->m_asSection + uiBlockIndex * psFileBlock->m_uiSection_Size;
    psData.pui = (TgUINT_E08_CP)psFileBlock + psSection.ps->m_uiOffset;
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgBOOL tgCM_File_Query_Data_Size( TgRSIZE_P puiSize, STg2_File_Block_CPC psFileBlock, TgUINT_E32_C uiBlockIndex )
{
    union
    {
        TgUINT_E08_CP                       pui;
