...
/*  »Project«   Teikitu Gaming System (TgS) (∂)
    »File«      TgS (WINDOWS) Common - SysInfo.c
...
SI_CO_Print_Configuration(
    TgUINT_E32_C ARG0, TgCHAR_U8_CP ARG1[KTgMAX_CMD_LINE_COUNT] ) TgATTRIBUTE_NO_EXCEPT;
...
/* System Parameters */
static TgUINT_E32                           s_uiSI_Page_Size = 0;
...
static TgUINT_E32                           s_nuiSI_Processors = 0;

/* Input Parameters */
static TgUINT_E32                           s_uiSI_IN_Mouse_Bounds_X_Double_Click = 0;
static TgUINT_E32                           s_uiSI_IN_Mouse_Bounds_Y_Double_Click = 0;
static TgUINT_E32                           s_uiSI_IN_Mouse_Bounds_X_Drag = 0;
static TgUINT_E32                           s_uiSI_IN_Mouse_Bounds_Y_Drag = 0;

static TgUINT_E32                           s_uiSI_Bounds_Hover_Height = 0;
static TgUINT_E32                           s_uiSI_Bounds_Hover_Width = 0;
static TgUINT_E32                           s_uiSI_Bounds_Hover_Time = 0;
static TgCHAR_U8_P                          s_pszSI_String_Pool = 0;

static TgUINT_E32                           s_bfSystemChecks = 0;
static TgUINT_E32                           s_bfInputChecks = 0;
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgUINT_E32 tgSI_SYSTEM_Number_Of_Processors( TgVOID )
{
...
TgVOID tgSI_Print_Configuration( STg2_Output_P pOutput )
{
    ...
    tgIO_PrintF( pOutput, u8"% 25.25s: %s\n\n", u8"Malloc Redirection:", tgMM_OS__Preload_Malloc_Redirected() ? "true" : "false" );
...
TgCLANG_WARN_DISABLE_POP(unused-function)
...
/* ---- SI_CO_Print_Configuration ------------------------------------------------------------------------------------------------------------------------------------------------ */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
static TgVOID SI_CO_Print_Configuration( TgATTRIBUTE_MAYBE_UNUSED TgUINT_E32_C nuiArg, TgATTRIBUTE_MAYBE_UNUSED TgCHAR_U8_CP pArgV[KTgMAX_CMD_LINE_COUNT] ) TgATTRIBUTE_NO_EXCEPT
{
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
#if TgCOMPILE__CONSOLE
static TgVOID SI_CO_Print_Modules( TgATTRIBUTE_MAYBE_UNUSED TgUINT_E32_C nuiArg, TgATTRIBUTE_MAYBE_UNUSED TgCHAR_U8_CP pArgV[KTgMAX_CMD_LINE_COUNT] ) TgATTRIBUTE_NO_EXCEPT
{
#if !defined(TgBUILD_UNIVERSAL__UWP)
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
#if TgCOMPILE__CONSOLE
static TgVOID SI_CO_Print_Threads( TgATTRIBUTE_MAYBE_UNUSED TgUINT_E32_C nuiArg, TgATTRIBUTE_MAYBE_UNUSED TgCHAR_U8_CP pArgV[KTgMAX_CMD_LINE_COUNT] ) TgATTRIBUTE_NO_EXCEPT
{
#if !defined(TgBUILD_UNIVERSAL__UWP)
