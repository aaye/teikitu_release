...
/*  »Project«   Teikitu Gaming System (TgS) (∂)
    »File«      TgS (WINDOWS) Common - Global.c
...
TgVOID_P                                    (__stdcall *g_pfnSetEvent)( TgVOID_P ) = nullptr;
...
TgSINT_E32                                  (__stdcall *g_pfnReleaseMutex)( TgVOID_P ) = nullptr;
DWORD                                       (__stdcall *g_pfnWaitForSingleObjectEx)( TgVOID_P, DWORD, BOOL ) = nullptr;
DWORD                                       (__stdcall *g_pfnWaitForMultipleObjectsEx )( DWORD, TgVOID_CP, BOOL, DWORD, BOOL ) = nullptr;
...
BOOL                                        (__stdcall *g_pfnSetThreadPriority)( TgVOID_P, TgSINT_E32  ) = nullptr;
TgSINT_E32                                  (__stdcall *g_pfnSwitchToThread)( TgVOID ) = nullptr;
TgSINT_E32                                  (__stdcall *g_pfnIsProcessorFeaturePresent)( DWORD ) = nullptr;

/* API Set: api-ms-win-core-handle-l1-1-0 */
TgSINT_E32                                  (__stdcall *g_pfnCloseHandle)( TgVOID_P ) = nullptr;
TgSINT_E32                                  (__stdcall *g_pfnDuplicateHandle )(TgVOID_P, TgVOID_P, TgVOID_P, TgVOID_PP, DWORD, BOOL, DWORD) = nullptr;
...
TgUINT_E64                                  (__stdcall *g_pfnGetTickCount64)( TgVOID ) = nullptr;
#if !defined(TgBUILD_UNIVERSAL__UWP)
BOOL                                        (__stdcall *g_pfnGetComputerNameEx)( COMPUTER_NAME_FORMAT , TgOSCHAR_P, LPDWORD ) = nullptr;
TgUINT_E32                                  (__stdcall *g_pfnGetSystemDirectory)( TgOSCHAR_P, TgUINT_E32  ) = nullptr;
TgUINT_E32                                  (__stdcall *g_pfnGetWindowsDirectory)( TgOSCHAR_P, TgUINT_E32  ) = nullptr;
...
TgVOID_P                                    (__stdcall *g_pfnVirtualAllocFromApp)( TgVOID_P, TgUINT_E64 , DWORD, DWORD ) = nullptr;
/*# defined(TgBUILD_UNIVERSAL__UWP) */
#endif

#if !defined(TgBUILD_UNIVERSAL__UWP)
/* API Set: api-ms-win-core-realtime-l1-1-0 */
BOOL                                        (__stdcall *g_pfnQueryProcessCycleTime)( TgVOID_P, TgUINT_E64_P  ) = nullptr;
BOOL                                        (__stdcall *g_pfnQueryThreadCycleTime)( TgVOID_P, TgUINT_E64_P  ) = nullptr;

/*  API Set: ext-ms-win-ntuser-sysparams-ext-l1-1-0 */
TgSINT_E32                                  (__stdcall *g_pfnGetSystemMetrics)( TgSINT_E32 ) = nullptr;
TgSINT_E32                                  (__stdcall *g_pfnSystemParametersInfo)( TgUINT_E32 , TgUINT_E32 , TgVOID_P, TgUINT_E32  ) = nullptr;

/* API Set: api-ms-win-core-localization-l1-2-1 */
TgUINT_E32                                  (__stdcall *g_pfnGetACP)( TgVOID );
...
/* Psapi */
BOOL                                        (__stdcall *g_pfnEnumProcessModulesEx)( TgVOID_P, HINSTANCE*, DWORD, TgUINT_E32_P, DWORD ) = nullptr;
...
/* ---- tgIDE_DBG_ERR_Write ------------------------------------------------------------------------------------------------------------------------------------------------------ */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgRSIZE tgIDE_DBG_ERR_Write( TgATTRIBUTE_MAYBE_UNUSED STg2_Output_PC psOut, TgATTRIBUTE_MAYBE_UNUSED TgRSIZE_C uiOffset, TgVOID_CP szText, TgRSIZE_C nbyText )
{
...
/* ---- tgIDE_DBG_OUT_Write ------------------------------------------------------------------------------------------------------------------------------------------------------ */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgRSIZE tgIDE_DBG_OUT_Write( TgATTRIBUTE_MAYBE_UNUSED STg2_Output_PC psOut, TgATTRIBUTE_MAYBE_UNUSED TgRSIZE_C uiOffset, TgVOID_CP szText, TgRSIZE_C nbyText )
{
    TgOSCHAR                            szBuffer[1024];
...
/* ---- tgIDE_DBG_ERR_Write ------------------------------------------------------------------------------------------------------------------------------------------------------ */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgRSIZE tgIDE_DBG_ERR_Write( TgATTRIBUTE_MAYBE_UNUSED STg2_Output_PC psOut, TgATTRIBUTE_MAYBE_UNUSED TgRSIZE_C uiOffset, TgATTRIBUTE_MAYBE_UNUSED TgVOID_CPC mbzText, TgATTRIBUTE_MAYBE_UNUSED TgRSIZE_C nbyText )
{
    return 0;
}
...
/* ---- tgIDE_DBG_OUT_Write ------------------------------------------------------------------------------------------------------------------------------------------------------ */
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
TgRSIZE tgIDE_DBG_OUT_Write( TgATTRIBUTE_MAYBE_UNUSED STg2_Output_PC psOut, TgATTRIBUTE_MAYBE_UNUSED TgRSIZE_C uiOffset, TgATTRIBUTE_MAYBE_UNUSED TgVOID_CPC mbzText, TgATTRIBUTE_MAYBE_UNUSED TgRSIZE_C nbyText )
{
    return 0;
}
...
/*# !defined(TgCOMPILE_WIDE_CHAR) */
    ...
    if (
        ...
        || !tgGB_Get_Func_Address( (FARPROC*)&g_pfnSetEvent, s_hDLL_Core_Sync2, ("SetEvent") )
        ...
        || !tgGB_Get_Func_Address( (FARPROC*)&g_pfnWaitForMultipleObjectsEx, s_hDLL_Core_Sync2, ("WaitForMultipleObjectsEx") )
