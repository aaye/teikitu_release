...
TgRESULT tgCM_UT_ST__AR__Insert_ElementN( STg2_UT_ST__AR_PCU psAR, TgRSIZE_C uiIndex, TgVOID_P pElement, TgRSIZE_C uiCount )
{
    ...
    if (psAR->m_puiEnd < psAR->m_puiLast + uiCount*psAR->m_uiStride)
    {
        TgUINT_E08_P                        puiData;
        TgRSIZE                             nbyData;
        TgUINT_E08_P                        puiNewData;
        TgRSIZE                             nbyNewData;
        TgUINT_E08_P                        puiNewStart;
...
//#             nbyNewData -= nbyCopy;
    ...
    else
    {
        ...
        TgRSIZE                             nbyTailSize;
        TgUINT_E08_P                        puiSrcData;
        TgUINT_E08_P                        puiDestData;
...
{
    TgUINT_E08_PC                       puiEraseStart = psAR->m_puiStart + uiStart*psAR->m_uiStride;
    TgUINT_E08_PC                       puiEraseLast_Test = psAR->m_puiStart + uiLast * psAR->m_uiStride;
    TgUINT_E08_PC                       puiEraseLast      = psAR->m_puiLast < puiEraseLast_Test ? psAR->m_puiLast : puiEraseLast_Test;
    TgUINT_E08_PC                       puiDataLast       = psAR->m_puiLast;
    TgUINT_E08_P                        puiErase;
