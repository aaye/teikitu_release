...
TgBOOL tgCN_Var_Set_S16( TgCN_VAR_ID_C tiCN_Var, TgSINT_E16_C iValue )
{
    ...
    psCmd_Var->m_sData.m_sScalar.m_sCurrent.m_iF16 = (TgSINT_E16)tgCM_CLP_S32( iValue, psCmd_Var->m_sData.m_sScalar.m_sMin.m_iF16, psCmd_Var->m_sData.m_sScalar.m_sMax.m_iF16 );
    return (true);
}
...
TgBOOL tgCN_Var_Set_U16( TgCN_VAR_ID_C tiCN_Var, TgUINT_E16_C uiValue )
{
    ...
    psCmd_Var->m_sData.m_sScalar.m_sCurrent.m_uiF16 = (TgUINT_E16)tgCM_CLP_U32( uiValue, psCmd_Var->m_sData.m_sScalar.m_sMin.m_uiF16, psCmd_Var->m_sData.m_sScalar.m_sMax.m_uiF16 );
    return (true);
}
