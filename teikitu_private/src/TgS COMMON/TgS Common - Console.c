...
static TgSINT_E32                           s_niCommand_Function_Used;
...
static TgSINT_E32                           s_aiUID_Filter[KTgCN_MAX_CHANNEL];
static TgUINT_E32                           s_auiSeverity_Filter[KTgCN_MAX_CHANNEL];
...
static TgCHAR_U8_C                          s_szPrefix_Initialize_Mem[] = u8"MEM: ";
...
/*# TgCOMPILE__THREAD */
    ...
    iIndex = KTgCN_CHANEL_INITIALIZE_MEMORY_INDEX - KTgCN_CHANEL_CONSOLE_INDEX;
    s_pzOutput_Prefix[iIndex] = s_szPrefix_Initialize_Mem;
    s_nbyOutput_Prefix[iIndex] = tgUSZ_Length_U08( s_pzOutput_Prefix[iIndex], KTgMAX_RSIZE );
...
TgRESULT tgCN_Update( TgFLOAT32_C fDT )
{
    ...
    if (s_pfnOS_Console_Render)
    {
        ...
        if (g_bOS_Console_Render)
        {
            ...
            TgCRITICAL_MSGF( nullptr != ppuszCon_Render_Buffer, STD_MSG_LITERAL_1, STD_MSG_POST, u8"Failed to allocate memory." );
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
#if TgCOMPILE__CONSOLE
TgUINT_E32 tgCN_Attach_Output( TgUINT_E32_C uiChannel_Mask, STg2_Output_PC psOutput )
{
    TgUINT_E32                          uiChannel, uiAttached;
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
#if TgCOMPILE__CONSOLE
TgUINT_E32 tgCN_Attach_Default_Break( TgUINT_E32_C uiChannel_Mask )
{
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
#if TgCOMPILE__CONSOLE
TgUINT_E32 tgCN_Attach_Default_Abort( TgUINT_E32_C uiChannel_Mask )
{
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
#if TgCOMPILE__CONSOLE
TgUINT_E32 tgCN_Remove_Output( TgUINT_E32_C uiChannel_Mask, STg2_Output_PC psOutput )
{
    TgUINT_E32                          uiChannel, uiOutput, uiRemoved;
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
#if TgCOMPILE__CONSOLE
TgUINT_E32 tgCN_Remove_Default_Break( TgUINT_E32_C uiChannel_Mask )
{
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
#if TgCOMPILE__CONSOLE
TgUINT_E32 tgCN_Remove_Default_Abort( TgUINT_E32_C uiChannel_Mask )
{
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
#if TgCOMPILE__CONSOLE
TgVOID tgCN_Set_Prefix( TgUINT_E32_C uiChannel_Mask, TgCHAR_U8_CPC mbzPrefix, TgRSIZE_C nbyMaxPrefix )
{
    TgUINT_E32                          uiChannel;
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
#if TgCOMPILE__CONSOLE
TgVOID tgCN_Set_UID_Filter( TgUINT_E32_C uiChannel_Mask, TgSINT_E32_C iUID )
{
    TgUINT_E32                          uiChannel;
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
#if TgCOMPILE__CONSOLE
TgUINT_E32 tgCN_Set_Severity_Filter( TgUINT_E32_C uiChannel_Mask, TgUINT_E32_C uiSeverity )
{
    TgUINT_E32                          uiPrevious_Severity = KTgMAX_U32;
    TgUINT_E32                          uiChannel;
...
static TgVOID tgCN_UID_Print_Internal( TgSINT_E32_C iUID, TgUINT_E32_C uiChannel_Mask, TgCHAR_U8_CP mbzText, TgRSIZE_C nbyMaxText )
{
    ...
    for (mbzStart = mbzText; '\0' != *mbzText; mbzStart = mbzText)
    {
        ...
        for (uiChannel = 0; uiChannel < KTgCN_MAX_CHANNEL; ++uiChannel)
        {
            ...
            TgUINT_E32_C                        uiChannel_ID = 1u << (uiChannel + KTgCN_SEVERITY_BITS);
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
#if TgCOMPILE__CONSOLE
static TgRSIZE tgLOG_CON_File_Write( TgATTRIBUTE_MAYBE_UNUSED STg2_Output_PC psOut, TgATTRIBUTE_MAYBE_UNUSED TgRSIZE_C uiOffset, TgVOID_CP mbzText, TgRSIZE_C _nuiText )
{
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
#if TgCOMPILE__CONSOLE
static TgRSIZE tgLOG_LOG_File_Write( TgATTRIBUTE_MAYBE_UNUSED STg2_Output_PC psOut, TgATTRIBUTE_MAYBE_UNUSED TgRSIZE_C uiOffset, TgVOID_CP mbzText, TgRSIZE_C _nuiText )
{
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
#if TgCOMPILE__CONSOLE
static TgRSIZE tgLOG_FCN_File_Write( TgATTRIBUTE_MAYBE_UNUSED STg2_Output_PC psOut, TgATTRIBUTE_MAYBE_UNUSED TgRSIZE_C uiOffset, TgVOID_CP mbzText, TgRSIZE_C _nuiText )
{
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
#if TgCOMPILE__CONSOLE
static TgRSIZE tgLOG_MEM_File_Write( TgATTRIBUTE_MAYBE_UNUSED STg2_Output_PC psOut, TgATTRIBUTE_MAYBE_UNUSED TgRSIZE_C uiOffset, TgVOID_CP mbzText, TgRSIZE_C _nuiText )
{
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
#if TgCOMPILE__CONSOLE
static TgRSIZE tgLOG_MSG_File_Write( TgATTRIBUTE_MAYBE_UNUSED STg2_Output_PC psOut, TgATTRIBUTE_MAYBE_UNUSED TgRSIZE_C uiOffset, TgVOID_CP mbzText, TgRSIZE_C _nuiText )
{
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
#if TgCOMPILE__CONSOLE
static TgRSIZE tgLOG_WRN_File_Write( TgATTRIBUTE_MAYBE_UNUSED STg2_Output_PC psOut, TgATTRIBUTE_MAYBE_UNUSED TgRSIZE_C uiOffset, TgVOID_CP mbzText, TgRSIZE_C _nuiText )
{
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
#if TgCOMPILE__CONSOLE
static TgRSIZE tgLOG_ERR_File_Write( TgATTRIBUTE_MAYBE_UNUSED STg2_Output_PC psOut, TgATTRIBUTE_MAYBE_UNUSED TgRSIZE_C uiOffset, TgVOID_CP mbzText, TgRSIZE_C _nuiText )
{
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
#if TgCOMPILE__CONSOLE
static TgRSIZE tgLOG_CRT_File_Write( TgATTRIBUTE_MAYBE_UNUSED STg2_Output_PC psOut, TgATTRIBUTE_MAYBE_UNUSED TgRSIZE_C uiOffset, TgVOID_CP mbzText, TgRSIZE_C _nuiText )
{
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
#if TgCOMPILE__CONSOLE
static TgRSIZE tgLOG_INT_File_Write( TgATTRIBUTE_MAYBE_UNUSED STg2_Output_PC psOut, TgATTRIBUTE_MAYBE_UNUSED TgRSIZE_C uiOffset, TgVOID_CP mbzText, TgRSIZE_C _nuiText )
{
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
#if TgCOMPILE__CONSOLE
static TgRSIZE tgLOG_LDN_File_Write( TgATTRIBUTE_MAYBE_UNUSED STg2_Output_PC psOut, TgATTRIBUTE_MAYBE_UNUSED TgRSIZE_C uiOffset, TgVOID_CP mbzText, TgRSIZE_C _nuiText )
{
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */
#if TgCOMPILE__CONSOLE
static TgRSIZE tgLOG_STD_File_Write( TgATTRIBUTE_MAYBE_UNUSED STg2_Output_PC psOut, TgATTRIBUTE_MAYBE_UNUSED TgRSIZE_C uiOffset, TgVOID_CP mbzText, TgRSIZE_C _nuiText )
{
    return (tgIO_File_Write( s_iLOG_Output_File, (TgVOID_CPC)mbzText, _nuiText ));
}
/*# TgCOMPILE__CONSOLE */
